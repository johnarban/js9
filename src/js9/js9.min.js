...
else break;if(h){try{k=JSON.parse(h)}catch(y){k=null}if(k)try{e.setParam("all",k)}catch(y){}}}a.globalOpts.alerts=g;e.xeqPlugins("image","onimageload");e.setStatus("load","complete");a.waiting(!1);if(b)try{a.xeqByName(b,window,e)}catch(y){a.error("in image onload callback",y,!1)}if(a.preloadwaiting&&a.preloadwaiting.length){var n=a.preloadwaiting.length;b=e.proxyURL||e.file;for(k=l=0;l<n;l++){var z=a.preloadwaiting[l];b.match(z.id)||z.id.match(b)?(z.loaded=!0,z.im=e):!1===z.loaded&&k++}if(!k){a.globalOpts.sortPreloads?
(a.images.sort(function(b,c){var d=0,e=0;for(l=0;l<n;l++)z=a.preloadwaiting[l],b.id===z.im.id&&(d=l),c.id===z.im.id&&(e=l);return d-e}),b=a.preloadwaiting[n-1].im||e,b.displayImage()):b=e;if(a.notNull(a.globalOpts.onpreload))try{a.xeqByName(a.globalOpts.onpreload,window,b)}catch(y){a.error("in onpreload callback",y,!1)}finally{delete a.globalOpts.onpreload}a.preloadwaiting=[]}}f&&f.allext&&e.hdus&&0<e.hdus.length&&e.displayExtension("all")};if(b)if("object"===typeof b){if(f=b,f.display)var m=f.display}else m=
...
(h=this.display.rgb.gim),this.display.rgb.bim&&(k=this.display.rgb.bim));var x=this.display.context;var w=this.rgb;var t=w.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.useOffScreenCanvas()){var u=t.width/t.zoom;var v=t.height/t.zoom;var r=t.x0;var z=this.offscreen.canvas.height-1-(t.y0+v);z=this.offscreen.context.getImageData(r,z,u,v);if(1===t.zoom)w.img=
z;else for(w.img=x.createImageData(t.width,t.height),w=w.img,d=c=0;c<z.height;c++,d++){var y=c*z.width;var A=d*t.zoom;for(b=x=0;x<z.width;x++,b++){r=4*(y+x);var C=b*t.zoom;for(e=0;e<t.zoom;e++){var B=Math.floor(A+e);var D=B*t.width;for(B=0;B<t.zoom;B++){var E=Math.floor(C+B);E=4*(D+E);w.data[E]=z.data[r];w.data[E+1]=z.data[r+1];w.data[E+2]=z.data[r+2];w.data[E+3]=z.data[r+3]}}}}return this}w.img&&w.img.width===t.width&&w.img.height===t.height||(w.img=x.createImageData(t.width,t.height));w=w.img;var F=
w.data.length-4;if(!this.psColors&&!this.staticObj)return this;var G=void 0!==this.params.opacity?Math.floor(255*this.params.opacity):void 0!==this.params.alpha?this.params.alpha:255;if(this.mask.active&&this.mask.im){var J=this.mask.im;if("mask"===this.mask.mode){m=!0;var I=a.notNull(this.mask.vopacity)?255*this.mask.vopacity:0;var K=a.notNull(this.params.opacity)?255*this.params.opacity:255;this.mask.invert&&(G=I,I=K,K=G)}else if("opacity"===this.mask.mode)n=!0;else if("overlay"===this.mask.mode){q=
!0;var L=J.rgb.img;a.isNull(this.mask.opacity)&&(this.mask.opacity=1)}}else if(a.notNull(this.params.flooropacity)&&!l){var R=255*this.params.flooropacity;var M=this.params.floorvalue;f=!0}var N=Math.max(1,Math.floor(1/t.zoom));var P=t.zoom*N;c=Math.floor(t.y1-1);for(d=0;c>=t.y0;c-=N,d++)for(y=c*this.raw.width,A=d*P,x=Math.floor(t.x0),b=0;x<t.x1;x+=N,b++){m?G=J.raw.data[y+x]>this.mask.value?K:I:n&&(G=255*J.raw.data[y+x]);if(l){if(z=g?g.colorData[y+x]:0,u=h?h.colorData[y+x]:0,v=k?k.colorData[y+x]:
0,a.isNull(z)||a.isNull(u)||a.isNull(v))return this.display.rgb.active=!1,a.error("RGB images are incompatible. Turning off RGB mode.","",!1),this.mkRGBImage(),this}else this.staticObj||(r=this.colorData[y+x]);var Q=G;f&&this.raw.data[y+x]<=M&&(Q=R);C=b*P;for(e=0;e<t.zoom;e++)for(B=Math.ceil(A+e),D=B*t.width,B=0;B<t.zoom;B++)if(E=Math.ceil(C+B),E=4*(D+E),E<=F)if(l)w.data[E]=g?g.psColors[z][0]:0,w.data[E+1]=h?h.psColors[u][1]:0,w.data[E+2]=k?k.psColors[v][2]:0,w.data[E+3]=G;else if(this.staticObj){var H=
this.raw.data[y+x];H=a.lookupStaticColor(this,H,p);w.data[E]=H.red;w.data[E+1]=H.green;w.data[E+2]=H.blue;w.data[E+3]=H.alpha}else if(void 0!==this.psColors[r])if(q&&L.data[E+3]){H=L.data[E+3]/255*this.mask.opacity;var O=1-H;w.data[E]=L.data[E]*H+this.psColors[r][0]*O;w.data[E+1]=L.data[E+1]*H+this.psColors[r][1]*O;w.data[E+2]=L.data[E+2]*H+this.psColors[r][2]*O;w.data[E+3]=255}else w.data[E]=this.psColors[r][0],w.data[E+1]=this.psColors[r][1],w.data[E+2]=this.psColors[r][2],w.data[E+3]=Q}return this};
...
return}switch(f.rtype){case "text":case void 0:e.displayAnalysis("text",n.stdout,{divid:a.globalOpts.analysisDiv});break;case "plot":e.displayAnalysis("plot",n.stdout,{divid:a.globalOpts.analysisDiv});break;case "alert":n.stdout&&alert(n.stdout);break;case "fits":(l=n.stdout.split(/\s+/))&&l[0]&&(c=a.cleanPath(l[0]),"/"!==c.charAt(0)&&(c=a.InstallDir(c)),n={proxyFile:c},l[1]&&(l=a.cleanPath(l[1]),n.parentFile=l,n.proxyParent=l),n.fits2fits=!1,n.fixpath=!1,a.Load(c,n,{display:e.display}));break;case "regions":if((l=
...
case -16:h.data=new Uint16Array(f.height*f.width);break;case 32:h.data=new Int32Array(f.height*f.width);break;case -32:h.data=new Float32Array(f.height*f.width);break;case -64:h.data=new Float64Array(f.height*f.width);break;default:a.error("unsupported bitpix: "+d.bitpix)}var l=h.width*h.height;for(b=0;b<l;b++)h.data[b]=f.data[b];h.bitpix=d.bitpix}else switch(f.bitpix){case 8:h.data=new Uint8Array(f.data);break;case 16:h.data=new Int16Array(f.data);break;case -16:h.data=new Uint16Array(f.data);break;
...
a.globalOpts.rotationCenter;if("file"!==k.center&&this.validWCS()){var n=this.getPan();(f=a.pix2wcs(this.raw.wcs,n.x,n.y).trim().split(/\s+/))&&1<f.length&&(m.CRPIX1=n.x,m.CRPIX2=n.y,m.CRVAL1=a.saostrtod(f[0]),a.isHMS(this.params.wcssys)&&(m.CRVAL1*=15),m.CRVAL2=a.saostrtod(f[1]))}d.wcsinfo&&(e=d.wcsinfo.cdelt1||0,g=d.wcsinfo.cdelt2||0);if("string"===typeof h)switch(h.toLowerCase()){case "northisup":case "northup":h=0;0<e&&(e=-e);0>g&&(g=-g);break;default:h=parseInt(h,10)}a.notNull(l.CD1_1)?(g=-(h*
Math.PI/180),e=Math.sin(g),g=Math.cos(g),m.CD1_1=l.CD1_1*g+l.CD1_2*e,m.CD1_2=l.CD1_1*-e+l.CD1_2*g,m.CD2_1=l.CD2_1*g+l.CD2_2*e,m.CD2_2=l.CD2_1*-e+l.CD2_2*g):(m.CROTA2=h,m.CDELT1=e,m.CDELT2=g);k.lcsUseRota2=!0;d.wcsinfo&&(m.ptype=d.wcsinfo.ptype);this.xeqStashSave("rotateData",b.slice(),k.rawid);return this.reprojectData(m,k)};a.Image.prototype.reproject=function(c,b){var d,e,f,g,h=!1;var k={};var l=/SIMPLE|BITPIX|NAXIS|NAXIS[1-4]|AMDX|AMDY|CD[1-2]_[1-2]|CDELT[1-4]|CNPIX[1-4]|CO1_[1-9][0-9]|CO2_[1-9][0-9]|CROTA[1-4]|CRPIX[1-4]|CRVAL[1-4]|CTYPE[1-4]|CUNIT[1-4]|DATE|DATE_OBS|DC-FLAG|DEC|DETSEC|DETSIZE|EPOCH|EQUINOX|EQUINOX[a-z]|IMAGEH|IMAGEW|LATPOLE|LONGPOLE|MJD-OBS|PC00[1-4]00[1-4]|PC[1-4]_[1-4]|PIXSCALE|PIXSCAL[1-2]|PLTDECH|PLTDECM|PLTDECS|PLTDECSN|PLTRAH|PLTRAM|PLTRAS|PPO|PROJP[1-9]|PROJR0|PV[1-3]_[1-3]|PV[1-4]_[1-4]|RA|RADECSYS|SECPIX|SECPIX|SECPIX[1-2]|UT|UTMID|VELOCITY|VSOURCE|WCSAXES|WCSDEP|WCSDIM|WCSNAME|XPIXSIZE|YPIXSIZE|ZSOURCE|LTM|LTV/;
...
x;p.angle=q;l=new fabric.Group(u,p);break;case "ellipse":f.shape="ellipse";p.rx=f.r1;p.ry=f.r2;l=new fabric.Ellipse(p);break;case "point":f.shape="point";switch(f.ptshape){case "x":f.text="\u00d7";p.fill=p.stroke;p.fontSize=6*p.width;l=new fabric.Text(f.text,p);break;case "+":f.text="+";p.fill=p.stroke;p.fontSize=7*p.width;l=new fabric.Text(f.text,p);break;case "box":l=new fabric.Rect(p);break;case "circle":l=new fabric.Circle(p);break;case "ellipse":l=new fabric.Ellipse(p);break;default:l=new fabric.Rect(p)}break;
case "line":f.shape="line";l=new fabric.Polyline(p.points,p);break;case "polygon":f.shape="polygon";l=new fabric.Polygon(p.points,p,!0);break;case "text":f.shape="text";f.text=p.text||"Double-click to add text here";p.fill=p.stroke;p.strokeWidth=0;l=new fabric.Text(f.text,p);break;default:a.error("unknown shape: "+x.shape)}k.add(l);f.layerName=c;f.sw1=Math.max(1,Math.floor(l.strokeWidth+.5));f.listonchange=!1;l.params=f;x="main"!==this.display.layers[c].dtype||l.params.preservedcoords?1:this.rgb.sect.zoom;
if(e.opts.panzoom)switch(f.shape){case "point":case "text":break;default:l.scale(x)}l.rescaleBorder();!1===l.params.changeable&&k.sendToBack(l);this._handleChildText(c,l,p);"TBD"!==d.parent&&this._updateShape(c,l,null,"add",f);if(d.onaddshapes&&l.pub)try{a.xeqByName(d.onaddshapes,this,this,l.pub)}catch(v){a.error("in onaddshapes callback",v,!1)}g.push(l);p.groupid&&(h[p.groupid]=h[p.groupid]||[],h[p.groupid].push(l))}}e=$jscomp.makeIterator(Object.keys(h));for(b=e.next();!b.done;b=e.next())b=b.value,
this.groupShapes(c,h[b],{groupid:b,select:!1});(void 0===f.redraw||f.redraw)&&k.renderAll();return"object"===d.rtn?l:"objs"===d.rtn?g:f.id}}}};a.Fabric._parseShapes=function(c,b,d){var e=this;if(!this.layers||!c||!this.layers[c])return null;var f=this.layers[c].canvas;d=d||{};a.tmp.regSelect={layer:c,im:this,all:[]};f.getObjects().forEach(function(b){b.params?b.params.parent||a.tmp.regSelect.all.push(b.params.id):"group"===b.type&&(b=e.lookupGroup(b))&&a.tmp.regSelect.all.push(b)});try{regSelect.parse(b)}catch(g){a.error("parsing selection filter: "+
b,g)}if(d.saveselection&&b)switch(b.trim()){case "all":case "saved":case "selected":break;default:this.layers[c].selection=b}b=a.tmp.regSelect.ids;delete a.tmp.regSelect;return b};a.Fabric._selectShapes=function(c,b,d,e){var f=this,g,h,k,l=[],m=function(a,b){0>$.inArray(a,l)&&(e.call(f,a,b),l.push(a))},n=function(a){var b;if(!a)return[];var c=a.length;do{for(b=0;c--;){var d=a[c];"group"!==d.type||d.params||(a.splice.apply(a,[c,1].concat($jscomp.arrayFromIterable(d.getObjects()))),b++)}c=a.length}while(b);
return a},q=function(a,b){var c,d,e=[],f=[];var g=b.length;for(c=0;c<g;c++){var h=b[c];("activeSelection"===h.type||"group"===h.type&&!h.params)&&e.push(h)}var k=e.length;(d=a.getActiveObject())&&("activeSelection"===d.type||"group"===d.type&&!d.params||(d=null));if(k||d)for(c=0;c<g;c++){var l=b[c];for(a=0;a<k;a++)h=e[a],h.contains(l)&&(f[c]=h);f[c]||d&&d.contains(l)&&(f[c]=d)}return f},p=function(a,b){var c;for(c=0;c<b.length;c++){var d=b[c];if("activeSelection"===d.type||"group"===d.type&&!d.params){if(d.contains(a))return d}else if(d.params&&
d===a)return u[c]}return null};if(!this.layers||!c||!this.layers[c])return null;"function"!==typeof e&&a.error("selectShapes requires a callback");d=d||{};var x=this.layers[c].canvas;b||(b=x.getActiveObject()&&"auto"===a.globalOpts.regWhichDefault?"selected":"all");if("string"===typeof b&&b.startsWith("["))try{b=JSON.parse(b)}catch(y){a.error("can't parse array selection")}if("string"===typeof b){if(this.layers[c].selection){if("and"===d.saved)b="(saved) && ("+b+")";else if("or"===d.saved||!0===d.saved)b=
"(saved) || ("+b+")";b=b.replace(/saved/gi,this.layers[c].selection)}if(b.match(/&|\||!/))b=this._parseShapes(c,b,d);else if(d.saveselection&&b)switch(b.trim()){case "all":case "saved":case "selected":break;default:this.layers[c].selection=b}}$.isArray(b)||(b=[b]);for(h=0;h<b.length;h++){var w=x.getObjects().reverse();var t=w.length;var u=q(x,w);var v=b[h];"string"===typeof v&&/^[1-9]\d*$/.test(v)&&(v=parseInt(v,10));var r={group:null,canvas:x,layer:c};switch(typeof v){case "object":t=n(w);for(g=
t.length;g--;)if((k=t[g])&&k.params&&k===v){r.group=p(k,w);m(k,r);break}break;case "number":t=n(w);for(g=t.length;g--;)if((k=t[g])&&k.params&&k.params.id===v){r.group=p(k,w);m(k,r);break}break;case "string":if("selected"===v)for(t=n(x.getActiveObjects()),g=t.length;g--;)k=t[g],r.group=p(k,w),k.params&&!k.params.parent&&m(k,r);else for(;t--;)if(k=w[t],"group"===k.type&&!k.params)v===this.lookupGroup(k)||"all"===v.toLowerCase()?(r.group=k,!1!==d.transparentgroup?k.forEachObject(function(a){a.params&&
!a.params.parent&&m(a,r)}):m(k,r)):k.forEachObject(function(a){a.params&&v===a.params.file&&m(a,r)});else if(k.params&&(g=k.stroke.toLowerCase(),!k.params.parent||"child"===v||"All"===v)&&("child"!==v||k.params.parent))if(r.group=u[t],"all"===v.toLowerCase())m(k,r);else if(v.toLowerCase()===g||a.colorToHex(v).toLowerCase()===g)m(k,r);else if(v===k.params.shape)m(k,r);else if(v===k.params.file)m(k,r);else if("object"===typeof k.params.data&&v===k.params.data.syncid)m(k,r);else if("child"===v&&k.params.parent)m(k,
r);else if("dcoords"===v&&k.params.preservedcoords)m(k,r);else if("nodcoords"===v&&!k.params.preservedcoords)m(k,r);else if("parent"===v&&k.params.children&&k.params.children.length)m(k,r);else if(0<=$.inArray(v,a.wcssyss)&&k.params.wcsconfig&&k.params.wcsconfig.wcssys===v)m(k,r);else if(k.params.tags)for(g=0;g<k.params.tags.length;g++){var z=k.params.tags[g];v.match(/^\/.*\/$/)&&z.match(new RegExp(v.slice(1,-1)))?m(k,r):v===z&&m(k,r)}}}return this};a.Fabric.selectShapes=function(c,b,d){var e,f=[];
...
1]];break;case "box":case "cross":h.wcssizestr=[k[2],k[3]];break;case "circle":h.wcssizestr=[k[2]];break;case "ellipse":h.wcssizestr=[k[2],k[3]];break;case "line":case "polygon":for(h.wcspts=[],b=0;b<k.length;b+=2)l=a.strtoscaled(k[b]),a.isHMS(h.wcssys,l.dtype)&&(l.dval*=15),m=a.strtoscaled(k[b+1]),h.wcspts.push({ra:l.dval,dec:m.dval})}}};if(b&&b.params){d=d||{};f=f||{};e=e||"update";var w="main"!==this.display.layers[c].dtype||b.params.preservedcoords?1:this.rgb.sect.zoom;m.mode=e;m.id=b.params.id;
m.groupid=b.params.groupid;m.shape=b.params.shape;m.layer=c;m.color=b.color||b.stroke;m.tags=b.params.tags;m.sticky=b.params.sticky;m.preservedcoords=b.params.preservedcoords;b.params.ignore&&(m.ignore=!0);m.parent=b.params.parent?b.params.parent.obj.params.id:null;m.child=b.params.children&&b.params.children.length?b.params.children[0].id:null;var t=b.getCenterPoint();var u={x:0,y:0};if(d.group&&(6>fabric.major_version&&(u=d.group.getCenterPoint(),t={x:u.x+t.x*d.group.scaleX,y:u.y+t.y*d.group.scaleY},
d.group.angle&&(t=a.rotatePoint(t,d.group.angle,u))),"activeSelection"!==d.group.type)){if((l=n.canvas.getActiveObject())&&"activeSelection"===l.type){var v=l.getObjects();var r=v.length;for(h=0;h<r;h++)if(v[h]===d.group){var z=l.getCenterPoint();break}}z||(l=null);l&&6>fabric.major_version&&(t={x:z.x+t.x*l.scaleX,y:z.y+t.y*l.scaleY},l.angle&&(t=a.rotatePoint(t,l.angle,z)))}m.preservedcoords&&(m.dx=t.x,m.dy=t.y);h=this.displayToImagePos(t);m.x=h.x;m.y=h.y;m.lcs=this.imageToLogicalPos(h);"export"!==
e&&b.params.wcsconfig&&("image"===b.params.wcsconfig.wcssys?k="image":"physical"===b.params.wcsconfig.wcssys&&(k="physical"));"image"===k||"image"===this.params.wcssys&&"physical"!==k?(m.imsys="image",h=m.x,v=m.y,k=1):(m.imsys=m.lcs.sys,h=m.lcs.x,v=m.lcs.y,k=Math.sqrt(Math.pow(this.lcs.physical.reverse[0][0],2)+Math.pow(this.lcs.physical.reverse[0][1],2)));m.angle=-b.angle;d.group&&(m.angle-=d.group.angle);l&&(m.angle-=l.angle);l=m.angle;if(!m.parent)switch(m.shape){case "box":case "cross":case "ellipse":case "text":if(a.notNull(this.params.transformScale)&&
(m.angle/=this.params.transformScale),a.notNull(this.params.transformAngle)&&(m.angle-=this.params.transformAngle),this.raw.wcsinfo)this.raw.wcsinfo.crot&&(m.angle-=this.raw.wcsinfo.crot);else if(a.notNull(this.raw.header.LTM1_1)||a.notNull(this.raw.header.LTM1_2)){try{var y=Math.atan((this.raw.header.LTM1_2||0)/(this.raw.header.LTM1_1||0))}catch(E){y=0}y&&(y=180*-y/Math.PI,m.angle-=y)}}for(;0>m.angle;)m.angle+=360;for(;360<=m.angle;)m.angle-=360;t=b.scaleX/w;y=b.scaleY/w;d.group&&(t*=d.group.scaleX,
y*=d.group.scaleY);switch(m.shape){case "annulus":m.shape="annulus";m.radii=[];"image"!==m.imsys&&(m.lcs.radii=[]);m.imstr="annulus("+p(h)+","+p(v)+",";var A="annulus "+m.x+" "+m.y+" ";v=b.getObjects();r=v.length;for(h=0;h<r;h++)u=v[h].radius*t,y=u*k,m.imstr+=p(y),A=a.REGSIZE?A+(m.x+" "+m.y+" "+(m.x+u)+" "+m.y+" "):A+(u+" "),m.imstr=h===r-1?m.imstr+")":m.imstr+",",m.radii.push(u),"image"!==m.imsys&&m.lcs.radii.push(y);break;case "box":case "cross":m.width=b.width*t;m.height=b.height*y;y=m.width*k;
A=m.height*k;"image"!==m.imsys&&(m.lcs.width=y,m.lcs.height=A);m.imstr=m.shape+"("+p(h)+","+p(v)+","+p(y)+","+p(A)+","+m.angle.toFixed(4)+")";A=a.REGSIZE?m.shape+" "+m.x+" "+m.y+" "+m.x+" "+m.y+" "+(m.x+m.width)+" "+m.y+" "+m.x+" "+m.y+" "+m.x+" "+(m.y+m.height)+" "+m.angle*Math.PI/180:m.shape+" "+m.x+" "+m.y+" "+m.width+" "+m.height+" "+m.angle*Math.PI/180;break;case "circle":m.radius=b.radius*t;y=m.radius*k;"image"!==m.imsys&&(m.lcs.radius=y);m.imstr="circle("+p(h)+","+p(v)+","+p(y)+")";A=a.REGSIZE?
"circle "+m.x+" "+m.y+" "+m.x+" "+m.y+" "+(m.x+m.radius)+" "+m.y:"circle "+m.x+" "+m.y+" "+m.radius;break;case "ellipse":m.r1=b.width*t/2;m.r2=b.height*y/2;y=m.r1*k;A=m.r2*k;"image"!==m.imsys&&(m.lcs.r1=y,m.lcs.r2=A);m.imstr="ellipse("+p(h)+","+p(v)+","+p(y)+","+p(A)+","+m.angle.toFixed(4)+")";A=a.REGSIZE?"ellipse "+m.x+" "+m.y+" "+m.x+" "+m.y+" "+(m.x+m.r1)+" "+m.y+" "+m.x+" "+m.y+" "+m.x+" "+(m.y+m.r2)+" "+m.angle*Math.PI/180:"ellipse "+m.x+" "+m.y+" "+m.r1+" "+m.r2+" "+m.angle*Math.PI/180;break;
case "point":m.width=b.width*t;m.height=b.height*y;y=m.width*k;A=m.height*k;"image"!==m.imsys&&(m.lcs.width=y,m.lcs.height=A);m.imstr="point("+p(h)+","+p(v)+")";A="point "+m.x+" "+m.y;break;case "line":case "polygon":m.imstr=m.shape+"(";A=m.shape+" ";m.pts=[];"image"!==m.imsys&&(m.lcs.pts=[]);for(h=0;h<b.points.length;h++)if(0<h&&(m.imstr+=",",A+=" "),y=this.displayToImagePos({x:u.x+b.left+b.points[h].x*b.scaleX,y:u.y+b.top+b.points[h].y*b.scaleY}),y=a.rotatePoint(y,l,{x:m.x,y:m.y}),"image"===m.imsys?
m.imstr+=p(y.x)+","+p(y.y):(w=this.imageToLogicalPos(y),d=w.x,w=w.y,m.imstr+=p(d)+","+p(w),m.lcs.pts.push({x:d,y:w})),A+=y.x+" "+y.y,m.pts.push(y),"line"===m.shape)if(0===h)var C=0;else d=m.pts[h-1],C+=Math.sqrt((y.x-d.x)*(y.x-d.x)+(y.y-d.y)*(y.y-d.y));if("line"===m.shape&&a.notNull(C)){m.imstr+=') {"size":'+p(C)+',"units":"pixels"';if(2===m.pts.length){for(y=180*Math.atan2(m.pts[1].y-m.pts[0].y,m.pts[1].x-m.pts[0].x)/Math.PI;0>y;)y+=360;var B=',"posang":'+y.toFixed(4)+',"posunits":"degrees"';m.imstr+=
B}m.imstr+="}"}else m.imstr+=")";m.angle=0;break;case "text":m.imstr="text("+p(h)+","+p(v)+',"'+b.text+'",'+m.angle.toFixed(4)+")",A="text "+m.x+" "+m.y+' "'+b.text+'" '+m.angle*Math.PI/180,m.text=b.text}this.validWCS()&&(x(this.raw.wcs,n,m,A,B,f,m),"export"!==e&&b.params.wcsconfig&&b.params.wcsconfig.wcssys&&(p=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,u=this.getWCSSys(),a.notWCS(b.params.wcsconfig.wcssys)||(this.setWCSSys(b.params.wcsconfig.wcssys,!1),x(this.raw.wcs,n,m,A,B,f,b.params.wcsconfig)),
m.wcsconfig=$.extend(!0,{},b.params.wcsconfig),this.setWCSSys(u,!1),a.globalOpts.xeqPlugins=p));m.data=b.params.data;b.set("pub",m);b.params.winid&&($(b.params.winid).is(":visible")?this.initRegionsForm(b):b.params.winid=null);if(f.nocb)return m;(function(){var d=function(b){try{g.params.xeqonchange=!1,a.xeqByName(b,window,g,m)}catch(G){a.log("error in onchange: %s [%s]\n%s",g.id,G.message,a.strace(G))}finally{g.params.xeqonchange=!0}};b.params.parent||e.match(q)||(g.params.xeqonchange&&n.show&&(n.opts.onchange?
d(n.opts.onchange):"regions"===c&&a.Regions.opts.onchange&&d(a.Regions.opts.onchange)),d="on"+c+"change",g.xeqPlugins("shape",d,m))})();if("regions"===c&&a.globalOpts.regToClipboard){switch(e){case "update":h=m.parent||m.id;break;default:h=null}if(a.notNull(h)){try{var D=this.listRegions(h,{mode:1,includedcoords:!0})}catch(E){D=null}D&&(a.clipboard=D)}}"regions"===c&&"wcs"===e&&this._updateMultiDialogs(!0);return m}};a.Fabric.lookupGroup=function(a,b){var c;b=b||"regions";if(!this.getShapeLayer(b))return null;
...
f.sort(function(a,b){return(a.id||0)-(b.id||0)});return f};a.Fabric.changeShapes=function(c,b,d){var e=this,f,g,h,k,l,m,n,q,p,x,w,t,u=[],v=[];if((l=this.getShapeLayer(c))&&d){if("string"===typeof d)try{d=JSON.parse(d)}catch(y){a.error("can't parse shape opts: "+d,y)}if(this.display.image!==this)this.delayedShapes=this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"change",opts:d});else{var r=l.canvas;if((m=r.getActiveObject())&&"activeSelection"===m.type){var z=r.getActiveObjects();
r.discardActiveObject();r.renderAll();m=null}a.isNull(d.saveselection)&&(d.saveselection=!0);this._selectShapes(c,b,d,function(b,z){p="main"!==e.display.layers[c].dtype||b.params.preservedcoords?1:e.rgb.sect.zoom;d.radii&&(b.params.radii=[]);d.tags&&(b.params.tags=[]);void 0!==d.locked&&delete b.params.changeable;k=$.extend(!0,{},b.params,d);h=e._parseShapeOptions(c,k,b);if(h.remove){if(!0===h.remove||"true"===h.remove)h.remove="all";if(!1!==h.remove&&"false"!==h.remove){e.removeShapes(c,h.remove||
"all");return}}x=e._exportShapeOptions(d).filter(function(a){return!{}.hasOwnProperty.call(b.params.exports,a)});h.params.exports=b.params.exports.concat(x);h.opts.stroke&&(h.opts.color=h.opts.stroke,h.opts.stroke=a.colorToHex(h.opts.stroke));switch(b.params.shape){case "text":h.opts.stroke&&(h.opts.fill=h.opts.stroke);h.opts.strokeWidth=0;break;case "line":case "polygon":h.opts.points&&h.opts.points.length&&(b.angle=0)}b.set(h.opts);b.params=$.extend(!1,{},b.params,h.params);h.opts.strokeWidth&&
(b.params.sw1=h.opts.strokeWidth);switch(b.params.shape){case "annulus":if(d.radii&&d.radii.length){b.forEachObject(function(a){u.push(a)});n=u.length;for(f=0;f<n;f++)b.remove(u[f]),r.remove(u[f]);n=b.params.radii.length;q=0;w=$.extend(!0,{},d);w.stroke=w.stroke||b.get("stroke");w.strokeWidth=w.strokeWidth||b.get("strokeWidth");w.strokeDashArray=w.strokeDashArray||b.get("strokeDashArray");for(f=0;f<n;f++)w.radius=b.params.radii[f],g=new fabric.Circle(w),q=Math.max(q,b.params.radii[f]),b.add(g);b.scaleX=
p;b.scaleY=p;b.width=2*q;b.height=2*q;m===b&&r.setActiveObject(b)}break;case "box":d.width&&(b.scaleX=p);d.height&&(b.scaleY=p);break;case "circle":d.radius&&(b.scaleX=p,b.scaleY=p);break;case "cross":w=$.extend(!0,{},d);w.stroke=w.stroke||b.get("stroke");w.width&&(b.scaleX=p,v[0]=[{x:-w.width/2,y:0},{x:w.width/2,y:0}],delete w.width);w.height&&(b.scaleY=p,v[1]=[{x:0,y:-w.height/2},{x:0,y:w.height/2}],delete w.height);w.angle&&delete w.angle;b.forEachObject(function(a,b){t=$.extend(!0,{},w);v[b]&&
(t.points=v[b]);a.set(t)});break;case "ellipse":d.r1&&(b.rx=b.params.r1,b.scaleX=p,b.width=2*b.rx);d.r2&&(b.ry=b.params.r2,b.scaleY=p,b.height=2*b.ry);break;case "line":case "polygon":if(d.points&&d.points.length||d.pts&&d.pts.length)b.scaleX=p,b.scaleY=p;m===b&&(a.Fabric.removePolygonAnchors(l.dlayer,b),a.Fabric.addPolygonAnchors(l.dlayer,b));a.resetPolygonCenter(b);break;case "text":d.text&&(b.params.text=d.text)}b.rescaleBorder();!1===b.params.changeable&&r.sendToBack(b);switch(h.opts.send){case "front":r.bringToFront(b);
m===b&&r.discardActiveObject();break;case "back":r.sendToBack(b),m===b&&r.discardActiveObject()}a.Fabric.updateChildren(l.dlayer,b,"moving");a.Fabric.updateChildren(l.dlayer,b,"scaling");a.Fabric.updateChildren(l.dlayer,b,"rotating");a.Fabric.updateChildren(l.dlayer,b,"deltas");b.setCoords();e._handleChildText(c,b,d);e._updateShape(c,b,z,"update");if(d.onchangeshapes&&b.pub)try{a.xeqByName(d.onchangeshapes,e,e,b.pub)}catch(C){a.error("in onchangeshapes callback",C,!1)}});z&&this.selectShapes(c,z);
(void 0===d.redraw||d.redraw)&&r.renderAll();return this}}};a.Fabric.refreshShapes=function(c){if(c){var b={mode:1,sticky:!1,ignoreignore:!0,saveediting:!0,savewcsconfig:!0,sortids:!1,saveid:!0};var d=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;var e=this.getWCSSys();"image"===e&&(this.validWCS()?this.setWCSSys("native",!1):this.setWCSSys("physical",!1));if(this.tmp.panzoomRefresh&&this.tmp.panzoomRefresh[c])this.tmp.panzoomRefresh[c].regstr?this.tmp.panzoomRefresh[c].refresh&&(b=this.tmp.panzoomRefresh[c].regstr,
...
b,d){var e=Number.MAX_VALUE;if(b&&b.points){d=a.eventToDisplayPos(d);var f=b.getCenterPoint().x;var g=b.getCenterPoint().y;f=(d.x-f)/b.get("scaleX");var h=(d.y-g)/b.get("scaleY");for(g=-b.get("angle")*Math.PI/180;g>2*Math.PI;)g-=2*Math.PI;d=Math.cos(g)*f-Math.sin(g)*h;h=Math.sin(g)*f+Math.cos(g)*h;f=b.points;for(g=0;g<f.length;g++){var k=f[g];var l=f[(g+1)%f.length];var m=k.x<l.x?k.x:l.x;var n=k.y<l.y?k.y:l.y;var q=k.x>l.x?k.x:l.x;var p=k.y>l.y?k.y:l.y;var x=k.x-l.x;k=k.y-l.y;var w=Math.sqrt(x*x+
k*k);0!==w&&(x/=w,k/=w);w=d-l.x;var t=h-l.y;w=w*x+t*k;x=l.x+x*w;l=l.y+k*w;x<m?x=m:x>q&&(x=q);l<n?l=n:l>p&&(l=p);m=(x-d)*(x-d)+(l-h)*(l-h);if(m<e){e=m;var u=x;var v=l;var r=g===f.length?0:g}}c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,b);f.splice(r+1,0,{x:u,y:v});switch(b.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(c.dlayer,b),c.dlayer.canvas.renderAll()}b.polyparams?c.dlayer.params.sel=b.polyparams.polygon:b.params&&(c.dlayer.params.sel=b)}};a.Fabric._removePolygonPoint=
