...
"zscale"===b.scaleclipping?e.zscale(!0):"zmax"===b.scaleclipping&&e.zscale("zmax");a.notNull(b.scalemin)&&(e.params.scalemin=b.scalemin);a.notNull(b.scalemax)&&(e.params.scalemax=b.scalemax)},l=function(b){var c=a.globalOpts.imopts,d=a.globalOpts.imcmap,g=a.globalOpts.alerts;var h=/(annulus|box|circle|ellipse|line|polygon|point|text) *\(/;a.images.push(e);e.display.clearMessage();f&&(a.notNull(f.flip)||a.notNull(f.rotate)||a.notNull(f.rot90))&&e.setTransform();e.displayImage("all",f);e.notifyHelper();
e.showShapeLayer("regions",!0,{local:!0});f&&((a.notNull(f.x)&&a.notNull(f.y)||a.notNull(f.px)&&a.notNull(f.py)||a.notNull(f.ra)&&a.notNull(f.dec)||a.notNull(f.wcs))&&e.setPan(f),f.regions&&(f.regions.match(h)?e.addShapes("regions",f.regions):a.LoadRegions(f.regions,{display:e.display})));a.globalOpts.alerts=!1;if(e.raw&&e.raw.header&&e.raw.header[d]){try{var k=JSON.parse(e.raw.header[d])}catch(y){k=null}if(k)try{a.AddColormap(k)}catch(y){}}if(e.raw&&e.raw.header&&e.raw.header[d+"1"]){var l=1;for(h=
"";100>l;l++){var m=d+String(l);if(e.raw.header[m])h+=e.raw.header[m];else break}if(h){try{k=JSON.parse(h)}catch(y){k=null}if(k)try{a.AddColormap(k)}catch(y){}}}if(e.raw&&e.raw.header&&e.raw.header[c]){try{k=JSON.parse(e.raw.header[c])}catch(y){k=null}if(k)try{e.setParam("all",k)}catch(y){}}if(e.raw&&e.raw.header&&e.raw.header[c+"1"]){l=1;for(h="";100>l;l++)if(m=c+String(l),e.raw.header[m])h+=e.raw.header[m];else break;if(h){try{k=JSON.parse(h)}catch(y){k=null}if(k)try{e.setParam("all",k)}catch(y){}}}a.globalOpts.alerts=
g;e.xeqPlugins("image","onimageload");e.setStatus("load","complete");a.waiting(!1);if(b)try{a.xeqByName(b,window,e)}catch(y){a.error("in image onload callback",y,!1)}if(a.preloadwaiting&&a.preloadwaiting.length){var n=a.preloadwaiting.length;b=e.proxyURL||e.file;for(k=l=0;l<n;l++){var z=a.preloadwaiting[l];b.match(z.id)||z.id.match(b)?(z.loaded=!0,z.im=e):!1===z.loaded&&k++}if(!k){a.globalOpts.sortPreloads?(a.images.sort(function(b,c){var d=0,e=0;for(l=0;l<n;l++)z=a.preloadwaiting[l],b.id===z.im.id&&
(d=l),c.id===z.im.id&&(e=l);return d-e}),b=a.preloadwaiting[n-1].im||e,b.displayImage()):b=e;if(a.notNull(a.globalOpts.onpreload))try{a.xeqByName(a.globalOpts.onpreload,window,b)}catch(y){a.error("in onpreload callback",y,!1)}finally{delete a.globalOpts.onpreload}a.preloadwaiting=[]}}f&&f.allext&&e.hdus&&0<e.hdus.length&&e.displayExtension("all")};if(b)if("object"===typeof b){if(f=b,f.display)var m=f.display}else m=b;m||(m=0<a.displays.length?a.displays[0].id:a.DEFID);this.type="image";this.display=
a.lookupDisplay(m);this.params={};this.regstack=[];this.tmp={};this.groups={};this.params.xeqonchange=!0;this.params=$.extend(!0,this.params,a.imageOpts,f);this.display.image&&(this.params.inherit=this.display.image.params.inherit,this.params.inherit&&(this.params=$.extend(!0,this.params,this.display.image.params)));b=a.globalOpts.xeqPlugins;m=this.params.overlay;a.globalOpts.xeqPlugins=!1;this.setColormap(this.params.colormap);this.params.overlay=m;a.globalOpts.xeqPlugins=b;this.displayMode=!0;this.clickState=
...
this.raw.header.BITPIX=this.raw.bitpix;e=this.raw.header;m||this.parentFile||this.parent||void 0===e.LTV1&&void 0===e.LTV2&&void 0===e.LTM1_1&&void 0===e.LTM2_2||(this.parent={},this.parent.raw={header:$.extend(!0,{},e)},this.parent.lcs={},a.Image.prototype.initLCS.call(this.parent,this.parent.raw.header));if("image"===l.imtab&&void 0!==l.x1&&1!==l.x1||void 0!==l.y1&&1!==l.y1||void 0===l.bin||1!==l.bin)h=a.defNull(l.x1,1),k=a.defNull(l.y1,1),f=l.bin||1,0>f&&(f=1/Math.abs(f)),a.notNull(e.NAXIS1)&&
(e.NAXIS1/=f),a.notNull(e.NAXIS2)&&(e.NAXIS2/=f),a.notNull(e.CRPIX1)&&(e.CRPIX1=(e.CRPIX1+1-h-.5)/f+.5),a.notNull(e.CRPIX2)&&(e.CRPIX2=(e.CRPIX2+1-k-.5)/f+.5),a.notNull(e.CDELT1)&&(e.CDELT1*=f),a.notNull(e.CDELT2)&&(e.CDELT2*=f),a.notNull(e.CD1_1)&&(e.CD1_1*=f),a.notNull(e.CD1_2)&&(e.CD1_2*=f),a.notNull(e.CD2_1)&&(e.CD2_1*=f),a.notNull(e.CD2_2)&&(e.CD2_2*=f),e.LTM1_1=a.defNull(e.LTM1_1,1),e.LTM1_1/=f,e.LTM2_1=e.LTM2_1||0,e.LTM2_1/=f,e.LTM1_2=e.LTM1_2||0,e.LTM1_2/=f,e.LTM2_2=a.defNull(e.LTM2_2,1),
e.LTM2_2/=f,e.LTV1=e.LTV1||0,e.LTV1=(e.LTV1-h)/f+.5,e.LTV2=e.LTV2||0,e.LTV2=(e.LTV2-k)/f+.5;b.lcsUseRota2&&(e.LCSROTA2=!0);b.file&&b.file!==this.file?(this.file=b.file,this.id=null):b.filename&&b.filename!==this.file?(this.file=b.filename,this.id=null):l.file&&l.file!==this.file&&(this.file=l.file,this.id=null);this.file0=this.file=a.cleanPath(this.file)||a.ANON+a.uniqueID();b.id&&(this.id0=b.id,this.id=a.getImageID(b.id,this.display.id,this));this.id||!this.file||this.file.match(/\[.*[^a-zA-Z0-9_].*\]/)||
(b.extname||b.extnum?(b.extname?(this.file=this.file.replace(/\[.*\]/,""),this.file+="["+b.extname+"]"):b.extnum&&0<b.extnum&&(this.file=this.file.replace(/\[.*\]/,""),this.file+="["+b.extnum+"]"),l.fits&&(b.extname&&(l.fits.extname=b.extname),b.extnum&&0<b.extnum&&(l.fits.extnum=b.extnum))):l.fits?l.fits.extname?(this.file=this.file.replace(/\[.*\]/,""),this.file+="["+l.fits.extname+"]"):l.fits.extnum&&0<l.fits.extnum&&(this.file=this.file.replace(/\[.*\]/,""),this.file+="["+l.fits.extnum+"]"):this.raw.header&&
this.raw.header.EXTNAME&&(this.file=this.file.replace(/\[.*\]/,""),this.file+="["+this.raw.header.EXTNAME+"]"));this.id||(this.id0=(this.parentFile||this.file).split("/").reverse()[0],this.id=a.getImageID(this.id0,this.display.id,this));b.proxyFile&&(this.proxyFile=b.proxyFile);this.raw.filter=b.filter||"";this.raw.columns=b.columns||"";this.imtab=l.imtab?l.imtab:l.table?"table":"image";this.raw.imtab=this.imtab;void 0!==l.dmin&&void 0!==l.dmax?this.dataminmax(l.dmin,l.dmax):this.dataminmax();this.object=
this.raw.header.OBJECT;this.telescope=this.raw.header.TELESCOP;this.instrument=this.raw.header.INSTRUME;if(b.binstr)try{(t=b.binstr.split(/\s+/))&&2===t.length&&("table"===this.imtab&&l.table?(l.table.bin=parseFloat(t[0]),l.table.binMode=t[1]):(l.bin=parseFloat(t[0]),l.binMode=t[1]))}catch(u){}this.binning.bin="table"===this.imtab&&l.table?l.table.bin||1:l.bin?0<l.bin?l.bin:1/Math.abs(l.bin):1;m||(this.binning.obin=this.binning.bin);x&&this.setWCSSys(x);w&&this.setWCSUnits(w);m&&m.header.CTYPE1&&
m.header.CTYPE2&&this.raw.header.CTYPE1&&this.raw.header.CTYPE2&&(m.header.CTYPE1!==this.raw.header.CTYPE1||m.header.CTYPE2!==this.raw.header.CTYPE2)&&this.initWCS();a.notNull(l.offscreen)&&(this.png={image:l.offscreen},this.mkOffScreenCanvas());this.initWCS();this.initLCS();try{if(b.hdus)this.hdus=b.hdus;else if(this.parentFile&&a.helper.connected&&a.helper.js9helper)c={id:this.expandMacro("$id"),cmd:this.expandMacro("js9Xeq listhdus $filename"),image:this.file,fits:this.parentFile,rtype:"text"},
a.helper.send("listhdus",c,function(a){if(!a.stderr&&!a.errcode&&a.stdout)try{d.hdus=JSON.parse(a.stdout)}catch(v){d.hdus=null}});else if(this.raw.hdu&&this.raw.hdu.fits&&(t=a.listhdu(this.raw.hdu.fits.vfile)))try{this.hdus=JSON.parse(t)}catch(u){this.hdus=null}}catch(u){}if(this.raw.hdu&&this.raw.hdu.fits&&this.raw.hdu.fits.vfile){t=a.globalOpts.clearImageMemory;t=!1===t?["never"]:!0===t?["always"]:t.toLowerCase().split(/[,>]/);m=c=!1;e=0;for(b=!1;e<t.length&&!b;e++)switch(t[e]){case "never":c=!1;
b=!0;break;case "always":b=c=!0;break;case "heap":m=!0;break;case "auto":2>=this.raw.header.NAXIS&&(!this.hdus||1===this.hdus.length)?c=!0:(c=!1,b=!0);break;case "nocube":2>=this.raw.header.NAXIS?c=!0:(c=!1,b=!0);break;case "noext":this.hdus&&1!==this.hdus.length?(c=!1,b=!0):c=!0;break;case "size":t[e+1]?a.vsize(l.fits.vfile)>1E6*t[e+1]?c=!0:(c=!1,b=!0):(c=!1,b=!0)}c?(2<a.DEBUG&&a.log("removing underlying FITS vfile for %s: %s",this.id,this.raw.hdu.fits.vfile),a.cleanupFITSFile(this.raw,!0)):m&&(2<
a.DEBUG&&a.log("freeing heap space for %s: %s",this.id,this.raw.hdu.fits.vfile),a.cleanupFITSFile(this.raw,!1))}this.xeqPlugins("image","onrawdata");return this};a.Image.prototype.mkSection=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=this;d=this.rgb.sect;var f=function(a){var b=e.display.canvas;return e.params.transformAngle?(b=Math.max(b.width,b.height),Math.min(e.raw.width*a,b)):Math.min(e.raw.width*a,b.width)},g=function(a){var b=e.display.canvas;return e.params.transformAngle?
...
d.ycen=parseFloat(b[1]);a.notNull(d.ix)&&(d.width=f(d.zoom));a.notNull(d.iy)&&(d.height=g(d.zoom));break;case 3:a.isNumber(b[0])&&a.isNumber(b[1])&&a.isNumber(b[2])||a.error("invalid input for generating section: "+b[0]+" "+b[1]+" "+b[2]),d.xcen=parseFloat(b[0]),d.ycen=parseFloat(b[1]),d.zoom=parseFloat(b[2]),d.width=f(d.zoom),d.height=g(d.zoom)}delete d.ix;delete d.iy;d.x0=d.xcen-d.width/(2*d.zoom);d.y0=d.ycen-d.height/(2*d.zoom);d.x1=d.xcen+d.width/(2*d.zoom);d.y1=d.ycen+d.height/(2*d.zoom);0>d.x0&&
(a.globalOpts.panWithinDisplay?d.x1-=d.x0:d.ix=d.x0*d.zoom,d.x0=0);0>d.y0&&(a.globalOpts.panWithinDisplay?d.y1-=d.y0:d.iy=d.y0*d.zoom,d.y0=0);d.x1>this.raw.width&&(a.globalOpts.panWithinDisplay?d.x0-=d.x1-this.raw.width:d.ix=(d.x1-this.raw.width)*d.zoom,d.x1=this.raw.width);d.y1>this.raw.height&&(a.globalOpts.panWithinDisplay?d.y0-=d.y1-this.raw.height:d.iy=(d.y1-this.raw.height)*d.zoom,d.y1=this.raw.height);0<d.ix&&0<d.x0&&(b=Math.min(d.ix,d.x0),d.x0-=b,d.ix+=b*d.zoom);0>d.ix&&d.x1<this.raw.width&&
...
this.raw.width*this.raw.height;k=this.raw.dmax-this.raw.dmin;var p=this.raw.dmax;b=this.raw.dmin;var x=c=0;m=[];if(!this.hist||!this.hist.length){this.hist=[];for(h=0;h<g;h++)m[h]=0;for(h=0;h<q;h++)l[h]>=b&&l[h]<=p&&(n=Math.floor((l[h]-b)/k*g+.5),n<g&&(m[n]+=1));for(h=0;h<g;h++)x+=m[h];n=x/g;for(h=l=0;h<g&&l<g;h++)for(this.hist[h]=l/g,c+=m[h];c>=n&&l<g;)c-=n,l++;for(c=(g-1)/g;h<g;)this.hist[h++]=c}for(h=0;h<e;h++)c=this.hist[h*g/e],c=Math.floor(c*d),this.psColors[h]=this.colorCells[c];for(h=0;h<f;h++){d=
h/f;for(n=0;n<g-1&&!(this.hist[n]>d);n++);c=n/g;this.psInverse[h]=c*k+b}break;default:a.error("unknown scale '"+this.params.scale+"'")}return this};a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f=!1,g=null,h=null,k=null,l=!1,m=!1,n=!1,q=!1,p=[];if(!this.rgb)return this;!this.display.rgb.active||this!==this.display.rgb.rim&&this!==this.display.rgb.gim&&this!==this.display.rgb.bim||(l=!0,this.display.rgb.rim&&(g=this.display.rgb.rim),this.display.rgb.gim&&(h=this.display.rgb.gim),this.display.rgb.bim&&
(k=this.display.rgb.bim));var x=this.display.context;var w=this.rgb;var t=w.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.useOffScreenCanvas()){var u=t.width/t.zoom;var v=t.height/t.zoom;var r=t.x0;var z=this.offscreen.canvas.height-1-(t.y0+v);z=this.offscreen.context.getImageData(r,z,u,v);if(1===t.zoom)w.img=z;else for(w.img=x.createImageData(t.width,
t.height),w=w.img,d=c=0;c<z.height;c++,d++){var y=c*z.width;var A=d*t.zoom;for(b=x=0;x<z.width;x++,b++){r=4*(y+x);var C=b*t.zoom;for(e=0;e<t.zoom;e++){var B=Math.floor(A+e);var D=B*t.width;for(B=0;B<t.zoom;B++){var E=Math.floor(C+B);E=4*(D+E);w.data[E]=z.data[r];w.data[E+1]=z.data[r+1];w.data[E+2]=z.data[r+2];w.data[E+3]=z.data[r+3]}}}}return this}w.img&&w.img.width===t.width&&w.img.height===t.height||(w.img=x.createImageData(t.width,t.height));w=w.img;var F=w.data.length-4;if(!this.psColors&&!this.staticObj)return this;
var G=void 0!==this.params.opacity?Math.floor(255*this.params.opacity):void 0!==this.params.alpha?this.params.alpha:255;if(this.mask.active&&this.mask.im){var J=this.mask.im;if("mask"===this.mask.mode){m=!0;var I=a.notNull(this.mask.vopacity)?255*this.mask.vopacity:0;var K=a.notNull(this.params.opacity)?255*this.params.opacity:255;this.mask.invert&&(G=I,I=K,K=G)}else if("opacity"===this.mask.mode)n=!0;else if("overlay"===this.mask.mode){q=!0;var L=J.rgb.img;a.isNull(this.mask.opacity)&&(this.mask.opacity=
1)}}else if(a.notNull(this.params.flooropacity)&&!l){var R=255*this.params.flooropacity;var M=this.params.floorvalue;f=!0}var N=Math.max(1,Math.floor(1/t.zoom));var P=t.zoom*N;c=Math.floor(t.y1-1);for(d=0;c>=t.y0;c-=N,d++)for(y=c*this.raw.width,A=d*P,x=Math.floor(t.x0),b=0;x<t.x1;x+=N,b++){m?G=J.raw.data[y+x]>this.mask.value?K:I:n&&(G=255*J.raw.data[y+x]);if(l){if(z=g?g.colorData[y+x]:0,u=h?h.colorData[y+x]:0,v=k?k.colorData[y+x]:0,a.isNull(z)||a.isNull(u)||a.isNull(v))return this.display.rgb.active=
!1,a.error("RGB images are incompatible. Turning off RGB mode.","",!1),this.mkRGBImage(),this}else this.staticObj||(r=this.colorData[y+x]);var Q=G;f&&this.raw.data[y+x]<=M&&(Q=R);C=b*P;for(e=0;e<t.zoom;e++)for(B=Math.ceil(A+e),D=B*t.width,B=0;B<t.zoom;B++)if(E=Math.ceil(C+B),E=4*(D+E),E<=F)if(l)w.data[E]=g?g.psColors[z][0]:0,w.data[E+1]=h?h.psColors[u][1]:0,w.data[E+2]=k?k.psColors[v][2]:0,w.data[E+3]=G;else if(this.staticObj){var H=this.raw.data[y+x];H=a.lookupStaticColor(this,H,p);w.data[E]=H.red;
w.data[E+1]=H.green;w.data[E+2]=H.blue;w.data[E+3]=H.alpha}else if(void 0!==this.psColors[r])if(q&&L.data[E+3]){H=L.data[E+3]/255*this.mask.opacity;var O=1-H;w.data[E]=L.data[E]*H+this.psColors[r][0]*O;w.data[E+1]=L.data[E+1]*H+this.psColors[r][1]*O;w.data[E+2]=L.data[E+2]*H+this.psColors[r][2]*O;w.data[E+3]=255}else w.data[E]=this.psColors[r][0],w.data[E+1]=this.psColors[r][1],w.data[E+2]=this.psColors[r][2],w.data[E+3]=Q}return this};a.Image.prototype.blendImage=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-
...
e,g)}a.isImage(e)||d||(d=e,e=null);e&&((f=a.lookupImage(e))||a.error("unknown image for maskImage: "+e),this.raw.width===f.raw.width&&this.raw.height===f.raw.height||a.error("maskImage: mask dims ("+f.raw.width+","+f.raw.height+") don't match image dims ("+this.raw.width+","+this.raw.height+")"),this.mask.im=f,this.mask.active=!0);if(d){if("string"===typeof d)try{d=JSON.parse(d)}catch(g){a.error("can't parse JSON in maskImage: "+d,g)}b=$jscomp.makeIterator(Object.keys(d));for(e=b.next();!e.done;e=
b.next())switch(e=e.value,e){case "opacity":this.mask.vopacity=d[e];break;default:this.mask[e]=d[e]}}!f||d&&!1===d.sync||"function"!==typeof this.syncImages||this.syncImages(this.mask.syncops,[f]);(f||d)&&this.displayImage()};a.Image.prototype.calcDisplayOffsets=function(c){var b=this.rgb.sect;this.ix=(this.display.canvas.width-this.rgb.img.width)/2;this.iy=(this.display.canvas.height-this.rgb.img.height)/2;a.notNull(b.ix)&&(this.ix-=b.ix/2);a.notNull(b.iy)&&(this.iy+=b.iy/2);this.ix=Math.floor(this.ix);
...
c=c||{};"reproject"===this.rawDataLayer()&&c.wcsim&&(this.wcsim=c.wcsim,this.wcsim.isawcsim=!0);this.calcDisplayOffsets(!0);e.save();void 0!==c.opacity&&(e.globalAlpha=c.opacity);void 0!==c.blend&&(e.globalCompositeOperation=c.blend);if(this.params.transform){c=this.params.transform;var f=this.display.width/2;var g=this.display.height/2;e.translate(f,g);e.transform(c[0][0],c[0][1],c[1][0],c[1][1],c[2][0],c[2][1]);e.translate(-f,-g)}e.drawImage(function(c){if(!b.offscreenRGB){var d=document.createElement("canvas");
var e=d.getContext("2d");a.ANTIALIAS||(e.imageSmoothingEnabled=!1);b.offscreenRGB={canvas:d,context:e}}b.offscreenRGB.canvas.width=c.width;b.offscreenRGB.canvas.height=c.height;b.offscreenRGB.context.putImageData(c,0,0);return b.offscreenRGB.canvas}(d.img),this.ix,this.iy);e.restore();return this};a.Image.prototype.displayImage=function(c,b){var d=0;var e=[],f={};if(!1===c)return this.displayMode=!1,this;!0===c&&(this.displayMode=!0,c="all");if(!this.displayMode)return this;"object"===typeof c&&(b=
c,c=null);c?"all"===c?(c="colors,scaled,rgb,display,plugins",f.notify=!0):"rgbonly"===c?(c="rgb,nodisplay",f.notify=!0):"display"===c&&(f.notify=!0):c="rgb";c.split(",").forEach(function(a,b,c){a=a.trim();f[a]=!0;switch(a){case "colors":f.scaled=!0;f.rgb=!0;break;case "scaled":f.rgb=!0}});f.display=!0;f.plugins=!0;this.useOffScreenCanvas()&&(f.colors=!1,f.scaled=!1);b=b||{};if("string"===typeof b)try{b=JSON.parse(b)}catch(h){a.error("can't parse displayImage opts: "+b,h)}if(this.display.blendMode&&
...
!0);!1!==l.waiting&&a.waiting(!0,d.display);c.fits.extname?g="["+c.fits.extname+"]":c.fits.extnum&&0<c.fits.extnum?g="["+c.fits.extnum+"]":d.parent&&(d.parent.extname?g="["+d.parent.extname+"]":d.parent.extnum&&0<d.parent.extnum&&(g="["+d.parent.extnum+"]"));g&&(l.id||(l.id=d.id.replace(/\[.*\]/,"")+g),l.file||(l.file=d.file.replace(/\[.*\]/,"")+g));if(l.separate){delete l.xcen;delete l.ycen;if("string"===typeof l.separate){g=l.separate.split(":");switch(g.length){case 1:e=g[0];break;default:e=g[0],
l.id=g[1]}l.display=a.lookupDisplay(e)}else l.display=d.display;"parentFile"===f&&d.fitsFile&&(e=a.lookupImage(d.fitsFile),l.parentFile=e&&e.parentFile?e.parentFile:d.fitsFile);h=d.listRegions("all",{mode:1,includedcoords:!0,ignoreignore:!0,saveediting:!0,savewcsconfig:!0,sortids:!1,saveid:!0});b=l.ondisplaysection||l.onrefresh||b;k=new a.Image(c,l,b);k.binning.obin=k.binning.bin;h&&!1!==l.refreshRegions&&k.addShapes("regions",h,{restoreid:!0});d.reFlipRot();k.setStatus("displaySection","complete")}else if("string"===
typeof l.refresh){delete l.xcen;delete l.ycen;g=l.refresh.split(":");switch(g.length){case 1:e=g[0];break;default:e=g[0],l.id=g[1]}l.display=a.lookupDisplay(e);l.display.image?(l.rawid=d.raw.id,l.onrefresh=l.ondisplaysection||l.onrefresh||b,l.display.image.refreshImage(c,l)):("parentFile"===f&&d.fitsFile&&(e=a.lookupImage(d.fitsFile),l.parentFile=e&&e.parentFile?e.parentFile:d.fitsFile),h=d.listRegions("all",{mode:1,includedcoords:!0,ignoreignore:!0,saveediting:!0,savewcsconfig:!0,sortids:!1,saveid:!0}),
b=l.ondisplaysection||l.onrefresh||b,k=new a.Image(c,l,b),k.binning.obin=k.binning.bin,h&&k.addShapes("regions",h,{restoreid:!0}),d.reFlipRot())}else l.rawid=d.raw.id,l.onrefresh=l.ondisplaysection||l.onrefresh||b,d.refreshImage(c,l);d.setStatus("displaySection","complete");a.waiting(!1)};this.raw&&this.raw.hdu&&this.raw.hdu.fits||a.error("invalid image for displaySection");c=c||{};if("full"===c){var p=this.fileDimensions();c={xdim:p.xdim,ydim:p.ydim,xcen:0,ycen:0}}else{if("selected"===c){this._selectShapes("regions",
"selected",null,function(a){a=a.pub;var c,e=0,f=0,g=1E6,h=0,k=1E6,m=0,n=a.shape;if(!d.parentFile&&a.lcs){a=a.lcs;var p=a.x;var x=a.y;if(c=d.maybePhysicalToImage({x:p,y:x}))p=c.x,x=c.y}else p=a.x,x=a.y;switch(n){case "annulus":var q=2*a.radii[a.radii.length-1];var w=2*a.radii[a.radii.length-1];break;case "box":q=a.width;w=a.height;break;case "circle":q=2*a.radius;w=2*a.radius;break;case "cross":q=a.width;w=a.height;break;case "ellipse":q=2*a.r1;w=2*a.r2;break;case "polygon":case "line":for(q=0;q<a.pts.length;q++)e+=
a.pts[q].x,f+=a.pts[q].y,a.pts[q].x>h&&(h=a.pts[q].x),a.pts[q].x<g&&(g=a.pts[q].x),a.pts[q].y>m&&(m=a.pts[q].y),a.pts[q].y<k&&(k=a.pts[q].y);a.x=e/a.pts.length;a.y=f/a.pts.length;"line"===a.shape&&2===a.pts.length?(q=Math.sqrt((a.pts[0].x-a.pts[1].x)*(a.pts[0].x-a.pts[1].x)+(a.pts[0].y-a.pts[1].y)*(a.pts[0].y-a.pts[1].y)),w=1):(q=h-g,w=m-k);break;case "text":w=q=10}l={xcen:p,ycen:x,xdim:q,ydim:w,from:"virtualFile",separate:!0,refreshRegions:!1,resetSection:!0};d.displaySection(l,b)});return}if("string"===
typeof c)try{c=JSON.parse(c)}catch(u){a.error("can't parse displaySection opts: "+c,u)}}c.cubecol=c.cubecol||"";if(c.cubecol){var x=this.file.split("/").reverse()[0].replace(/\[.*\]/,"").replace(".fits","_cube_"+c.cubecol+".fits").replace(/\.ftz$/,"_cube_"+c.cubecol+".fits").replace(/\.gz$/,"").replace(/\.bz2$/,"").replace(/:/g,"_");c.file||(c.file=x);c.id||(c.id=x);!1!==c.separate&&(c.separate=!0)}var w=c.separate?$.extend(!0,{},this.raw.hdu):this.raw.hdu;(f=c.from)||(f=this.parentFile&&a.helper.connected&&
a.helper.js9helper?"parentFile":"virtualFile");if("table"===this.imtab&&w.table)p=w.table;else{p={};p.bin=w.bin||1;"parentFile"===f&&this.raw.header&&a.notNull(this.raw.header.LTM1_1)&&(p.bin=1/Math.abs(this.raw.header.LTM1_1));var t={x:this.raw.width/2,y:this.raw.height/2};t=this.imageToLogicalPos(t);p.xcen=Math.floor(t.x+.5*(p.bin-1));p.ycen=Math.floor(t.y+.5*(p.bin-1));if(t=this.maybePhysicalToImage({x:p.xcen,y:p.ycen}))p.xcen=t.x,p.ycen=t.y;p.xdim=Math.floor(w.naxis1*p.bin);p.ydim=Math.floor(w.naxis2*
p.bin);p.filter=this.raw.filter||"";p.columns=this.raw.columns||""}if("string"===typeof c.bin)switch(c.bin.match(/[as]$/)&&(c.binMode=c.bin.slice(-1),c.bin=c.bin.slice(0,-1)),t=p.bin||this.binning.bin,c.bin.charAt(0)){case "*":case "x":case "X":c.bin=t*parseFloat(c.bin.slice(1));break;case "/":c.bin=t/parseFloat(c.bin.slice(1));break;case "i":case "I":c.bin=2*t;break;case "o":case "O":c.bin=t/2;break;default:a.isNumber(c.bin)?c.bin=parseFloat(c.bin):a.error("invalid bin for displaySection: "+c.bin)}c.xcen=
...
n.errcode+"]",n.stdout)a.log(c);else{k(c,a.analOpts.epattern);return}switch(f.rtype){case "text":case void 0:e.displayAnalysis("text",n.stdout,{divid:a.globalOpts.analysisDiv});break;case "plot":e.displayAnalysis("plot",n.stdout,{divid:a.globalOpts.analysisDiv});break;case "alert":n.stdout&&alert(n.stdout);break;case "fits":(l=n.stdout.split(/\s+/))&&l[0]&&(c=a.cleanPath(l[0]),"/"!==c.charAt(0)&&(c=a.InstallDir(c)),n={proxyFile:c},l[1]&&(l=a.cleanPath(l[1]),n.parentFile=l,n.proxyParent=l),n.fits2fits=
...
case "catalog":(l=n.stdout.split(/\s+/))&&l[0]&&(c=a.cleanPath(l[0]),h={responseType:"text"},a.fetchURL(null,c,h,function(a,b){e.loadCatalog(null,a,b)}));break;case "none":break;default:a.error("unknown analysis result type: "+f.rtype)}}e.setStatus("runAnalysis","complete");a.waiting(!1)});return this}a.error("could not find analysis task: "+c)}};a.Image.prototype.displayAnalysis=function(c,b,d){var e=this,f,g;var h=a.lightOpts[a.LIGHTWIN];var k=function(){var b=a.Plot.opts.title;if(p&&x){$(a.lightOpts[a.LIGHTWIN].topid).arrive("#plotConfigForm",
{onceOnly:!0},function(){a.Plot.initConfigForm.call(e,x,q)});var c=a.allinone?a.allinone.plotConfigHTML:a.InstallDir(a.Plot.opts.configURL);x.winid=e.displayAnalysis("params",c,{title:b,winformat:"width=368px,height=110px,resize=1,scrolling=1"})}};d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(w){a.error("can't parse displayAnalysis opts: "+d,w)}var l=d.winformat;d.divid&&0<$("#"+d.divid).length&&(f=$("#"+d.divid));var m=d.title||"";this&&!m&&(d=this.fitsFile||this.id||"",d=d.split("/").reverse()[0],
m="AnalysisResults: "+d+sprintf(a.IDFMT,this.display.id));d="Analysis_"+a.uniqueID();switch(c){case "text":b="<div class='JS9Analysis'></div><pre class='JS9AnalysisText'>"+((b||"")+"</pre></div>");if(f)f.html(b),window.electron&&a.searchbar(f[0]);else{l=l||h.textWin;var n=a.lightWin(d,"inline",b,m,l);window.electron&&a.searchbar(n)}break;case "plot":if(b&&"string"===typeof b)try{var q=JSON.parse(b)}catch(w){a.error("can't plot return data: "+b,w)}else"object"===typeof b&&(q=b);if(!q)return;q.curscale=
...
[b],h)}catch(w){a.error("can't plot data (plotly)",w)}break;default:h=$.extend(!0,{},a.Plot.opts,q.opts);a.Plot.opts.annotate&&q.annotations&&(h.zoomStack.func=function(b,c){a.Plot.annotate(p,b,q)});q.color=q.color||h.color;"log"===q.xscale&&(h.xaxis=h.xaxis||{},h.xaxis.transform=a.Plot.logfunc,h.xaxis.inverseTransform=a.Plot.expfunc,q.curscale.x="log");"log"===q.yscale&&(h.yaxis=h.yaxis||{},h.yaxis.transform=a.Plot.logfunc,h.yaxis.inverseTransform=a.Plot.expfunc,q.curscale.y="log");try{var x=$.plot(p,
[q],h)}catch(w){a.error("can't plot data (flot)",w)}a.Plot.opts.annotate&&q.annotations&&a.Plot.annotate(p,x,q)}p.css("outline","none");p.attr("tabindex",0);p.on("keydown",function(b){b=a.eventToCharStr(b);switch(b){case "c":k();break;case "x":case "y":g="linear"!==q.curscale[b]?"linear":"log",a.Plot.rescale(p,x,q,b,g)}});l=$("<img src='"+a.InstallDir("images/gears.png")+"'>");l.on("click",k);b=$("<div class='JS9PlotGear'>");b.append(l);p.append(b)}break;case "params":case "regions":case "textline":f?
a.allinone?f.html(b):$.ajax({url:b,cache:!1,dataType:"text",success:function(a){f.html(a)}}):(l="params"===c?l||h.paramWin:"regions"===c?"small"===a.globalOpts.regConfigSize?l||h.regWin0:l||h.regWin:l||h.dpathWin,n=a.allinone?"inline":"ajax",n=a.lightWin(d,n,b,m,l))}return n};a.Image.prototype.saveFITS=function(c,b){if({}.hasOwnProperty.call(window,"saveAs")){c?(c=c.replace(/\s+/g,"_").replace(/(png|jpg|jpeg|fz)$/i,"fits"),c.match(/.fits$/)||(c+=".fits")):c="js9.fits";b=b||{};if("string"===typeof b){try{var d=
...
this.imageToDisplayPos(c);h.sys="display";var k="image"===this.params.wcssys?f:g;d=this.raw.data[Math.floor(c.y-.5)*this.raw.width+Math.floor(c.x-.5)];switch(this.raw.bitpix){case 8:case 16:case -16:case 32:var l=e(d);break;case -32:case -64:l=a.floatFormattedString(d,this.params.precision,3);break;default:l=e(d)}e=l;var m=k.x.toFixed(3)+" "+k.y.toFixed(3)+" ("+k.sys+")";a.globalOpts.valposDCoords&&"image"===k.sys&&(m+="&nbsp;&nbsp;&nbsp;&nbsp;"+h.x.toFixed(3)+" "+h.y.toFixed(3)+" ("+h.sys+")");var n=
e+"&nbsp;&nbsp;&nbsp;&nbsp;"+m;d={ix:f.x,iy:f.y,ipos:f.x.toFixed(2)+"\t\t "+f.y.toFixed(2),isys:"image",px:g.x,py:g.y,ppos:g.x.toFixed(2)+"\t\t "+g.y.toFixed(2),psys:"physical",dx:h.x,dy:h.y,dpos:h.x.toFixed(2)+"\t\t "+h.y.toFixed(2),dsys:"display",cx:k.x,cy:k.y,cpos:k.x.toFixed(2)+"\t\t "+k.y.toFixed(2),csys:k.sys,ra:"",dec:"",wcspos:"",wcssys:"",racen:"",deccen:"",wcsfov:"",wcspix:"",val:d,val3:l,id:this.id,file:this.file,object:this.object||""};if(this.telescope||this.instrument)d.object&&(d.object+=
...
case -64:h.data=new Float64Array(f.height*f.width);break;default:a.error("unsupported bitpix: "+d.bitpix)}var l=h.width*h.height;for(b=0;b<l;b++)h.data[b]=f.data[b];h.bitpix=d.bitpix}else switch(f.bitpix){case 8:h.data=new Uint8Array(f.data);break;case 16:h.data=new Int16Array(f.data);break;case -16:h.data=new Uint16Array(f.data);break;case 32:h.data=new Int32Array(f.data);break;case -32:h.data=new Float32Array(f.data);break;case -64:h.data=new Float64Array(f.data);break;default:a.error("unsupported bitpix: "+
...
d=this.raws[0];d.header&&d.wcsinfo||a.error("no WCS info available for reprojection");k=k||{};if("string"===typeof k)try{k=JSON.parse(k)}catch(q){a.error("can't parse rotate opts: "+k,q)}k.stash="rotateData";k.rawid="rotate";k.oraw=a.RAWID0;!0!==k.resetSection&&(k.resetSection=!1);var l=d.header;var m=$.extend(!0,{},l);k.center=k.center||a.globalOpts.rotationCenter;if("file"!==k.center&&this.validWCS()){var n=this.getPan();(f=a.pix2wcs(this.raw.wcs,n.x,n.y).trim().split(/\s+/))&&1<f.length&&(m.CRPIX1=
n.x,m.CRPIX2=n.y,m.CRVAL1=a.saostrtod(f[0]),a.isHMS(this.params.wcssys)&&(m.CRVAL1*=15),m.CRVAL2=a.saostrtod(f[1]))}d.wcsinfo&&(e=d.wcsinfo.cdelt1||0,g=d.wcsinfo.cdelt2||0);if("string"===typeof h)switch(h.toLowerCase()){case "northisup":case "northup":h=0;0<e&&(e=-e);0>g&&(g=-g);break;default:h=parseInt(h,10)}a.notNull(l.CD1_1)?(g=-(h*Math.PI/180),e=Math.sin(g),g=Math.cos(g),m.CD1_1=l.CD1_1*g+l.CD1_2*e,m.CD1_2=l.CD1_1*-e+l.CD1_2*g,m.CD2_1=l.CD2_1*g+l.CD2_2*e,m.CD2_2=l.CD2_1*-e+l.CD2_2*g):(m.CROTA2=
h,m.CDELT1=e,m.CDELT2=g);k.lcsUseRota2=!0;d.wcsinfo&&(m.ptype=d.wcsinfo.ptype);this.xeqStashSave("rotateData",b.slice(),k.rawid);return this.reprojectData(m,k)};a.Image.prototype.reproject=function(c,b){var d,e,f,g,h=!1;var k={};var l=/SIMPLE|BITPIX|NAXIS|NAXIS[1-4]|AMDX|AMDY|CD[1-2]_[1-2]|CDELT[1-4]|CNPIX[1-4]|CO1_[1-9][0-9]|CO2_[1-9][0-9]|CROTA[1-4]|CRPIX[1-4]|CRVAL[1-4]|CTYPE[1-4]|CUNIT[1-4]|DATE|DATE_OBS|DC-FLAG|DEC|DETSEC|DETSIZE|EPOCH|EQUINOX|EQUINOX[a-z]|IMAGEH|IMAGEW|LATPOLE|LONGPOLE|MJD-OBS|PC00[1-4]00[1-4]|PC[1-4]_[1-4]|PIXSCALE|PIXSCAL[1-2]|PLTDECH|PLTDECM|PLTDECS|PLTDECSN|PLTRAH|PLTRAM|PLTRAS|PPO|PROJP[1-9]|PROJR0|PV[1-3]_[1-3]|PV[1-4]_[1-4]|RA|RADECSYS|SECPIX|SECPIX|SECPIX[1-2]|UT|UTMID|VELOCITY|VSOURCE|WCSAXES|WCSDEP|WCSDIM|WCSNAME|XPIXSIZE|YPIXSIZE|ZSOURCE|LTM|LTV/;
var m=/TAN|SIN|ZEA|STG|ARC/,n=function(b,c){if(!c)return b;b=$.extend(!0,{},b);a.isNull(b.CRVAL1)&&!a.isNull(c.crval1)&&(b.CRVAL1=c.crval1);a.isNull(b.CRVAL2)&&!a.isNull(c.crval2)&&(b.CRVAL2=c.crval2);a.isNull(b.CRPIX1)&&!a.isNull(c.crpix1)&&(b.CRPIX1=c.crpix1);a.isNull(b.CRPIX2)&&!a.isNull(c.crpix2)&&(b.CRPIX2=c.crpix2);a.isNull(b.CDELT1)&&!a.isNull(c.cdelt1)&&(b.CDELT1=c.cdelt1);a.isNull(b.CDELT2)&&!a.isNull(c.cdelt2)&&(b.CDELT2=c.cdelt2);a.isNull(b.CROTA2)&&!a.isNull(c.crot)&&(b.CROTA2=c.crot);
return b};if(a.reproject&&c&&this!==c){this.raws&&this.raws[0]||a.error("no raw data for reprojection");var q=this.raws[0];q.header&&q.wcsinfo||a.error("no WCS info available for reprojection");b=b||{};var p=$.extend(!0,{},q.header);var x=$jscomp.makeIterator(Object.keys(p));for(e=x.next();!e.done;e=x.next())e=e.value,l.test(e)&&delete p[e];if("object"===typeof c){c.raw&&c.raw.header?d=c.raw.header:c.BITPIX&&c.NAXIS1&&c.NAXIS2?d=c:a.error("invalid wcs object input to reproject()");x=$jscomp.makeIterator(Object.keys(d));
for(e=x.next();!e.done;e=x.next())e=e.value,l.test(e)&&(k[e]=d[e]);p=$.extend(!0,{},k,p);if(!p.NAXIS||!p.NAXIS1||!p.NAXIS2)return;p.NAXIS1=Math.min(p.NAXIS1,a.globalOpts.image.xdim);p.NAXIS2=Math.min(p.NAXIS2,a.globalOpts.image.ydim);k=a.raw2FITS(p,{addcr:!0});p="wcs_"+a.uniqueID()+".txt";a.vfile(p,k);a.globalOpts.reprojectLimits&&(k=a.globalOpts.image.xdim,l=a.globalOpts.image.ydim,e=a.globalOpts.image.xdim*a.globalOpts.image.ydim,q.header.NAXIS1*q.header.NAXIS2>e&&a.error("the max reproject size is "+
k+" * "+l+". You can use the Bin/Filter/Section plugin to extract a section, then save it as FITS and reproject the smaller image."))}else p=c;try{if(!m.test(q.wcsinfo.ptype)){var w=n(q.header,q.wcsinfo);var t="owcs_"+a.uniqueID()+".txt";a.vfile(t,a.raw2FITS(w,{addcr:!0}));var u="awcs_"+a.uniqueID()+".txt";var v=a.tanhdr(t,u,"");1<a.DEBUG&&a.log("tanhdr (input): %s %s -> %s",t,u,v);a.vunlink(t);0<=v.search(/\[struct stat="OK"/)&&(b.cmdswitches=b.cmdswitches||"",b.cmdswitches+=" -i "+u)}if(c.raw&&
!m.test(c.raw.wcsinfo.ptype)||c.ptype&&!m.test(c.ptype)){w=n(d,c.raw.wcsinfo);t="owcs_"+a.uniqueID()+".txt";a.vfile(t,a.raw2FITS(w,{addcr:!0}));var r="awcs_"+a.uniqueID()+".txt";v=a.tanhdr(t,r,"");1<a.DEBUG&&a.log("tanhdr (reproj): %s %s -> %s",t,r,v);a.vunlink(t);0<=v.search(/\[struct stat="OK"/)&&(a.vunlink(p),p=r)}}catch(C){}if(q.hdu&&q.hdu.fits.vfile)c=q.hdu.fits.vfile,q.hdu.fits.extname?c+="["+q.hdu.fits.extname+"]":q.hdu.fits.extnum&&0<q.hdu.fits.extnum&&(c+="["+q.hdu.fits.extnum+"]");else{var z=
this.toArray();c=this.id.replace(/\.png$/,"_png.fits");a.vfile(c,z)}r=this.id.replace(/\[.*\]/,"").replace(/\.png$/i,".fits").replace(/\.fz$/i,"").replace(/\.gz$/i,"");r="reproj_"+a.uniqueID()+"_"+r;d=b.rawid||"reproject";for(t=0;t<this.raws.length&&(w=this.raws[t],w.id!==d||!a.cleanupFITSFile(w,!0));t++);q.hdu&&"table"===q.hdu.imtab&&q.hdu.table&&!c.match(/\[bin /)&&(c.match(/\[EVENTS\]/)||(c+="[EVENTS]"),w=q.hdu.table,q=Math.floor(w.xcen-w.xdim/2+1),t=Math.floor(w.xcen+w.xdim/2),d=Math.floor(w.ycen-
w.ydim/2+1),w=Math.floor(w.ycen+w.ydim/2),c+="[bin X="+q+":"+t+",Y="+d+":"+w+"]");try{var y=r.lastIndexOf(".");0<=y&&(f=r.substring(0,y)+"_area"+r.substring(y));var A=b.cmdswitches||"";A+=" -a 0 "+a.globalOpts.reprojSwitches;v=a.reproject(c,r,p,A);1<a.DEBUG&&a.log("reproject: %s %s %s [%s] -> %s",c,r,p,A,v);a.vunlink(f);a.vunlink(p);u&&a.vunlink(u);z&&a.vunlink(c);0>v.search(/\[struct stat="OK"/)&&(h=!0,(g=v.match(/msg="(.*)"/))&&g[1]?a.error(g[1]+" (from mProjectPP)"):a.error(v))}catch(C){if(h)return;
a.vunlink(f);a.vunlink(p);v?a.error(v):a.error("WCS reproject failed",C)}return r}};a.Image.prototype.reprojectData=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=this,f;d=$jscomp.makeIterator(b);var g=d.next().value,h=d.next().value;if(g&&a.reproject){if("string"===typeof g){if("all"===g){for(b=0;b<a.images.length;b++)d=a.images[b],this.display.id===d.display.id&&d.reprojectData(this);return}(d=a.getImage(g))?g=d:a.error("unknown WCS for reproject: "+g)}if(this!==g){h=
...
e.winid.close&&(f=$.inArray(e,a.displays),0<=f&&a.displays.splice(f,1),e.winid.close());return this};a.Image.prototype.saveSession=function(c,b){var d,e,f,g,h,k,l=function(b){var c={};if(window.electron){var l=new RegExp("^"+window.electron.currentDir+"/");c.file=b.file.replace(l,"")}else c.file=b.file;c.dwidth=b.display.width;c.dheight=b.display.height;c.params=$.extend(!0,{},b.params);c.tmp={};"active"===b.tmp.gridStatus&&(c.tmp.gridStatus="active");h=b.imageToLogicalPos({x:b.rgb.sect.xcen,y:b.rgb.sect.ycen});
...
"image";try{switch(e){case "image":d[b].apply(d,$jscomp.arrayFromIterable(c.args));break;case "display":d.display[b].apply(d.display,$jscomp.arrayFromIterable(c.args));break;default:d[b].apply(d,$jscomp.arrayFromIterable(c.args))}}catch(n){a.error("error executing stash: "+b,n,!1)}};c=c||this.xeqstash;if($.isArray(c))for(e=0;e<c.length;e++){var g=c[e];var h=g.func;0<=$.inArray(h,b)||f(h,g)}else for(e=$jscomp.makeIterator(Object.keys(c)),h=e.next();!h.done;h=e.next())h=h.value,0<=$.inArray(h,b)||(g=
...
this.display.pluginInstances||{};var h=$jscomp.makeIterator(Object.keys(g));for(e=h.next();!e.done;e=h.next()){e=e.value;e=g[e];var k=e.plugin.opts;if(e.isActive(b)&&"function"===typeof k[b]){this.callingPlugin=b;switch(c){case "image":try{k[b].call(e,this),f(b,{im:this})}catch(m){e.errLog(b,m)}break;case "region":case "shape":try{k[b].call(e,this,d),f(b,{im:this,xreg:d})}catch(m){e.errLog(b,m)}break;case "keydown":case "keypress":var l=d.originalEvent||d;try{k[b].call(e,this,this.ipos,l),f(b,{im:this,
ipos:this.ipos,evt:l})}catch(m){e.errLog(b,m)}break;case "mouse":if(!this.clickInRegion||k[b+"_inRegion"]){l=d.originalEvent||d;try{k[b].call(e,this,this.ipos,l),f(b,{im:this,ipos:this.ipos,evt:l})}catch(m){e.errLog(b,m)}}}delete this.callingPlugin}}return this}};a.Image.prototype.uploadFITSFile=function(){var c=this,b,d=function(b){delete a.worker.uploadActive;window.setTimeout(function(){a.progress(!1)},1E3);b.stderr?a.error(b.stderr):b.stdout&&(c.fitsFile=b.stdout.trim(),c.proxyFile=c.fitsFile,
...
g=0,h=0,k=0,l=1,m,n,q,p,x,w,t,u,v,r,z,y,A,C,B,D={},E=/_sep[0-9][0-9]*/,F=a.globalOpts.separate,G=function(b,c,d){c||a.error("can't init separation ops: no 'from' id");m=d.layout||a.globalOpts.separate.layout||"auto";n=d.leftMargin||F.leftMargin||0;q=d.topMargin||F.topMargin||0;"auto"===m&&0<b.divjq.closest(".JS9GridContainer").length&&(m="grid");"grid"===m&&(CSS.supports("display","grid")?(f=b.divjq.closest(".JS9GridContainer"),0<f.length&&(p=f)):m="auto");switch(m){case "auto":k=1;h=0;break;case "horizontal":k=
1;h=0;break;case "vertical":k=0;h=1;break;default:k=1,h=0}x=43;w=0;t=$("#"+c);u=$("#"+c+"Menubar");0<u.length&&(u.isactive="visible"===u.closest(".JS9PluginContainer").css("visibility"));v=$("#"+c+"Toolbar");0<v.length&&(v.isactive="visible"===v.closest(".JS9PluginContainer").css("visibility"));r=$("#"+c+"Statusbar");0<r.length&&(r.isactive="visible"===r.closest(".JS9PluginContainer").css("visibility"));z=$("#"+c+"Colorbar");0<z.length&&!r.length&&(z.isactive="visible"===z.closest(".JS9PluginContainer").css("visibility"));
0<t.length&&(y=t.width(),A=t.height(),C=t.offset().top-$(window).scrollTop()-5,B=t.offset().left-$(document).scrollLeft(),u.isactive&&(A+=u.height(),C-=u.height()),v.isactive&&(A+=v.height(),C-=v.height()),r.isactive?(A+=r.height(),C-=r.height()):z.isactive&&(A+=z.height(),C-=z.height(),C+=7))},J=function(a,b){if(a){if(0<t.length){var c="";u.isactive&&(c+=sprintf("<div class='JS9Menubar' id='%sMenubar' data-width=%s></div>",b,t.width()));v.isactive&&(c+=sprintf("<div class='JS9Toolbar' id='%sToolbar' data-width=%s></div>",
b,t.width()));c+=sprintf("<div class='JS9' id='%s' data-width=%s data-height=%s></div>",b,t.width(),t.height());r.isactive?c+=sprintf("<div style='margin-top: 2px;'><div class='JS9Statusbar' id='%sStatusbar' data-width=%s></div></div>",b,t.width()):z.isactive&&(c+=sprintf("<div style='margin-top: 2px;'><div class='JS9Colorbar' id='%sColorbar' data-width=%s></div></div>",b,t.width()))}"auto"===m&&B+y*(k+.5)>window.innerWidth&&(h++,k=0);var d=sprintf("width=%s,height=%s,top=%s,left=%s,resize=1,scolling=1",
y,A,C+(A+q+x)*h,B+(y+n+w)*k);"auto"===m||"horizontal"===m?k++:"vertical"===m&&h++}return{id:b,html:c,winopts:d}},I=function(f){var h;var k=g++;f.length>k?(k="number"===typeof f[k]?a.images[f[k]]:f[k])&&k.display===b?(k.displayImage("all"),void 0===d?(d=k.display.id,G(k.display,d,c),!1===c.firstinplace&&g--,I(f)):(e="string"===typeof c.idbase?h=c.idbase+l++:d.replace(E,"")+"_sep"+a.uniqueID(),D[e]=k,k=J(d,e),h&&(k.id=h),"grid"===m?($("<div>").prop("id",k.id+"GridItem").addClass("JS9GridItem").append($(k.html)).appendTo(p),
...
g.display.clearMessage(),f&&(f=g.displayToImagePos(f),g.valpos=null,g.valpos=g.updateValpos(f,!0)));return this};a.Display.prototype.loadSession=function(c,b){var d=this,e,f,g={},h=function(c){var e,h=function(){var b=u.canvas.getObjects();b&&"undefined"!==typeof b.length&&(c.layers[u.layerName].nshape=b.length+1);a.Fabric.updateChildren(u,null,"objects");c.refreshLayers()},k=function(a,b){5>parseInt(a.version.slice(0,1),10)&&(b.startAngle&&(b.startAngle*=180/Math.PI),b.endAngle&&(b.endAngle*=180/
Math.PI))};var l=g[c.file]||{};l.blend&&(c.blend=$.extend(!0,{},l.blend));l.tmp&&(c.tmp=$.extend(!0,{},l.tmp));l.wcsim&&(c.wcsim=a.lookupImage(l.wcsim));if(l.layers&&l.layers.length)for(e=0;e<l.layers.length;e++){var m=l.layers[e];var t=m.name;if(!(0<=$.inArray("regions",c.params.disable)&&"regions"===t)&&"crosshair"!==t&&"grid"!==t){var u=d.newShapeLayer(t,m.dopts);c.addShapes(t,[]);u.canvas.loadFromJSON(m.json,h,k);m.catalog&&(c.layers[t].catalog=m.catalog);if(m.starbase)try{c.layers[t].starbase=
JSON.parse(m.starbase)}catch(v){}}}c.tmp&&"active"===c.tmp.gridStatus&&c.displayCoordGrid(!0);a.notNull(f)&&(--f,0===f&&a.images.sort(function(a,b){var c=0,d=0;g[a.file]&&(c=g[a.file].i);g[b.file]&&(d=g[b.file].i);return c-d}));l.xeqstash&&c.xeqStashCall(l.xeqstash);a.globalOpts.extendedPlugins&&c.xeqPlugins("image","onsessionload");if("function"===typeof b.onsessionload)try{a.xeqByName(b.onsessionload,window,c)}catch(v){a.error("in onsessionload callback",v,!1)}},k=function(c){c.file||a.error("session does not contain a filename");
e=$.extend(!0,{},c);delete e.params.display;e.params.crosshair=!1;e.params.onload=h;c=e.file;e.sect&&(e.params.xcen=e.sect.xcen,e.params.ycen=e.sect.ycen,e.params.xdim=e.sect.xdim,e.params.ydim=e.sect.ydim,e.params.zoom=e.sect.zoom,delete e.sect);window.electron&&a.desktopOpts.sessionPath&&b.sessionPath&&"/"!==e.file.charAt(0)&&!e.file.match(a.URLEXP)&&(c=a.fixPath(b.sessionPath+e.file,b));g[c]=e;a.Load(c,e.params,{display:d.id})},l=function(b){var c;b.globalOpts&&($.extend(!0,a.globalOpts,b.globalOpts),
...
a.uniqueID();var f=function(a){return"mosaic_"+d+"_"+a};var k=f("in.lst");var t=f("in.tbl");var u=f("in.hdr");var v=f("bin.lst");var r=f("bin.tbl");var z=f("out.lst");var y=f("out.tbl");var A=f("out.hdr");f=c[0].id.replace(/\[.*\]/,"").replace(/\.fz$/i,"").replace(/\.gz$/i,"").replace(/\.fits$/i,"_mosaic.fits");var C=f.replace(/\.fits$/,"_area.fits");h=[k,t,u,v,r,z,y,A,C];C="|                                                    fname|\n|                                                     char|\n";
for(e=0;e<c.length;e++)C+=c[e].raw.hdu.fits.vfile+"\n";a.vfile(k,C);k=a.imgtbl(k,".",t,"-C");m("mImgtbl",k);a.vsize(t)||a.error("no image data found with which to construct a mosaic");k=a.makehdr(t,u,"");m("mMakeHdr",k);if("js9"===b.reduce){C=a.vread(u).split("\n");for(e=u=0;e<C.length;e++)switch(k=C[e].split("="),k[0].trim()){case "NAXIS1":u=Math.max(u,parseFloat(k[1].trim()));break;case "NAXIS2":u=Math.max(u,parseFloat(k[1].trim()))}g=Math.max(1,Math.floor(u/b.dim+.5));C="|                                                    fname|\n|                                                     char|\n";
t=a.vread(t);t=t.trim().split("\n");t.splice(0,3);for(e=0;e<t.length;e++)if(k=t[e].trim().split(/\s+/),u=k[k.length-2],k=k[k.length-1],u&&k){var B=k+"["+u+"]";var D=k.split("/").reverse()[0].replace(/\.(g|f)z$/,"");u="bin_"+u+"_"+D;h.push(u);k="0@0,0@0,"+g;q("bin %s [%s]",B,g);a.imsection(B,u,k,"");C+=u+"\n"}a.vfile(v,C);k=a.imgtbl(v,".",r,"-C");m("mImgtbl",k);a.vsize(r)||a.error("no image data found to construct a mosaic");k=a.makehdr(r,A,"");m("mMakeHdr",k);t=a.vread(r)}else k=a.shrinkhdr(b.dim,
u,A),m("mShrinkHdr",k),t=a.vread(t);t=t.trim().split("\n");t.splice(0,3);C="|                                                    fname|\n|                                                     char|\n";for(e=0;e<t.length;e++)k=t[e].trim().split(/\s+/),u=k[k.length-2],k=k[k.length-1],u&&k&&(v="-a 1","shrink"===b.reduce&&(v+=" -h "+u),v+=" "+a.globalOpts.reprojSwitches,D=k.split("/").reverse()[0].replace(/\.(g|f)z$/,""),r="reproj_"+u+"_"+D,C+=r+"\n",h.push(r),h.push(r.replace(/\.fits$/i,"_area.fits")),
q("reproject: %s [%s] -> %s",k,u,r),k=a.reproject(k,r,A,v),m("mProjectPP",k));a.vfile(z,C);k=a.imgtbl(z,".",y,"");m("mImgtbl",k);a.vsize(y)||a.error("no FITS files were added to output table for mosaic");q("create mosaic: %s",f);k=a.madd(y,A,f,"");m("mAdd",k);l();z=$.extend(!0,{},a.fits.options,b);z.image={xdim:0,ydim:0};z.file=f;a.fits.handleFITSFile(f,z,n)},a.SPINOUT);return this};a.Display.prototype.moveImageInStack=function(c,b){var d,e,f,g;for(e=d=0;d<a.images.length;d++)if(a.images[d].display.id===
...
parseFloat(fabric.version.split(".")[0]);fabric.minor_version=parseFloat(fabric.version.split(".")[1]);fabric.patch_version=parseFloat(fabric.version.split(".")[2]);6<=fabric.major_version&&(Object.defineProperty(fabric.ActiveSelection.prototype,"type",{get:function(){return"activeSelection"},set:function(){},configurable:!0,enumerable:!0}),void 0===fabric.isTouchSupported&&(fabric.isTouchSupported="undefined"!==typeof window&&"ontouchstart"in window||"undefined"!==typeof navigator&&(0<navigator.maxTouchPoints||
0<navigator.msMaxTouchPoints)),Object.getOwnPropertyDescriptor(fabric.Object.prototype,"hasRotatingPoint")||Object.defineProperty(fabric.Object.prototype,"hasRotatingPoint",{get:function(){return this.isControlVisible?this.isControlVisible("mtr"):!0},set:function(a){this.setControlVisible&&this.setControlVisible("mtr",!!a)},configurable:!0,enumerable:!0}),fabric.ActiveSelection.prototype.addWithUpdate||(fabric.ActiveSelection.prototype.addWithUpdate=function(a){return this.multiSelectAdd(a)}),fabric.ActiveSelection.prototype.toGroup||
(fabric.ActiveSelection.prototype.toGroup=function(){var a=this.canvas,b=this.getObjects().concat();if(!a)return new fabric.Group(b);a.discardActiveObject();a.remove.apply(a,$jscomp.arrayFromIterable(b));b=new fabric.Group(b);a.add(b);a.setActiveObject(b);a.requestRenderAll();return b}),fabric.Group.prototype.toActiveSelection||(fabric.Group.prototype.toActiveSelection=function(){var a=this.canvas;if(a){var b=this.getObjects().concat();this.removeAll();a.remove(this);b.forEach(function(b){a.add(b)});
b=new fabric.ActiveSelection(b,{canvas:a});a.setActiveObject(b);a.requestRenderAll();return b}}),fabric.StaticCanvas.prototype.setWidth||(fabric.StaticCanvas.prototype.setWidth=function(a){return this.setDimensions({width:a})}),fabric.StaticCanvas.prototype.setHeight||(fabric.StaticCanvas.prototype.setHeight=function(a){return this.setDimensions({height:a})}),fabric.StaticCanvas.prototype.sendToBack||(fabric.StaticCanvas.prototype.sendToBack=function(a){a&&-1!==this.getObjects().indexOf(a)&&this.sendObjectToBack(a);
return this}),fabric.StaticCanvas.prototype.bringToFront||(fabric.StaticCanvas.prototype.bringToFront=function(a){a&&-1!==this.getObjects().indexOf(a)&&this.bringObjectToFront(a);return this}),fabric.Object.prototype.sendToBack||(fabric.Object.prototype.sendToBack=function(){this.canvas&&-1!==this.canvas.getObjects().indexOf(this)&&this.canvas.sendObjectToBack(this);return this}),void 0===fabric.devicePixelRatio&&(fabric.devicePixelRatio=fabric.config&&fabric.config.devicePixelRatio||"undefined"!==
typeof window&&window.devicePixelRatio||1));a.Fabric={};a.Fabric.elements="cornerSize cornerColor cornerStyle borderColor transparentCorners selectionLineWidth centeredScaling hasControls hasRotatingPoint lockMovementX lockMovementY lockRotation lockScalingX lockScalingY lockUniScaling selectable hasBorders params pub".split(" ");a.Fabric.opts={originX:"center",originY:"center",strokeWidth:2,selectionLineWidth:2,borderColor:"#00EEFF",cornerColor:"#00EEFF",cornerSize:fabric.isTouchSupported?10:6,cornerStyle:"circle",
...
a.Fabric.newShapeLayer=function(c,b,d){var e=this,f=function(a,b){var d=n.display.image;var e=n.canvas.getActiveObject();var f={};if(d)if(a.params)"activeSelection"===e.type&&(f.group=e),d._updateShape(c,a,f,b);else if("activeSelection"===a.type||"group"===a.type&&!a.params){var g=a.getObjects();for(e=0;e<g.length;e++){var h=g[e];h.params&&(f.group=a,d._updateShape(c,h,f,b))}}},g=function(a){e.image&&n.display.image._updateMultiDialogs(a)},h=function(b,c){b.params.sel=null;b.display.image&&(b.display.image.layer=
null);if(c){switch(c.type){case "polyline":case "polygon":a.Fabric.removePolygonAnchors(b,c)}f(c,"unselect");g(-1)}},k=function(a,b){var c=a.canvas.getActiveObjects();for(b=0;b<c.length;b++){var d=c[b];h(a,d)}g(-1)},l=function(b,d){b.params.sel&&d.params&&b.params.sel!==d&&h(b,b.params.sel);b.display.image&&(b.display.image.layer=c);if(d){switch(d.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(b,d),b.canvas.renderAll()}d.polyparams?b.params.sel=d.polyparams.polygon:d.params&&(b.params.sel=
d);f(d,"select");g(1)}},m=function(b,c,d){b.params.sel&&b.params.sel!==d&&h(b,b.params.sel);d=d||b.canvas.getActiveObject();var e=b.canvas.getActiveObjects();for(c=0;c<e.length;c++){var k=e[c];if(k.params&&k.params.parent&&k.params.parent.obj){var l=k.params.parent.obj;0>$.inArray(l,e)&&d.addWithUpdate(l)}if(k.params&&k.params.children)for(l=0;l<k.params.children.length;l++){var m=k.params.children[l].obj;0>$.inArray(m,e)&&d.addWithUpdate(m)}switch(k.type){case "polyline":case "polygon":k.params&&
a.Fabric.removePolygonAnchors(b,k)}f(k,"select")}b.canvas.renderAll();g(1)};if(e&&c){if(e.layers[c])return e.layers[c];e.layers[c]={};var n=e.layers[c];n.layerName=c;n.params=[];n.params.sel=null;n.params.sellayer=null;d?n.dtype="other":(n.dtype="main",d=e.divjq);var q=d.attr("id")+"-"+c.replace(/\s+/,"_")+"-shapeLayer";n.display=e;n.opts=$.extend(!0,{},b);n.opts.canvas=n.opts.canvas||{};void 0===n.opts.canvas.selection&&(n.opts.canvas.selection=!0);n.el=a.Fabric.elements;n.divjq=$("<div>").addClass("JS9Container").css("z-index",
0).appendTo(d);n.canvasjq=$("<canvas>").addClass("JS9Layer").attr("id",q).attr("width",d.css("width")).attr("height",d.css("height")).appendTo(n.divjq);a.bugs.webkit_resize&&"main"===n.dtype&&n.canvasjq.attr("width",e.width).attr("height",e.height);n.canvas=new fabric.Canvas(n.canvasjq[0]);n.canvas.renderOnAddRemove=!1;n.canvas.preserveObjectStacking=!0;n.opts.movable?(n.opts.lockMovementX=!1,n.opts.lockMovementY=!1,n.opts.selectable=!0,n.opts.evented=!0):!1===n.opts.movable&&(n.opts.lockMovementX=
!0,n.opts.lockMovementY=!0,n.opts.selectable=!1,n.opts.evented=!1);void 0===n.opts.changeable&&void 0!==n.opts.fixinplace&&(n.opts.changeable=!n.opts.fixinplace);void 0===n.opts.changeable&&void 0!==n.opts.locked&&(n.opts.changeable=!n.opts.locked);n.opts.changeable?(n.opts.hasControls=!0,n.opts.hasRotatingPoint=!0,n.opts.hasBorders=!0,n.opts.lockMovementX=!1,n.opts.lockMovementY=!1,n.opts.lockRotation=!1,n.opts.lockScalingX=!1,n.opts.lockScalingY=!1,n.opts.lockUniScaling=!1,n.opts.selectable=!0,
n.opts.evented=!0,n.opts.usekeyboard=!0):!1===n.opts.changeable&&(n.opts.hasControls=!1,n.opts.hasRotatingPoint=!1,n.opts.hasBorders=!1,n.opts.lockMovementX=!0,n.opts.lockMovementY=!0,n.opts.lockRotation=!0,n.opts.lockScalingX=!0,n.opts.lockScalingY=!0,n.opts.lockUniScaling=!0,n.opts.selectable=!1,n.opts.evented=!1,n.opts.usekeyboard=!1);n.opts.selectable&&(n.opts.canvas.selection=!0);if(n.opts.onmousedown||n.opts.onmouseup||n.opts.onmousemove||n.opts.tooltip||n.opts.onmouseover||n.opts.onmouseout){n.opts.evented=
!0;if(n.opts.onmousedown)n.canvas.on("mouse:down",function(b){if(n.display.image&&b.target){var d=b.target,e=d.params;if(!e||e&&!1!==e.changeable)"main"===n.dtype&&(n.display.image.clickInRegion=!0,n.display.image.clickInLayer=c),n.opts.onmousedown.call(n.canvas,n.display.image,d.pub,b.e,d)}else if(n.canvas._selection=n.canvas.selection)n.canvas.selection=a.specialKey(b.e)});else n.canvas.on("mouse:down",function(b){if(n.canvas._selection=n.canvas.selection)n.canvas.selection=a.specialKey(b.e)});
if(n.opts.onmouseup)n.canvas.on("mouse:up",function(a){n.display.image&&a.target&&n.opts.onmouseup.call(n.canvas,n.display.image,a.target.pub,a.e,a.target);n.canvas.selection=n.canvas._selection||n.canvas.selection});else n.canvas.on("mouse:up",function(){n.canvas.selection=n.canvas._selection||n.canvas.selection});if(n.opts.onmousemove)n.canvas.on("mouse:move",function(a){n.display.image&&a.target&&n.opts.onmousemove.call(n.canvas,n.display.image,a.target.pub,a.e,a.target)});if(n.opts.onmouseover)n.canvas.on("mouse:over",
function(a){n.display.image&&a.target&&n.opts.onmouseover.call(n.canvas,n.display.image,a.target.pub,a.e,a.target)});if(n.opts.onmouseout)n.canvas.on("mouse:out",function(a){n.display.image&&a.target&&n.opts.onmouseout.call(n.canvas,n.display.image,a.target.pub,a.e,a.target)});if(n.opts.onmousedblclick)n.canvas.on("mouse:dblclick",function(a){n.display.image&&a.target&&n.opts.onmousedblclick.call(n.canvas,n.display.image,a.target.pub,a.e,a.target)});n.opts.tooltip&&(n.canvas.on("mouse:over",function(b){n.display.image&&
b.target&&a.tooltip(b.target.left+b.target.width+2,b.target.top+b.target.height+2,n.opts.tooltip,n.display.image,b.target.pub,b.e,b.target)}),n.canvas.on("mouse:out",function(b){n.display.image&&b.target&&a.tooltip(b.target.left,b.target.top,null,n.display.image,b.target.pub,b.e,b.target)}))}else n.canvas.on("mouse:down",function(b){if(n.canvas._selection=n.canvas.selection)n.canvas.selection=a.specialKey(b.e)}),n.canvas.on("mouse:up",function(){n.canvas.selection=n.canvas._selection||n.canvas.selection});
n.canvas.on("object:modified",function(b){var c=[];if(b.target){var d=b.target;a.Fabric.updateChildren(n,d,"deltas");if(n.opts.sortOverlapping&&(d.setCoords(),n.canvas.forEachObject(function(a){a!==d&&d.intersectsWithObject(a)&&(e=a.getScaledWidth(),f=a.getScaledHeight(),c.push({obj:a,siz:e*f}))}),c.length)){var e=d.getScaledWidth();var f=d.getScaledHeight();c.push({obj:d,siz:e*f});c.sort(function(a,b){return a.siz<=b.siz?-1:1});var g=c.length;for(b=0;b<g;b++)try{c[b].obj.sendToBack()}catch(r){}}}});
n.canvas.on("object:scaling",function(b){b.target&&(b=b.target,b.rescaleEvenly(),b.rescaleBorder(),a.Fabric.updateChildren(n,b,"scaling"),"activeSelection"!==b.type&&"group"!==b.type||f(b,"scaling"))});n.canvas.on("object:moving",function(b){b.target&&(b=b.target,a.Fabric.updateChildren(n,b,"moving"),"activeSelection"!==b.type&&"group"!==b.type||f(b,"moving"))});n.canvas.on("object:rotating",function(b){b.target&&(b=b.target,a.Fabric.updateChildren(n,b,"rotating"),"activeSelection"!==b.type&&"group"!==
b.type||f(b,"rotating"))});n.canvas.on("selection:created",function(b){if(!a.globalOpts.skipSelectionProcessing)if(b.target){var c=b.target;"activeSelection"===c.type||"group"===c.type&&!c.params?m(n,b,c):l(n,c)}else b.selected&&b.selected.length&&(1===b.selected.length?(c=b.selected[0],l(n,c)):m(n,b))});n.canvas.on("selection:updated",function(b){if(!a.globalOpts.skipSelectionProcessing)if(b.target){var c=b.target;"activeSelection"===c.type||"group"===c.type&&!c.params?m(n,b,c):l(n,c)}else b.selected&&
b.selected.length&&(1===b.selected.length?(c=b.selected[0],l(n,c)):m(n,b))});n.canvas.on("before:selection:cleared",function(b){if(!a.globalOpts.skipSelectionProcessing)if(b.target){var c=b.target;"activeSelection"===c.type||"group"===c.type&&!c.params?k(n,b):h(n,c)}else b.deselected&&b.deselected.length&&(c=b.deselected[0],"activeSelection"===c.type||"group"===c.type&&!c.params?k(n,b):h(n,c))});if(n.divjq.closest(a.lightOpts[a.LIGHTWIN].drag).length)if(fabric.isTouchSupported)n.divjq.on("touchstart",
function(){n.canvas.calcOffset()});else n.divjq.on("mouseenter",function(){n.canvas.calcOffset()});return n}};a.Fabric.showShapeLayer=function(c,b,d){var e=this,f;var g=0;if(f=this.getShapeLayer(c)){d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(m){a.error("can't parse showShapeLayer opts: "+d,m)}var h=f.canvas;var k=this.display.layers[c];if(a.isNull(b))return f.show;if(!0===b||"true"===b){if(!d.local&&(f.show=!0,this!==this.display.image))return;f.show&&(h.selection=f.opts.canvas.selection);
f.json&&f.show&&h.loadFromJSON(f.json,function(){var b,d;a.Fabric.updateChildren(f.dlayer,null,"objects");e.resize&&(h.getObjects().forEach(function(a){a.left+=e.resize.left;a.top+=e.resize.top;a.setCoords()}),h.calcOffset());f.zindex=Math.abs(f.zindex);k.divjq.css("z-index",f.zindex);var g=$jscomp.makeIterator(Object.keys(e.layers));for(b=g.next();!b.done;b=g.next())if(b=b.value,c!==b&&e.layers[b].show&&(b=e.display.layers[b],b.divjq.css("z-index")<f.zindex&&(d=b.canvas.getActiveObject())))a.Fabric.removePolygonAnchors(b,
d),b.canvas.getActiveObject()&&b.canvas.discardActiveObject();e.restoreSelection(c)});d=$jscomp.makeIterator(Object.keys(this.layers));for(b=d.next();!b.done;b=d.next())b=b.value,this.layers[b].json&&g++;g||(this.resize=null);this.xeqPlugins("shape","onshapelayershow",c)}else{if(!d.local&&this!==this.display.image){f.show=!1;return}if(f.show){g=h.getObjects();for(b=g.length;b--;){var l=g[b];l.params&&(l.params.winid&&(l.params.winid.close(),l.params.winid=null),l.params.anchors&&a.Fabric.removePolygonAnchors(f.dlayer,
l))}g=h.toJSON(f.dlayer.el);f.json=JSON.stringify(g);this.saveSelection(c);h.selection=!1;k&&(f.zindex=-Math.abs(f.zindex),k.divjq.css("z-index",f.zindex));h.clear()}d.local||(f.show=!1);this.xeqPlugins("shape","onshapelayerhide",c)}return this}};a.Fabric.displayShapeLayers=function(){var a;if(this!==this.display.image){if(this.display.image&&this.display.image.layers){var b=$jscomp.makeIterator(Object.keys(this.display.image.layers));for(a=b.next();!a.done;a=b.next())a=a.value,this.display.image.showShapeLayer(a,
...
0;for(b=this.zlayer-1;e<a.length;e++){var f=this.layers[a[e]];"main"===f.dlayer.dtype&&(f.zindex=b--,f.show?c||(c=a[e]):f.zindex=-f.zindex,f.dlayer.divjq.css("z-index",f.zindex))}a=c}else{if((f=this.layers[a])&&f.show){c=f.zindex;f.zindex=this.zlayer-1;f.dlayer.divjq.css("z-index",f.zindex);var g=$jscomp.makeIterator(Object.keys(this.layers));for(e=g.next();!e.done;e=g.next())e=e.value,b=this.layers[e],b!==f&&b.zindex===f.zindex&&"main"===b.dlayer.dtype&&(b.zindex=c,b.dlayer.divjq.css("z-index",b.zindex));
this.xeqPlugins("shape","onshapelayeractive",a)}a=this}else{a=$jscomp.makeIterator(Object.keys(this.layers));for(e=a.next();!e.done;e=a.next())e=e.value,b=this.layers[e],"main"===b.dlayer.dtype&&(void 0===f||b.zindex>f)&&(f=b.zindex,c=e);a=c}return a};a.Fabric._parseShapeOptions=function(c,b,d){var e,f={},g={};b=b||{};if(b.remove)return{remove:b.remove};var h=b.parent||d&&d.params&&d.params.parent;delete b.parent;b.restoreid||delete b.id;delete b.restoreid;g.tags=[];if(b.tags)if("string"===typeof b.tags){var k=
b.tags.toLowerCase().split(",");for(e=0;e<k.length;e++)g.tags[e]=k[e].trim()}else if($.isArray(b.tags))for(e=0;e<b.tags.length;e++)g.tags[e]=b.tags[e].trim();if(a.notNull(b.angle)){if(!h)switch(b.shape){case "box":case "cross":case "ellipse":case "text":if(this.raw.wcsinfo)this.raw.wcsinfo.crot&&(b.angle+=this.raw.wcsinfo.crot);else if(a.notNull(this.raw.header.LTM1_1)||a.notNull(this.raw.header.LTM1_2)){try{var l=Math.atan((this.raw.header.LTM1_2||0)/(this.raw.header.LTM1_1||0))}catch(x){l=0}l&&
(l=180*-l/Math.PI,b.angle+=l)}a.notNull(this.params.transformAngle)&&(b.angle+=this.params.transformAngle);a.notNull(this.params.transformScale)&&(b.angle*=this.params.transformScale)}f.angle=-b.angle}void 0!==b.dx&&void 0!==b.dy&&(f.left=b.dx,f.top=b.dy);void 0!==b.x&&void 0!==b.y&&(l=this.imageToDisplayPos(b),f.left=l.x,f.top=l.y);void 0!==b.px&&void 0!==b.py&&(l=this.logicalToDisplayPos({x:b.px,y:b.py}),f.left=l.x,f.top=l.y);"string"===typeof b.wcs&&(l=b.wcs.trim().split(/ +/),b.ra=l[0],b.dec=
l[1],3<=l.length&&(b.wcssys=l[2]));if(this.validWCS()&&a.notNull(b.ra)&&a.notNull(b.dec)){if(b.wcssys){var m=this.getWCSSys();var n=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.setWCSSys(b.wcssys,!1)}else b._wcssys&&(m=this.getWCSSys(),n=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,this.setWCSSys(b._wcssys,!1),delete b._wcssys);"string"===typeof b.ra&&(b.ra=a.saostrtod(b.ra),a.isHMS(this.params.wcssys)&&(b.ra*=15));"string"===typeof b.dec&&(b.dec=a.saostrtod(b.dec));l=a.wcs2pix(this.raw.wcs,
b.ra,b.dec).trim().split(/ +/);m&&(this.setWCSSys(m,!1),a.globalOpts.xeqPlugins=n);l=this.imageToDisplayPos({x:parseFloat(l[0]),y:parseFloat(l[1])});f.left=l.x;f.top=l.y}void 0!==b.left&&(f.left=b.left);void 0!==b.top&&(f.top=b.top);void 0===f.left&&!0!==b.noLeftTop&&(f.left=d&&void 0!==d.left?d.left:this.display.canvasjq.attr("width")/2-1);void 0===f.top&&!0!==b.noLeftTop&&(f.top=d&&void 0!==d.top?d.top:this.display.canvasjq.attr("height")/2-1+1);b.deltax&&(f.left+=b.deltax);b.deltay&&(f.top-=b.deltay);
c="main"!==this.display.layers[c].dtype||b.preservedcoords?1:this.rgb.sect.zoom;if(""===b.strokeDashes||""===b.strokeDashArray)b.strokeDashArray=[];""===b.strokeWidth&&(b.strokeWidth=a.Fabric.opts.strokeWidth);switch(b.shape){case "annulus":g.radii=[];if(void 0!==b.radii)if("string"===typeof b.radii)for(g.radii=b.radii.replace(/ /g,"").split(","),n=e=0;e<g.radii.length;e++)""!==g.radii[e]&&(b.sizeScale&&(g.radii[e]*=b.sizeScale),g.radii[n++]=this.wcs2imlen(g.radii[e]));else{if(g.radii=b.radii,b.sizeScale)for(e=
0;e<g.radii.length;e++)g.radii[e]*=b.sizeScale}else for(b.ireg&&a.SCALEIREG&&(a.notNull(b.iradius)&&(b.iradius/=c),a.notNull(b.oradius)&&(b.oradius/=c)),b.sizeScale&&(a.notNull(b.iradius)&&(b.iradius*=b.sizeScale),a.notNull(b.oradius)&&(b.oradius*=b.sizeScale)),c=(b.oradius-b.iradius)/b.nannuli,m=b.nannuli+1,e=0;e<m;e++)n=b.iradius+c*e,b.sizeScale&&(n*=b.sizeScale),g.radii.push(n);break;case "box":case "cross":b.ireg&&a.SCALEIREG&&(a.notNull(b.width)&&(b.width/=c),a.notNull(b.height)&&(b.height/=
c));b.sizeScale&&(a.notNull(b.width)&&(b.width*=b.sizeScale),a.notNull(b.height)&&(b.height*=b.sizeScale));break;case "circle":b.ireg&&a.SCALEIREG&&a.notNull(b.radius)&&(b.radius/=c);b.sizeScale&&a.notNull(b.radius)&&(b.radius*=b.sizeScale);break;case "ellipse":b.ireg&&a.SCALEIREG&&(a.notNull(b.r1)&&(b.r1/=c),a.notNull(b.r2)&&(b.r2/=c));b.sizeScale&&(a.notNull(b.r1)&&(b.r1*=b.sizeScale),a.notNull(b.r2)&&(b.r2*=b.sizeScale));break;case "point":switch(b.ptshape){case "box":b.width=2*b.ptsize;b.height=
2*b.ptsize;break;case "circle":b.radius=b.ptsize;break;case "ellipse":b.rx=b.ptsize,b.ry=b.ptsize/2}b.lockRotation=!0;b.lockScalingX=!0;b.lockScalingY=!0;b.lockUniScaling=!0;b.hasControls=!1;b.hasRotatingPoint=!1;b.hasBorders=!0;break;case "line":case "polygon":if(a.notNull(b.wcspts)&&this.validWCS()){b.pts=[];b.wcssys&&(m=this.getWCSSys(),n=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,this.setWCSSys(b.wcssys,!1));for(e=0;e<b.wcspts.length;e++)l=a.wcs2pix(this.raw.wcs,b.wcspts[e].ra,b.wcspts[e].dec).trim().split(/ +/),
b.pts.push({x:parseFloat(l[0]),y:parseFloat(l[1])});m&&(this.setWCSSys(m,!1),a.globalOpts.xeqPlugins=n)}if(b.pts&&b.pts.length){if("string"===typeof b.pts){l=b.pts.replace(/ /g,"").split(",");m=l.length;if("string"===typeof l[0])for(e=0;e<m;e++)l[e]=parseFloat(l[e]);b.pts=[];for(n=e=0;e<m;e+=2,n++)b.pts[n]={x:l[e],y:l[e+1]}}m=b.pts.length;for(e=0;e<m;e++)n=b.pts[e],a.notNull(n.x)&&a.notNull(n.y)?b.pts[e]=this.imageToDisplayPos(b.pts[e]):a.notNull(n.dx)&&a.notNull(n.dy)&&(b.pts[e].x=n.dx,delete b.pts[e].dx,
b.pts[e].y=n.dy,delete b.pts[e].dy);b.left&&b.top?n={x:b.left,y:b.top}:b.dx&&b.dy?n={x:b.dx,y:b.dy}:(n=a.centerPolygon(b.pts),f.left=n.x,f.top=n.y);b.points=[];for(e=0;e<m;e++)l={x:(b.pts[e].x-n.x)/c,y:(b.pts[e].y-n.y)/c},b.points.push(l)}else d&&d.points&&d.points.length||("polygon"===b.shape&&b.polypoints?b.points=b.points||b.polypoints:"line"===b.shape&&b.linepoints&&(b.points=b.points||b.linepoints));if(b.ireg&&a.SCALEIREG)for(m=b.points.length,e=0;e<m;e++)b.points[e].x/=c,b.points[e].y/=c}e=
...
b[c];break;case "shape":var q=b[c];break;default:g[c]=b[c]}if(!(b=g.color||f.stroke)){b=g.tags;e=g.tagcolors;e=e||{};n=$jscomp.makeIterator(Object.keys(e));for(c=n.next();!c.done;c=n.next())if(c=c.value,m=c.split("_"),0===$(b).not(m).length&&0===$(m).not(b).length){var p=e[c];break}if(!p)for(n=$jscomp.makeIterator(Object.keys(e)),c=n.next();!c.done;c=n.next())if(c=c.value,m=c.split("_"),0===$(b).not(m).length){p=e[c];break}if(!p)for(n=$jscomp.makeIterator(Object.keys(e)),c=n.next();!c.done;c=n.next())if(c=
c.value,m=c.split("_"),0===$(m).not(b).length){p=e[c];break}b=p=p||d&&d.get("stroke")||e.defcolor||a.globalOpts.defcolor||"#000000"}f.stroke=b;f.selectColor=f.stroke;if(!0===a.globalOpts.controlsMatchRegion||"corner"===a.globalOpts.controlsMatchRegion)f.cornerColor=f.stroke;if(!0===a.globalOpts.controlsMatchRegion||"border"===a.globalOpts.controlsMatchRegion)f.borderColor=f.stroke;void 0===g.changeable&&void 0!==g.fixinplace&&(g.changeable=!g.fixinplace);void 0===g.changeable&&void 0!==g.locked&&
...
d){var e,f={},g=[],h={};if(!(0<=$.inArray("regions",this.params.disable)&&"regions"===c)){d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(v){a.error("can't parse shape opts: "+d,v)}if(this.display.image!==this)this.delayedShapes=this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"add",opts:d});else{if(d.file&&a.globalOpts.reloadRefreshReg)try{this.removeShapes("regions",d.file)}catch(v){}if((e=this.getShapeLayer(c))&&e.show){var k=e.canvas;if("string"===typeof b){var l=
this.parseRegions(b,d);b="string"===typeof l?[{shape:l}]:l}else if(!$.isArray(b))if("object"===typeof b)b=[b];else return;if(a.isNull(e.zindex)||Number.isNaN(e.zindex)){if("main"===this.display.layers[c].dtype)switch(c){case a.Crosshair.LAYERNAME:case a.Grid.LAYERNAME:e.zindex=1;break;default:e.zindex=this.zlayer++}else e.zindex=a.SHAPEZINDEX;var m=this.display.layers[c];m.divjq.css("z-index",e.zindex);this.xeqPlugins("shape","onshapelayercreate",c)}var n=$.extend(!0,{},a.Fabric.opts,e.opts,d);for(m=
0;m<b.length;m++){var q=b[m];!0===q.preservedcoords&&((a.isNull(q.dx)||a.isNull(q.dy))&&$.isArray(q.pts)&&a.isNull(q.pts[0].dx)&&a.error("preservedcoords requires positions in display coords"),q.sticky=!0,q.preservedcoords=Object.keys(q),q.wcsconfig={wcssys:"image"});var p=$.extend(!0,{},n,q);var x=this._parseShapeOptions(c,p);if(x.remove){if(!0===x.remove||"true"===x.remove)x.remove="all";if(!1!==x.remove&&"false"!==x.remove){this.removeShapes(c,x.remove);continue}}if(x.shape){p=x.opts;f=x.params;
void 0===f.id&&(f.id=++e.nshape);void 0===f.wcsconfig&&(f.wcsconfig={wcssys:this.getWCSSys()});f.exports=this._exportShapeOptions(d).concat(this._exportShapeOptions(q));f.parent=null;f.children=[];p.stroke&&(p.color=p.stroke,p.stroke=a.colorToHex(p.stroke));e.opts.noCenteredScaling&&0<=$.inArray(x.shape,e.opts.noCenteredScaling)&&(p.centeredScaling=!1);switch(x.shape){case "annulus":f.shape="annulus";l=p.top;x=p.left;p.top=0;p.left=0;var w=[];if(f.radii)for(q=0;q<f.radii.length;q++)p.radius=f.radii[q],
w.push(new fabric.Circle(p));p.top=l;p.left=x;p.width=2*p.radius;p.height=2*p.radius;l=new fabric.Group(w,p);break;case "box":f.shape="box";l=new fabric.Rect(p);break;case "circle":f.shape="circle";l=new fabric.Circle(p);break;case "cross":f.shape="cross";l=p.top;x=p.left;q=p.angle;w=p.width/2;var t=p.height/2;var u=[];p.left=0;p.top=0;p.angle=0;p.points=[{x:-w,y:0},{x:w,y:0}];u.push(new fabric.Polyline(p.points,p));p.points=[{x:0,y:-t},{x:0,y:t}];u.push(new fabric.Polyline(p.points,p));p.top=l;p.left=
x;p.angle=q;l=new fabric.Group(u,p);break;case "ellipse":f.shape="ellipse";p.rx=f.r1;p.ry=f.r2;l=new fabric.Ellipse(p);break;case "point":f.shape="point";switch(f.ptshape){case "box":l=new fabric.Rect(p);break;case "circle":l=new fabric.Circle(p);break;case "ellipse":l=new fabric.Ellipse(p);break;default:l=new fabric.Rect(p)}break;case "line":f.shape="line";l=new fabric.Polyline(p.points,p);break;case "polygon":f.shape="polygon";l=new fabric.Polygon(p.points,p,!0);break;case "text":f.shape="text";
f.text=p.text||"Double-click to add text here";p.fill=p.stroke;p.strokeWidth=0;l=new fabric.Text(f.text,p);break;default:a.error("unknown shape: "+x.shape)}k.add(l);f.layerName=c;f.sw1=Math.max(1,Math.floor(l.strokeWidth+.5));f.listonchange=!1;l.params=f;x="main"!==this.display.layers[c].dtype||l.params.preservedcoords?1:this.rgb.sect.zoom;if(e.opts.panzoom)switch(f.shape){case "point":case "text":break;default:l.scale(x)}l.rescaleBorder();!1===l.params.changeable&&k.sendToBack(l);this._handleChildText(c,
l,p);"TBD"!==d.parent&&this._updateShape(c,l,null,"add",f);if(d.onaddshapes&&l.pub)try{a.xeqByName(d.onaddshapes,this,this,l.pub)}catch(v){a.error("in onaddshapes callback",v,!1)}g.push(l);p.groupid&&(h[p.groupid]=h[p.groupid]||[],h[p.groupid].push(l))}}e=$jscomp.makeIterator(Object.keys(h));for(b=e.next();!b.done;b=e.next())b=b.value,this.groupShapes(c,h[b],{groupid:b,select:!1});(void 0===f.redraw||f.redraw)&&k.renderAll();return"object"===d.rtn?l:"objs"===d.rtn?g:f.id}}}};a.Fabric._parseShapes=
...
b}b=a.tmp.regSelect.ids;delete a.tmp.regSelect;return b};a.Fabric._selectShapes=function(c,b,d,e){var f=this,g,h,k,l=[],m=function(a,b){0>$.inArray(a,l)&&(e.call(f,a,b),l.push(a))},n=function(a){var b;if(!a)return[];var c=a.length;do{for(b=0;c--;){var d=a[c];"group"!==d.type||d.params||(a.splice.apply(a,[c,1].concat($jscomp.arrayFromIterable(d.getObjects()))),b++)}c=a.length}while(b);return a},q=function(a,b){var c,d,e=[],f=[];var g=b.length;for(c=0;c<g;c++){var h=b[c];("activeSelection"===h.type||
"group"===h.type&&!h.params)&&e.push(h)}var k=e.length;(d=a.getActiveObject())&&("activeSelection"===d.type||"group"===d.type&&!d.params||(d=null));if(k||d)for(c=0;c<g;c++){var l=b[c];for(a=0;a<k;a++)h=e[a],h.contains(l)&&(f[c]=h);f[c]||d&&d.contains(l)&&(f[c]=d)}return f},p=function(a,b){var c;for(c=0;c<b.length;c++){var d=b[c];if("activeSelection"===d.type||"group"===d.type&&!d.params){if(d.contains(a))return d}else if(d.params&&d===a)return u[c]}return null};if(!this.layers||!c||!this.layers[c])return null;
"function"!==typeof e&&a.error("selectShapes requires a callback");d=d||{};var x=this.layers[c].canvas;b||(b=x.getActiveObject()&&"auto"===a.globalOpts.regWhichDefault?"selected":"all");if("string"===typeof b&&b.startsWith("["))try{b=JSON.parse(b)}catch(y){a.error("can't parse array selection")}if("string"===typeof b){if(this.layers[c].selection){if("and"===d.saved)b="(saved) && ("+b+")";else if("or"===d.saved||!0===d.saved)b="(saved) || ("+b+")";b=b.replace(/saved/gi,this.layers[c].selection)}if(b.match(/&|\||!/))b=
this._parseShapes(c,b,d);else if(d.saveselection&&b)switch(b.trim()){case "all":case "saved":case "selected":break;default:this.layers[c].selection=b}}$.isArray(b)||(b=[b]);for(h=0;h<b.length;h++){var w=x.getObjects().reverse();var t=w.length;var u=q(x,w);var v=b[h];"string"===typeof v&&/^[1-9]\d*$/.test(v)&&(v=parseInt(v,10));var r={group:null,canvas:x,layer:c};switch(typeof v){case "object":t=n(w);for(g=t.length;g--;)if((k=t[g])&&k.params&&k===v){r.group=p(k,w);m(k,r);break}break;case "number":t=
n(w);for(g=t.length;g--;)if((k=t[g])&&k.params&&k.params.id===v){r.group=p(k,w);m(k,r);break}break;case "string":if("selected"===v)for(t=n(x.getActiveObjects()),g=t.length;g--;)k=t[g],r.group=p(k,w),k.params&&!k.params.parent&&m(k,r);else for(;t--;)if(k=w[t],"group"===k.type&&!k.params)v===this.lookupGroup(k)||"all"===v.toLowerCase()?(r.group=k,!1!==d.transparentgroup?k.forEachObject(function(a){a.params&&!a.params.parent&&m(a,r)}):m(k,r)):k.forEachObject(function(a){a.params&&v===a.params.file&&
m(a,r)});else if(k.params&&(g=k.stroke.toLowerCase(),!k.params.parent||"child"===v||"All"===v)&&("child"!==v||k.params.parent))if(r.group=u[t],"all"===v.toLowerCase())m(k,r);else if(v.toLowerCase()===g||a.colorToHex(v).toLowerCase()===g)m(k,r);else if(v===k.params.shape)m(k,r);else if(v===k.params.file)m(k,r);else if("object"===typeof k.params.data&&v===k.params.data.syncid)m(k,r);else if("child"===v&&k.params.parent)m(k,r);else if("dcoords"===v&&k.params.preservedcoords)m(k,r);else if("nodcoords"===
v&&!k.params.preservedcoords)m(k,r);else if("parent"===v&&k.params.children&&k.params.children.length)m(k,r);else if(0<=$.inArray(v,a.wcssyss)&&k.params.wcsconfig&&k.params.wcsconfig.wcssys===v)m(k,r);else if(k.params.tags)for(g=0;g<k.params.tags.length;g++){var z=k.params.tags[g];v.match(/^\/.*\/$/)&&z.match(new RegExp(v.slice(1,-1)))?m(k,r):v===z&&m(k,r)}}}return this};a.Fabric.selectShapes=function(c,b,d){var e,f=[];if(e=this.getShapeLayer(c)){var g=e.canvas;d=d||{};if("string"===typeof d)try{d=
...
case "ellipse":h.wcssizestr=[k[2],k[3]];break;case "line":case "polygon":for(h.wcspts=[],b=0;b<k.length;b+=2)l=a.strtoscaled(k[b]),a.isHMS(h.wcssys,l.dtype)&&(l.dval*=15),m=a.strtoscaled(k[b+1]),h.wcspts.push({ra:l.dval,dec:m.dval})}}};if(b&&b.params){d=d||{};f=f||{};e=e||"update";var w="main"!==this.display.layers[c].dtype||b.params.preservedcoords?1:this.rgb.sect.zoom;m.mode=e;m.id=b.params.id;m.groupid=b.params.groupid;m.shape=b.params.shape;m.layer=c;m.color=b.color||b.stroke;m.tags=b.params.tags;
m.sticky=b.params.sticky;m.preservedcoords=b.params.preservedcoords;b.params.ignore&&(m.ignore=!0);m.parent=b.params.parent?b.params.parent.obj.params.id:null;m.child=b.params.children&&b.params.children.length?b.params.children[0].id:null;var t=b.getCenterPoint();var u={x:0,y:0};if(d.group&&(6>fabric.major_version&&(u=d.group.getCenterPoint(),t={x:u.x+t.x*d.group.scaleX,y:u.y+t.y*d.group.scaleY},d.group.angle&&(t=a.rotatePoint(t,d.group.angle,u))),"activeSelection"!==d.group.type)){if((l=n.canvas.getActiveObject())&&
"activeSelection"===l.type){var v=l.getObjects();var r=v.length;for(h=0;h<r;h++)if(v[h]===d.group){var z=l.getCenterPoint();break}}z||(l=null);l&&6>fabric.major_version&&(t={x:z.x+t.x*l.scaleX,y:z.y+t.y*l.scaleY},l.angle&&(t=a.rotatePoint(t,l.angle,z)))}m.preservedcoords&&(m.dx=t.x,m.dy=t.y);h=this.displayToImagePos(t);m.x=h.x;m.y=h.y;m.lcs=this.imageToLogicalPos(h);"export"!==e&&b.params.wcsconfig&&("image"===b.params.wcsconfig.wcssys?k="image":"physical"===b.params.wcsconfig.wcssys&&(k="physical"));
"image"===k||"image"===this.params.wcssys&&"physical"!==k?(m.imsys="image",h=m.x,v=m.y,k=1):(m.imsys=m.lcs.sys,h=m.lcs.x,v=m.lcs.y,k=Math.sqrt(Math.pow(this.lcs.physical.reverse[0][0],2)+Math.pow(this.lcs.physical.reverse[0][1],2)));m.angle=-b.angle;d.group&&(m.angle-=d.group.angle);l&&(m.angle-=l.angle);l=m.angle;if(!m.parent)switch(m.shape){case "box":case "cross":case "ellipse":case "text":if(a.notNull(this.params.transformScale)&&(m.angle/=this.params.transformScale),a.notNull(this.params.transformAngle)&&
(m.angle-=this.params.transformAngle),this.raw.wcsinfo)this.raw.wcsinfo.crot&&(m.angle-=this.raw.wcsinfo.crot);else if(a.notNull(this.raw.header.LTM1_1)||a.notNull(this.raw.header.LTM1_2)){try{var y=Math.atan((this.raw.header.LTM1_2||0)/(this.raw.header.LTM1_1||0))}catch(E){y=0}y&&(y=180*-y/Math.PI,m.angle-=y)}}for(;0>m.angle;)m.angle+=360;for(;360<=m.angle;)m.angle-=360;t=b.scaleX/w;y=b.scaleY/w;d.group&&(t*=d.group.scaleX,y*=d.group.scaleY);switch(m.shape){case "annulus":m.shape="annulus";m.radii=
[];"image"!==m.imsys&&(m.lcs.radii=[]);m.imstr="annulus("+p(h)+","+p(v)+",";var A="annulus "+m.x+" "+m.y+" ";v=b.getObjects();r=v.length;for(h=0;h<r;h++)u=v[h].radius*t,y=u*k,m.imstr+=p(y),A=a.REGSIZE?A+(m.x+" "+m.y+" "+(m.x+u)+" "+m.y+" "):A+(u+" "),m.imstr=h===r-1?m.imstr+")":m.imstr+",",m.radii.push(u),"image"!==m.imsys&&m.lcs.radii.push(y);break;case "box":case "cross":m.width=b.width*t;m.height=b.height*y;y=m.width*k;A=m.height*k;"image"!==m.imsys&&(m.lcs.width=y,m.lcs.height=A);m.imstr=m.shape+
"("+p(h)+","+p(v)+","+p(y)+","+p(A)+","+m.angle.toFixed(4)+")";A=a.REGSIZE?m.shape+" "+m.x+" "+m.y+" "+m.x+" "+m.y+" "+(m.x+m.width)+" "+m.y+" "+m.x+" "+m.y+" "+m.x+" "+(m.y+m.height)+" "+m.angle*Math.PI/180:m.shape+" "+m.x+" "+m.y+" "+m.width+" "+m.height+" "+m.angle*Math.PI/180;break;case "circle":m.radius=b.radius*t;y=m.radius*k;"image"!==m.imsys&&(m.lcs.radius=y);m.imstr="circle("+p(h)+","+p(v)+","+p(y)+")";A=a.REGSIZE?"circle "+m.x+" "+m.y+" "+m.x+" "+m.y+" "+(m.x+m.radius)+" "+m.y:"circle "+
m.x+" "+m.y+" "+m.radius;break;case "ellipse":m.r1=b.width*t/2;m.r2=b.height*y/2;y=m.r1*k;A=m.r2*k;"image"!==m.imsys&&(m.lcs.r1=y,m.lcs.r2=A);m.imstr="ellipse("+p(h)+","+p(v)+","+p(y)+","+p(A)+","+m.angle.toFixed(4)+")";A=a.REGSIZE?"ellipse "+m.x+" "+m.y+" "+m.x+" "+m.y+" "+(m.x+m.r1)+" "+m.y+" "+m.x+" "+m.y+" "+m.x+" "+(m.y+m.r2)+" "+m.angle*Math.PI/180:"ellipse "+m.x+" "+m.y+" "+m.r1+" "+m.r2+" "+m.angle*Math.PI/180;break;case "point":m.width=b.width*t;m.height=b.height*y;y=m.width*k;A=m.height*
k;"image"!==m.imsys&&(m.lcs.width=y,m.lcs.height=A);m.imstr="point("+p(h)+","+p(v)+")";A="point "+m.x+" "+m.y;break;case "line":case "polygon":m.imstr=m.shape+"(";A=m.shape+" ";m.pts=[];"image"!==m.imsys&&(m.lcs.pts=[]);for(h=0;h<b.points.length;h++)if(0<h&&(m.imstr+=",",A+=" "),y=this.displayToImagePos({x:u.x+b.left+b.points[h].x*b.scaleX,y:u.y+b.top+b.points[h].y*b.scaleY}),y=a.rotatePoint(y,l,{x:m.x,y:m.y}),"image"===m.imsys?m.imstr+=p(y.x)+","+p(y.y):(w=this.imageToLogicalPos(y),d=w.x,w=w.y,m.imstr+=
p(d)+","+p(w),m.lcs.pts.push({x:d,y:w})),A+=y.x+" "+y.y,m.pts.push(y),"line"===m.shape)if(0===h)var C=0;else d=m.pts[h-1],C+=Math.sqrt((y.x-d.x)*(y.x-d.x)+(y.y-d.y)*(y.y-d.y));if("line"===m.shape&&a.notNull(C)){m.imstr+=') {"size":'+p(C)+',"units":"pixels"';if(2===m.pts.length){for(y=180*Math.atan2(m.pts[1].y-m.pts[0].y,m.pts[1].x-m.pts[0].x)/Math.PI;0>y;)y+=360;var B=',"posang":'+y.toFixed(4)+',"posunits":"degrees"';m.imstr+=B}m.imstr+="}"}else m.imstr+=")";m.angle=0;break;case "text":m.imstr="text("+
p(h)+","+p(v)+',"'+b.text+'",'+m.angle.toFixed(4)+")",A="text "+m.x+" "+m.y+' "'+b.text+'" '+m.angle*Math.PI/180,m.text=b.text}this.validWCS()&&(x(this.raw.wcs,n,m,A,B,f,m),"export"!==e&&b.params.wcsconfig&&b.params.wcsconfig.wcssys&&(p=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,u=this.getWCSSys(),a.notWCS(b.params.wcsconfig.wcssys)||(this.setWCSSys(b.params.wcsconfig.wcssys,!1),x(this.raw.wcs,n,m,A,B,f,b.params.wcsconfig)),m.wcsconfig=$.extend(!0,{},b.params.wcsconfig),this.setWCSSys(u,!1),
a.globalOpts.xeqPlugins=p));m.data=b.params.data;b.set("pub",m);b.params.winid&&($(b.params.winid).is(":visible")?this.initRegionsForm(b):b.params.winid=null);if(f.nocb)return m;(function(){var d=function(b){try{g.params.xeqonchange=!1,a.xeqByName(b,window,g,m)}catch(G){a.log("error in onchange: %s [%s]\n%s",g.id,G.message,a.strace(G))}finally{g.params.xeqonchange=!0}};b.params.parent||e.match(q)||(g.params.xeqonchange&&n.show&&(n.opts.onchange?d(n.opts.onchange):"regions"===c&&a.Regions.opts.onchange&&
d(a.Regions.opts.onchange)),d="on"+c+"change",g.xeqPlugins("shape",d,m))})();if("regions"===c&&a.globalOpts.regToClipboard){switch(e){case "update":h=m.parent||m.id;break;default:h=null}if(a.notNull(h)){try{var D=this.listRegions(h,{mode:1,includedcoords:!0})}catch(E){D=null}D&&(a.clipboard=D)}}"regions"===c&&"wcs"===e&&this._updateMultiDialogs(!0);return m}};a.Fabric.lookupGroup=function(a,b){var c;b=b||"regions";if(!this.getShapeLayer(b))return null;b=this.layers[b].canvas;if("string"===typeof a){var e=
b.getObjects();for(b=0;b<e.length;b++){var f=e[b];if("group"===f.type&&!f.params){var g=f.getObjects();for(c=0;c<g.length;c++){var h=g[c];if(h.params&&h.params.groupid===a)return f}}}}else if("object"===typeof a&&"group"===a.type&&!a.params&&(e=a.getObjects())&&e.length&&e[0]&&e[0].params)return e[0].params.groupid;return null};a.Fabric.listGroups=function(c,b,d){var e="";d=d||"regions";var f=this.getShapeLayer(d);if(!f)return e;c=c||"all";if("string"===typeof b)try{b=JSON.parse(b)}catch(l){a.error("can't parse listGroups opts: "+
b,l)}b=b||{};var g=f.canvas.getObjects();for(f=0;f<g.length;f++){var h=g[f];if("group"===h.type&&!h.params){var k=h.getObjects()[0].params.groupid;if("all"===c||c===k)!1===b.includeregions?e+=k+";":(h=this.getShapes(d,k,{format:"text",includejson:!1,includecomments:!0})+";;",h=h.substring(h.indexOf(";")+1),e+=k+":;"+h)}}a.notNull(b.mode)&&0<b.mode&&this.display.displayMessage("regions",e);return e.replace(/;\s*/g,"\n").replace(/\n\n$/,"\n")};a.Fabric.groupShapes=function(c,b,d){var e=this,f,g,h,k,
l=[],m=[];var n=this.getShapeLayer(c);if(!n)return 0;var q=n.dlayer;d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(x){a.error("can't parse groupShapes opts: "+d,x)}n=n.canvas;var p=function(a){var b=1;for(a=a.groupid||"group_"+b;e.lookupGroup(a);)b+=1,a=a.replace(/_[0-9][0-9]*$/,"")+("_"+b);return a}(d);this._selectShapes(c,b,d,function(b){if(0>$.inArray(b,l)){h=!1;if(b.params.groupid)switch(a.globalOpts.regGroupConflict){case "skip":k=b.params.groupid;h=!0;break;default:g=sprintf("%s can only be a member of one group [%s,%s]",
"regions"===c?"regions":"shapes",b.params.id,b.params.groupid),a.error(g)}if(!h&&(b.params.groupid=p,0>$.inArray("groupid",b.params.exports)&&b.params.exports.push("groupid"),l.push(b),m.push(b.pub),b.params&&b.params.children.length))for(f=0;f<b.params.children.length;f++)b.params.children[f].obj&&l.push(b.params.children[f].obj)}});if(!l.length)return k;n.getActiveObject()&&n.discardActiveObject();b=new fabric.ActiveSelection(l,{canvas:n});a.globalOpts.skipSelectionProcessing=!0;n.setActiveObject(b);
n.getActiveObject().toGroup();!1===d.select&&n.getActiveObject()&&n.discardActiveObject();delete a.globalOpts.skipSelectionProcessing;n.renderAll();this.groups[c]=this.groups[c]||[];this.groups[c].push(p);"function"===typeof q.opts.ongroupcreate&&q.opts.ongroupcreate.call(q.canvas,p,this,m,l);return p};a.Fabric.ungroupShapes=function(c,b,d){var e,f;var g=this.getShapeLayer(c);if(!g||!this.layers[c])return this;a.isNull(b)&&a.error("ungroup requires a group id or selection");d=d||{};var h=g.canvas;
var k=h.getObjects();for(g=0;g<k.length;g++){var l=k[g];if("group"===l.type&&!l.params){var m=l.getObjects();for(f=e=0;e<m.length;e++){var n=m[e];if(n.params&&("all"===b||b===n.params.groupid)){f||(h.getActiveObject()&&h.discardActiveObject(),a.globalOpts.skipSelectionProcessing=!0,h.setActiveObject(l),h.getActiveObject().toActiveSelection(),d.select||h.discardActiveObject(),h.requestRenderAll(),delete a.globalOpts.skipSelectionProcessing,f++);delete n.params.groupid;var q=$.inArray("groupid",n.params.exports);
0<=q&&n.params.exports.splice(q,1)}}}}this.groups[c]&&(q=$.inArray(b,this.groups[c]),0<=q&&this.groups[c].splice(q,1));return this};a.Fabric.removeShapes=function(c,b,d){var e=this,f,g,h=!1,k={mode:1,includedcoords:!0,sortids:!1},l=[],m=[];if(f=this.getShapeLayer(c)){var n=f.canvas;d=d||{};n.getActiveObject()&&(g=n.getActiveObjects());"regions"===c&&a.globalOpts.unremoveReg&&(this.regstack.push(this.listRegions(b,k,c)),this.regstack.length>a.globalOpts.unremoveReg&&(this.regstack=this.regstack.slice(0,
a.globalOpts.unremoveReg)));this._selectShapes(c,b,d,function(a,b){if(!(!1===a.params.removable&&!d.overrideRemovable||a.params.sticky&&!1===d.sticky)){"main"===f.dlayer.dtype&&e._updateShape(c,a,b,"remove");a.params.winid&&(a.params.winid.close(),a.params.winid=null);if(a.params.parent){var k=a.params.parent.obj;for(b=k.params.children.length-1;0<=b;b--)if(a===k.params.children[b].obj){k.params.children.splice(b,1);break}}for(b=0;b<a.params.children.length;b++)k=a.params.children[b].obj,l.push(k);
a.params.groupid&&0>$.inArray(a.params.groupid,m)&&m.push(a.params.groupid);g&&!h&&0<=$.inArray(a,g)&&(h=!0);l.push(a)}});h&&n.discardActiveObject();for(b=0;b<m.length;b++)this.ungroupShapes(c,m[b]);for(b=0;b<l.length;b++)n.remove(l[b]);n.renderAll();!n.size()&&a.globalOpts.resetEmptyShapeId&&(f.nshape=0);return this}};a.Fabric.getShapes=function(c,b,d){var e={},f=[];d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(k){a.error("can't parse getShapes opts: "+d,k)}if("regions"===c&&("text"===
...
0)-(b.id||0)});return f};a.Fabric.changeShapes=function(c,b,d){var e=this,f,g,h,k,l,m,n,q,p,x,w,t,u=[],v=[];if((l=this.getShapeLayer(c))&&d){if("string"===typeof d)try{d=JSON.parse(d)}catch(y){a.error("can't parse shape opts: "+d,y)}if(this.display.image!==this)this.delayedShapes=this.delayedShapes||[],this.delayedShapes.push({layer:c,shape:b,mode:"change",opts:d});else{var r=l.canvas;if((m=r.getActiveObject())&&"activeSelection"===m.type){var z=r.getActiveObjects();r.discardActiveObject();r.renderAll();
m=null}a.isNull(d.saveselection)&&(d.saveselection=!0);this._selectShapes(c,b,d,function(b,z){p="main"!==e.display.layers[c].dtype||b.params.preservedcoords?1:e.rgb.sect.zoom;d.radii&&(b.params.radii=[]);d.tags&&(b.params.tags=[]);void 0!==d.locked&&delete b.params.changeable;k=$.extend(!0,{},b.params,d);h=e._parseShapeOptions(c,k,b);if(h.remove){if(!0===h.remove||"true"===h.remove)h.remove="all";if(!1!==h.remove&&"false"!==h.remove){e.removeShapes(c,h.remove||"all");return}}x=e._exportShapeOptions(d).filter(function(a){return!{}.hasOwnProperty.call(b.params.exports,
a)});h.params.exports=b.params.exports.concat(x);h.opts.stroke&&(h.opts.color=h.opts.stroke,h.opts.stroke=a.colorToHex(h.opts.stroke));switch(b.params.shape){case "text":h.opts.stroke&&(h.opts.fill=h.opts.stroke);h.opts.strokeWidth=0;break;case "line":case "polygon":h.opts.points&&h.opts.points.length&&(b.angle=0)}b.set(h.opts);b.params=$.extend(!1,{},b.params,h.params);h.opts.strokeWidth&&(b.params.sw1=h.opts.strokeWidth);switch(b.params.shape){case "annulus":if(d.radii&&d.radii.length){b.forEachObject(function(a){u.push(a)});
n=u.length;for(f=0;f<n;f++)b.remove(u[f]),r.remove(u[f]);n=b.params.radii.length;q=0;w=$.extend(!0,{},d);w.stroke=w.stroke||b.get("stroke");w.strokeWidth=w.strokeWidth||b.get("strokeWidth");w.strokeDashArray=w.strokeDashArray||b.get("strokeDashArray");for(f=0;f<n;f++)w.radius=b.params.radii[f],g=new fabric.Circle(w),q=Math.max(q,b.params.radii[f]),b.add(g);b.scaleX=p;b.scaleY=p;b.width=2*q;b.height=2*q;m===b&&r.setActiveObject(b)}break;case "box":d.width&&(b.scaleX=p);d.height&&(b.scaleY=p);break;
case "circle":d.radius&&(b.scaleX=p,b.scaleY=p);break;case "cross":w=$.extend(!0,{},d);w.stroke=w.stroke||b.get("stroke");w.width&&(b.scaleX=p,v[0]=[{x:-w.width/2,y:0},{x:w.width/2,y:0}],delete w.width);w.height&&(b.scaleY=p,v[1]=[{x:0,y:-w.height/2},{x:0,y:w.height/2}],delete w.height);w.angle&&delete w.angle;b.forEachObject(function(a,b){t=$.extend(!0,{},w);v[b]&&(t.points=v[b]);a.set(t)});break;case "ellipse":d.r1&&(b.rx=b.params.r1,b.scaleX=p,b.width=2*b.rx);d.r2&&(b.ry=b.params.r2,b.scaleY=p,
b.height=2*b.ry);break;case "line":case "polygon":if(d.points&&d.points.length||d.pts&&d.pts.length)b.scaleX=p,b.scaleY=p;m===b&&(a.Fabric.removePolygonAnchors(l.dlayer,b),a.Fabric.addPolygonAnchors(l.dlayer,b));a.resetPolygonCenter(b);break;case "text":d.text&&(b.params.text=d.text)}b.rescaleBorder();!1===b.params.changeable&&r.sendToBack(b);switch(h.opts.send){case "front":r.bringToFront(b);m===b&&r.discardActiveObject();break;case "back":r.sendToBack(b),m===b&&r.discardActiveObject()}a.Fabric.updateChildren(l.dlayer,
b,"moving");a.Fabric.updateChildren(l.dlayer,b,"scaling");a.Fabric.updateChildren(l.dlayer,b,"rotating");a.Fabric.updateChildren(l.dlayer,b,"deltas");b.setCoords();e._handleChildText(c,b,d);e._updateShape(c,b,z,"update");if(d.onchangeshapes&&b.pub)try{a.xeqByName(d.onchangeshapes,e,e,b.pub)}catch(C){a.error("in onchangeshapes callback",C,!1)}});z&&this.selectShapes(c,z);(void 0===d.redraw||d.redraw)&&r.renderAll();return this}}};a.Fabric.refreshShapes=function(c){if(c){var b={mode:1,sticky:!1,ignoreignore:!0,
...
f)/b.get("scaleX");var h=(d.y-g)/b.get("scaleY");for(g=-b.get("angle")*Math.PI/180;g>2*Math.PI;)g-=2*Math.PI;d=Math.cos(g)*f-Math.sin(g)*h;h=Math.sin(g)*f+Math.cos(g)*h;f=b.points;for(g=0;g<f.length;g++){var k=f[g];var l=f[(g+1)%f.length];var m=k.x<l.x?k.x:l.x;var n=k.y<l.y?k.y:l.y;var q=k.x>l.x?k.x:l.x;var p=k.y>l.y?k.y:l.y;var x=k.x-l.x;k=k.y-l.y;var w=Math.sqrt(x*x+k*k);0!==w&&(x/=w,k/=w);w=d-l.x;var t=h-l.y;w=w*x+t*k;x=l.x+x*w;l=l.y+k*w;x<m?x=m:x>q&&(x=q);l<n?l=n:l>p&&(l=p);m=(x-d)*(x-d)+(l-h)*
(l-h);if(m<e){e=m;var u=x;var v=l;var r=g===f.length?0:g}}c=this.getShapeLayer(c);a.Fabric.removePolygonAnchors(c.dlayer,b);f.splice(r+1,0,{x:u,y:v});switch(b.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(c.dlayer,b),c.dlayer.canvas.renderAll()}b.polyparams?c.dlayer.params.sel=b.polyparams.polygon:b.params&&(c.dlayer.params.sel=b)}};a.Fabric._removePolygonPoint=function(c,b){if(b&&b.polyparams){var d=b.polyparams.polygon;var e=d.points;if(!("polygon"===d.type&&3>=e.length||"polyline"===
...
delete b.savesel}};a.Fabric.print=function(c){var b,d="",e=0,f=sprintf("width=%s,height=%s,menubar=1,toolbar=1,status=0,scrollbars=1,resizable=1",this.display.canvasjq.attr("width"),this.display.canvasjq.attr("height"));c=c||{};if("string"===typeof c)try{c=JSON.parse(c)}catch(l){a.error("can't parse print opts: "+c,l)}var g=this.display.canvas.toDataURL("image/png");var h="<html><body style='padding: 0px; margin: 0px' onload='window.print(); return false'>";var k=sprintf("<div style='position:absolute; left:%spx; top:%spx'>",
...
e))return;$(a.lightOpts[a.LIGHTWIN].topid).arrive(".regionsConfigForm",{onceOnly:!0},function(){b.firsttime=!0;c&&c.params&&d.updateShapes("regions",c,"wcsconfig");d.initRegionsForm(c,b)});b.winid=this.displayAnalysis("regions",g,{title:f,winformat:h});c&&c.params&&(c.params.winid=b.winid)}};a.Regions.initConfigForm=function(c,b){var d=this,e,f,g,h,k,l,m,n=!1,q=this.raw.wcsinfo||{cdelt1:1,cdelt2:1};var p={type:"multi",pub:{shape:"multi",wcsconfig:{}},params:{}};var x=function(b){if(void 0!==b)return"number"===
typeof b&&0!==b%1&&(b=Math.round(1E4*(b+1E-5))/1E4),String(b)},w=function(b){var a=String.fromCharCode(13,10);return"string"===typeof b?b.replace(/\\n/g,a):b};if(c&&c.pub)var t=c.pub.wcsconfig&&c.pub.wcsconfig.wcssys?c.pub.wcsconfig.wcssys:this.params.wcssys;else t=this.params.wcssys,c=p;var u=!1===c.params.changeable;b=b||{};if(c.params.winid)var v=c.params.winid;else b.winid&&(v=b.winid);if(v){var r="#"+$(v).attr("id")+" .regionsConfigForm ";if($(r).length){n=$(r).data("multi")?!0:b.multi;$(r+"."+
c.pub.shape).each(function(b,a){$(a).removeClass("nodisplay")});$(r+".val").each(function(b,m){g="";f=$(m).attr("name");switch(f){case "x":case "y":c.pub.lcs&&void 0!==c.pub.lcs[f]?g=x(c.pub.lcs[f]):void 0!==c.pub[f]&&(g=x(c.pub[f]));break;case "radii":c.pub.radii&&(g=!a.notWCS(t)&&c.pub.wcsconfig&&c.pub.wcsconfig.wcsstr?c.pub.wcsconfig.wcsstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","):c.pub.imstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","));
break;case "pts":c.pub.pts?c.pub.pts.forEach(function(b){g&&(g+=", ");g+=b.x.toFixed(2)+", "+b.y.toFixed(2)}):c.pub.imstr&&(g=c.pub.imstr.replace(/^.*\(/,"").replace(/\)$/,""));break;case "linelength":if(c.pub.pts&&2===c.pub.pts.length){k=c.pub.pts[0];l=c.pub.pts[1];g=x(Math.sqrt((l.x-k.x)*(l.x-k.x)+(l.y-k.y)*(l.y-k.y)));switch(t){case "image":case "physical":break;default:g*=Math.abs(q.cdelt1),g*=Math.abs(q.cdelt2)}g=x(g);d.tmp.linelength=g}break;case "lineangle":if(c.pub.pts&&2===c.pub.pts.length){k=
c.pub.pts[0];l=c.pub.pts[1];for(g=180*Math.atan2(l.y-k.y,l.x-k.x)/Math.PI;0>g;)g+=360;g=x(g);d.tmp.lineangle=g}break;case "fontFamily":c.getFontFamily&&(g=c.getFontFamily());break;case "fontSize":c.getFontSize&&(g=c.getFontSize());break;case "fontStyle":c.getFontStyle&&(g=c.getFontStyle());break;case "fontWeight":c.getFontWeight&&(g=c.getFontWeight());break;case "colorPicker":g=void 0!==c.pub.color?a.colorToHex(c.pub.color):$(r).data("colorpicker")||a.globalOpts.defcolor;break;case "color":n||(void 0!==
c.pub.color?g=x(c.pub.color):$(r).data("colorpicker")&&(g=$(r).data("colorpicker")));break;case "strokeWidth":g=c.params.sw1?c.params.sw1:$(r).data("strokewidth")||"";break;case "strokeDashes":c.strokeDashArray?(g=c.strokeDashArray.join(" "),g.match(/NaN/)&&(g="")):g=$(r).data("strokedashes")||"";break;case "regstr":g=!a.notWCS(t)&&c.pub.wcsconfig&&c.pub.wcsconfig.wcsstr?c.pub.wcsconfig.wcssys+";"+c.pub.wcsconfig.wcsstr:c.pub.imsys+";"+c.pub.imstr;break;case "xpos":switch(t){case "image":c.pub.preservedcoords&&
void 0!==c.pub.dx?g=sprintf("d%.1f",c.pub.dx):void 0!==c.pub.x&&(g=sprintf("%.1f",c.pub.x));break;case "physical":c.pub.lcs?g=sprintf("%.1f",c.pub.lcs.x):void 0!==c.pub.x&&(g=sprintf("%.1f",c.pub.x));break;default:c.pub.wcsconfig&&a.notNull(c.pub.wcsconfig.ra)?g=sprintf("%.6f",c.pub.wcsconfig.ra):void 0!==c.pub.x&&(g=sprintf("%.1f",c.pub.x))}$(r+"[name='"+f+"']").prop("readonly",u);break;case "ypos":switch(t){case "image":c.pub.preservedcoords&&void 0!==c.pub.dy?g=sprintf("d%.1f",c.pub.dy):void 0!==
c.pub.y&&(g=sprintf("%.1f",c.pub.y));break;case "physical":c.pub.lcs?g=sprintf("%.1f",c.pub.lcs.y):void 0!==c.pub.y&&(g=sprintf("%.1f",c.pub.y));break;default:c.pub.wcsconfig&&a.notNull(c.pub.wcsconfig.dec)?g=sprintf("%.6f",c.pub.wcsconfig.dec):void 0!==c.pub.y&&(g=sprintf("%.1f",c.pub.y))}$(r+"[name='"+f+"']").prop("readonly",u);break;case "radius":case "oradius":case "length":case "width":case "r1":switch(t){case "image":void 0!==c.pub[f]&&(g=x(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==
c.pub.lcs[f]&&(g=x(c.pub.lcs[f]));break;default:c.pub.wcsconfig&&a.notNull(c.pub.wcsconfig.wcssizestr)?g=x(c.pub.wcsconfig.wcssizestr[0]):void 0!==c.pub[f]&&(g=x(c.pub[f]))}$(r+"[name='"+f+"']").prop("readonly",u);break;case "height":case "r2":switch(t){case "image":void 0!==c.pub[f]&&(g=x(c.pub[f]));break;case "physical":c.pub.lcs&&void 0!==c.pub.lcs[f]&&(g=x(c.pub.lcs[f]));break;default:c.pub.wcsconfig&&a.notNull(c.pub.wcsconfig.wcssizestr)?g=x(c.pub.wcsconfig.wcssizestr[1]):void 0!==c.pub[f]&&
(g=x(c.pub[f]))}$(r+"[name='"+f+"']").prop("readonly",u);break;case "wcssys":case "savewcs":z=$(r).find("[name='"+f+"']");if(!z.find("option").length)for(e=0;e<a.wcssyss.length;e++)z.append("<option>"+a.wcssyss[e]+"</option>");h="savewcs"===f?a.globalOpts.regSaveWCS||t:t;z.find("option").each(function(b,a){h===a.value&&(g=a.value)});break;case "wcsunits":c.pub.wcsunits&&(g=c.pub.wcsunits);break;case "childtext":c.params.children&&0<c.params.children.length&&(g=w(c.params.children[0].obj.text));break;
case "text":void 0!==c.pub[f]&&(g=w(x(c.pub[f])));break;case "id":n?g="selected":void 0!==c.pub.id&&(g=String(c.pub.id),$(m).css("width",g.length+"ch"));break;case "tags":void 0!==c.pub[f]&&(g=x(c.pub[f]));break;case "savefile":g=$(r).data("savefile")||d.tmp.saveregionsFile||"js9.reg";window.electron&&!g.match(/.*\//)&&(g=window.electron.currentDir+"/"+g);break;case "selectfilter":g=$(r).data("selectfilter");break;case "selectshape":case "selectcolor":case "selecttag":case "selectwcs":case "selectgroup":a.Regions.regionsConfigSetSelectMenu(d,
$(r),f);break;default:void 0!==c.pub[f]&&(g=x(c.pub[f]))}$(m).val(g)});(n||!this.raw.wcs||0>this.raw.wcs)&&$(r).find("[name='wcssys']").hide();"text"!==c.type&&c.params.children&&$(r+".childtext").removeClass("nodisplay");if(b.firsttime){window.electron&&$(r).find(".rsavebrowse, .rconfigbrowse").removeClass("nodisplay");n?($(r).find("label[for='savecur']").text("sel"),$(r).find("input[id='savecur']").data("tooltip","save selected regions"),$(r).find("[id='selectreg']").prop("checked",!0)):$(r).find(".checkboxes").removeClass("nodisplay");
if(a.favorites.wcs&&a.favorites.wcs.length){var z=$(r).find(".rwcsbuttons").removeClass("nodisplay");var y=z.find(".rwcsbuttoncontainer");if(y.length&&!y.find(".rwcsbutton").length){for(e=0;e<a.favorites.wcs.length;e++){p=a.favorites.wcs[e];var A="string"===typeof p?p.split(":"):p;p=A[0];A=A[1]||p;if("save"===b.type){var C="rsavecol_R"+(e+2);var B="rsaveradio"}else C="rconfigcol_R"+(e+2),B="rconfigradio";y.append("<span class='rconfigcol_R rwcsbutton "+C+"'>\n                                <input type='radio'\n                                       id='rwcsbutton_"+
p+"'\n                                       name='rwcsbutton'\n                                       class='rwcsradio "+B+"}'\n                                       value='"+p+"'\n                                       data-tooltip='save using "+p+' wcs\'\n                                       onclick=\'\n                                           $(this).closest("form")\n                                           .find("[name=savewcs]")\n                                           .val("'+p+'")\n                                           .trigger("change");\'>\n                                <label for=\'rwcsbutton_'+
p+"'>"+A+"</label>\n                                </span>")}$(r).find(".rwcsbuttons").find("[value='"+t+"']").prop("checked",!0)}}a.globalOpts.internalColorPicker&&$.fn.spectrum.inputTypeColorSupport()||(z=$(r).find("input[name='colorPicker']"),z.spectrum({showButtons:!1,showInput:!1,preferredFormat:"hex6"}),z.on("move.spectrum",function(b,a){b=a.toHexString();$(r).find("input[name='color']").val(b);$(r).data("colorpicker",b)}))}void 0===c.params.listonchange&&(c.params.listonchange=!1);c.params.listonchange?
...
e=0;p=[];for(A="";e<y.length;e++)D=y[e],"group"!==D.type||D.params?p.push(D):A+=this.lookupGroup(D)+"\n";C=this.listRegions(p,{mode:1,includejson:!1,includecomments:!1}).replace(/ *; */g,"\n");if(A+=C.substring(C.indexOf("\n")+1))B="selected",$(r).find("[name='selectfilter']").val(B),$(r).data("selectfilter",B),$(r).find("[name='multitext']").val(A)}else{if(p=$(r).find("[name='selectfilter']").val()||"selected",A=this.listRegions(p,{mode:1,includejson:!1,includecomments:!1}).replace(/ *; */g,"\n"))$(r).find("[name='selectfilter']").val(p),
...
$(r).data("tooltipInit")||($(r).data("tooltipInit",!0),$(".rconfigcol_R, .rsavecol_R").on(v,function(b){var c=b.currentTarget;b=$(c).find("input, textarea, span").data("tooltip");c=$(c).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);b&&c.length&&(m=$(c)[0].childNodes[0].nodeValue.replace(/:.*/,""),$(c)[0].childNodes[0].nodeValue=m+": "+b)}),$(".rconfigcol_R, .rsavecol_R").on(D,function(b){b=$(b.currentTarget).closest(a.lightOpts[a.LIGHTWIN].top).find(a.lightOpts[a.LIGHTWIN].dragBar);
b.length&&(m=$(b)[0].childNodes[0].nodeValue.replace(/:.*/,""),$(b)[0].childNodes[0].nodeValue=m)}))}}};a.Regions.processConfigForm=function(c,b,d){var e,f=1;var g={type:"multi",pub:{shape:"multi"},params:{}};var h=d.length,k={},l=this.raw.wcsinfo||{cdelt1:1,cdelt2:1},m=function(b){if(void 0!==b)return"number"===typeof b&&0!==b%1&&(b=Math.round(1E4*(b+1E-5))/1E4),String(b)},n=function(b,a){return t?!0:void 0===b?!1:m(b)!==m(a)},q=function(b,c,d){if("remove"===c)return"selected"===d;if("childtext"===
...
if("misc"===c&&""!==d||"radii"===c&&b.params.radii)return!0;if("angle"===c)return b.angle!==-parseFloat(d);if("ix"===c)return b.pub.preservedcoords&&"d"===d.charAt(0).toLowerCase()?n(b.pub.dx,a.saostrtod(d.substring(1))):n(b.pub.x,a.saostrtod(d));if("iy"===c)return b.pub.preservedcoords&&"d"===d.charAt(0).toLowerCase()?n(b.pub.dy,a.saostrtod(d.substring(1))):n(b.pub.y,a.saostrtod(d));if("px"===c&&b.pub.lcs)return n(b.pub.lcs.x.toFixed(1),d);if("py"===c&&b.pub.lcs)return n(b.pub.lcs.y.toFixed(1),d);
if("ra"===c)return b.pub.wcsconfig&&b.pub.wcsconfig.wcsposstr?n(a.saostrtod(b.pub.wcsconfig.wcsposstr[0]),a.saostrtod(d)):b.pub.wcsposstr?n(a.saostrtod(b.pub.wcsposstr[0]),a.saostrtod(d)):!1;if("dec"===c){if(b.pub.wcsconfig&&b.pub.wcsconfig.wcsposstr)return n(a.saostrtod(b.pub.wcsconfig.wcsposstr[1]),a.saostrtod(d));if(b.pub.wcsposstr)return n(a.saostrtod(b.pub.wcsposstr[1]),a.saostrtod(d))}return"sticky"===c?t?!1:n(b.pub.sticky||!1,d):"locked"===c?t?!1:!1!==b.params.changeable?!1===d:!0===d:"listonchange"===
c&&t?!1:b.pub.lcs&&void 0!==b.pub.lcs[c]?n(b.pub.lcs[c],d)?!0:!1:n(b.pub[c],d)||n(b.params[c],d)||n(b[c],d)?!0:!1},p=function(b){return"true"===b?!0:"false"===b?!1:a.isNumber(b)?parseFloat(b):b},x=function(b){var a=String.fromCharCode(13,10);return"string"===typeof b?b.replace(/\\n/g,a):b};this.lcs&&this.lcs.physical&&(f=Math.sqrt(Math.pow(this.lcs.physical.forward[0][0],2)+Math.pow(this.lcs.physical.forward[0][1],2)));if(b&&b.pub)var w=b.pub.wcsconfig&&b.pub.wcsconfig.wcssys?b.pub.wcsconfig.wcssys:
this.params.wcssys;else w=this.params.wcssys,b=g;var t=$(c).data("multi");g=b.pub.layer||"regions";for(e=0;e<h;e++){var u=d[e].name;var v=d[e].value;if("xpos"===u||"ypos"===u)switch(w){case "image":u="i"+u.charAt(0);break;case "physical":u="p"+u.charAt(0);break;default:u=this.validWCS()?"xpos"===u?"ra":"dec":"xpos"===u?"ix":"iy"}switch(u){case "multitext":case "colorPicker":case "savefile":case "rwcsbutton":case "savewcs":case "saveformat":case "includejson":case "includecomments":case "savewhich":case "savedcoords":break;
case "text":"text"===b.type&&q(b,u,v)&&(k[u]=x(v));break;case "selectfilter":if(v&&v!==$(c).data("selectfilter")){$(c).data("selectfilter",v);this.lookupGroup(v)?this.groupShapes(g,v):this.selectShapes(g,v);return}break;case "strokeDashes":if(""===v)k.strokeDashArray=[];else{var r=v.trim().split(/\s+/);if(t&&v||q(b,u,r))k.strokeDashArray=0===r.length?[]:r.map(function(b){return parseInt(b,10)})}break;case "strokeWidth":if(""===v)k[u]="";else if(a.isNumber(v))if(r=parseInt(v,10),0>=r)k[u]="";else if(t&&
v||!t&&q(b,u,r))k[u]=p(r);break;case "color":""===v?k[u]="":q(b,u,v)&&(k[u]=p(v));break;case "tags":t?v&&(k[u]='""'===v||"''"===v?"":p(v)):q(b,u,v)&&(k[u]=p(v));break;case "childtext":"text"!==b.type&&q(b,u,v)&&(k.text=x(v));break;case "ix":q(b,u,v)&&(b.pub.preservedcoords&&"d"===v.charAt(0).toLowerCase()?(k.dx=p(v.substring(1)),void 0===k.dy&&void 0!==b.pub.dy&&(k.dy=b.pub.dy)):(k.x=p(v),void 0===k.y&&void 0!==b.pub.y&&(k.y=b.pub.y)));break;case "iy":q(b,u,v)&&(b.pub.preservedcoords&&"d"===v.charAt(0).toLowerCase()?
(k.dy=p(v.substring(1)),void 0===k.dx&&void 0!==b.pub.dx&&(k.dx=b.pub.dx)):(k.y=p(v),void 0===k.x&&void 0!==b.pub.x&&(k.x=b.pub.x)));break;case "px":q(b,u,v)&&(k.px=p(v),void 0===k.py&&b.pub.lcs&&(k.py=b.pub.lcs.y));break;case "py":q(b,u,v)&&(k.py=p(v),void 0===k.px&&b.pub.lcs&&(k.px=b.pub.lcs.x));break;case "ra":q(b,u,v)&&(k.ra=v,void 0===k.dec&&(b.pub.wcsconfig&&b.pub.wcsconfig.wcsposstr?k.dec=b.pub.wcsconfig.wcsposstr[1]:b.pub.wcsposstr&&(k.dec=b.pub.wcsposstr[1])));break;case "dec":q(b,u,v)&&
(k.dec=v,void 0===k.ra&&(b.pub.wcsconfig&&b.pub.wcsconfig.wcsposstr?k.ra=b.pub.wcsconfig.wcsposstr[0]:b.pub.wcsposstr&&(k.ra=b.pub.wcsposstr[0])),void 0===k.wcssys&&(k.wcssys=w));break;case "wcssys":break;case "radius":case "length":case "width":case "r1":switch(w){case "image":q(b,u,v)&&(k[u]=p(v));break;case "physical":q(b,u,v)&&(k[u]=p(v)*f);break;default:r=a.strtoscaled(v),v=Math.abs(r.dval/l.cdelt1),u=u.replace("wcs",""),q(b,u,v)&&(k[u]=p(v))}break;case "height":case "r2":switch(w){case "image":q(b,
u,v)&&(k[u]=p(v));break;case "physical":q(b,u,v)&&(k[u]=p(v)*f);break;default:r=a.strtoscaled(v),v=Math.abs(r.dval/l.cdelt2),u=u.replace("wcs",""),q(b,u,v)&&(k[u]=p(v))}break;case "radii":q(b,u,v)&&(k[u]=v);break;case "linelength":if(b.pub.pts&&2===b.pub.pts.length&&a.isNumber(v)&&v!==this.tmp.linelength){v=parseFloat(v);switch(w){case "image":case "physical":break;default:void 0!==l.cdelt1?v/=Math.abs(l.cdelt1):void 0!==l.cdelt2&&(v/=Math.abs(l.cdelt2))}k.pts?(u=k.pts[0],r=k.pts[1]):(u=b.pub.pts[0],
r=b.pub.pts[1]);if(0<=$.inArray("line",a.Regions.opts.noCenteredScaling)){var z=Math.sqrt((u.x-r.x)*(u.x-r.x)+(u.y-r.y)*(u.y-r.y));var y=u.x-v*(u.x-r.x)/z;v=u.y-v*(u.y-r.y)/z;k.pts=[u,{x:y,y:v}]}else y={x:(u.x+r.x)/2,y:(u.y+r.y)/2},z=parseFloat(this.tmp.lineangle)||0,u.x=y.x-v/2,u.y=y.y,r.x=y.x+v/2,r.y=y.y,k.pts=[a.rotatePoint(u,z,y),a.rotatePoint(r,z,y)]}break;case "lineangle":b.pub.pts&&2===b.pub.pts.length&&a.isNumber(v)&&v!==this.tmp.lineangle&&(z=parseFloat(v)-parseFloat(this.tmp.lineangle)||
0,k.pts?(u=k.pts[0],r=k.pts[1]):(u=b.pub.pts[0],r=b.pub.pts[1]),0<=$.inArray("line",a.Regions.opts.noCenteredScaling)?k.pts=[u,a.rotatePoint(r,z,u)]:(y={x:(u.x+r.x)/2,y:(u.y+r.y)/2},k.pts=[a.rotatePoint(u,z,y),a.rotatePoint(r,z,y)]));break;case "remove":q(b,u,v)&&(t?k[u]="selected":void 0!==b.pub.id&&(k[u]=b.pub.id));break;case "locked":q(b,u,!p(v))&&(k.changeable=!p(v));break;case "misc":if(v.trim())try{var A=JSON.parse(v);$.extend(k,A)}catch(C){a.error("invalid json: "+v)}break;default:q(b,u,v)&&
(k[u]=p(v))}}0<Object.keys(k).length&&(c=t?$(c).find("[name='selectfilter']").val()||"selected":$(c).find("[name='id']").val()||b,this.changeShapes(g,c,k),this.initRegionsForm(b,{multi:t}))};a.Regions.regionsConfigSetSelectFilter=function(c,b){var d=[];var e=[],f=[],g=c.closest("form"),h=g.find("[name='selectfilter']"),k=g.data("im");g=function(b){if(!b)return"";b=b.trim();return"("===b.charAt(0)&&")"===b.charAt(b.length-1)?b:"("+b+")"};if(k){f=k.listGroups("all",{includeregions:!1}).split("\n");
var l=c.val().trim();var m=h.val().trim();if("other"===b&&"saved"===l)(b=k.layers.regions.selection||"")&&m&&(b=g(b)+" && "+g(m)),h.val(""+b);else{m&&(d=m.split(/\s+/));if(d.length&&(d=d[d.length-1],!l.match(/[&|]/)&&!d.match(/[&|!]/))){switch(b){case "regions":e=a.regions;break;case "wcssys":e=a.wcssyss;break;case "groups":e=f;break;case "ops":e=["!","&&","||"]}l=0<=$.inArray(d,e)?"|| "+l:0<=$.inArray(d,f)||0<=$.inArray(l,f)?"|| "+l:"&& "+l}d=m+" "+l;if(a.globalOpts.regConfigAddParens){d=d.split("||");
if(2<=d.length)for(m=0;m<d.length;m++)b=d[m].trim(),0<b.indexOf("&&")?d[m]=g(b):d[m]=b;d=d.join(" || ").replace(/  */g," ")}h.val(d)}c.prop("selectedIndex",0)}};a.Regions.regionsConfigSetSelectMenu=function(a,b,d){var c,f;d.match(/^select/)||(d="select"+d);b=b.find("[name='"+d+"']");var g=b[0];for(c=g.options.length-1;1<=c;c--)g.remove(c);g=a.getShapes("regions","all");switch(d){case "selectshape":a=0;for(f=[];a<g.length;a++)c=g[a].shape,0>$.inArray(c,f)&&(b.append("<option>"+c+"</option>"),f.push(c));
...
d/=h;e/=h;for(c=0;c<h;c++){var k=g[c].pub.x-d+this.ipos.x;var l=g[c].pub.y-e+this.ipos.y;this.changeShapes("regions",g[c].pub.id,{x:k,y:l})}}a.globalOpts.regToClipboard=f}else a.error(a.CLIPBOARDERROR2);return b}};a.Regions.listRegions=function(c,b,d){var e=this,f,g,h,k,l,m="";var n="none";var q=!1,p=[];var x={};var w=[],t=[];var u={includeObj:!0};var v=function(c,d){var f,g={},h=c.params,k=h.children,l=h.exports;for(f=0;f<l.length;f++){var m=l[f];if(("text"!==m||"text"===c.type)&&"textOpts"!==m){if("strokeDashArray"===
m&&c.strokeDashArray){var n=c.strokeDashArray.join("");if(""===n||n.match(/NaN/))continue}"id"===m&&b.file||"wcsconfig"===m&&b.file||"data"===m&&"object"===typeof h.data&&!1===h.data.doexport&&b.file||("strokeWidth"===m&&h.sw1?g[m]=h.sw1:void 0!==c[m]?g[m]=c[m]:void 0!==h[m]?g[m]=h[m]:d&&void 0!==d[m]&&(g[m]=d[m]))}}if(0<k.length&&k[0].obj.text){n=k[0].obj;g.text=n.text;g.textOpts=v(n);if(c.angle!==n.angle){if(g.textOpts.angle=-n.angle,"circle"===c.params.shape||"annulus"===c.params.shape)n.params.hasTextOpts=
...
c.stroke&&delete g.textOpts.color;g.textOpts.text&&delete g.textOpts.text;Object.keys(g.textOpts).length||delete g.textOpts}return g};b=b||{};if("string"===typeof b)try{b=JSON.parse(b)}catch(D){a.error("can't parse listRegions opts: "+b,D)}a.notNull(b.sortids)&&(u.sortids=b.sortids);var r=b.mode;a.isNull(r)&&(r=3);d=d||"regions";if(this.getShapeLayer(d)){if(b.wcssys||b.wcsunits){var z=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;if(b.wcssys){var y=this.getWCSSys();this.setWCSSys(b.wcssys,!1);
var A=this.getWCSSys()}if(b.wcsunits){var C=this.getWCSUnits();this.setWCSUnits(b.wcsunits,!1)}this.updateShapes(d,c,"export")}a.isNull(b.includedcoords)&&(b.includedcoords=a.globalOpts.regListDCoords);p=this.getShapes(d,c,u);u=p.length;if(r)for(f=0;f<u;f++){var B=p[f];if((h=B.tags.join(","))&&"source,include"!==h&&"include,source"!==h){q=!0;break}}f=$jscomp.makeIterator(Object.keys(a.Regions.opts.tagcolors));for(B=f.next();!B.done;B=f.next())h=B.value,t.push(a.Regions.opts.tagcolors[h]);for(f=0;f<
u;f++)if(B=p[f],x=B.obj,w=[],!B.sticky||!1!==b.sticky)if(!B.preservedcoords||b.includedcoords)if(!B.ignore||b.ignoreignore)if($.isArray(x.params.preservedcoords)){for(g=0;g<x.params.preservedcoords.length;g++)switch(h=x.params.preservedcoords[g],h){case "pts":0>$.inArray("dx",w)&&w.push("dx");0>$.inArray("dy",w)&&w.push("dy");0>$.inArray("points",w)&&w.push("points");break;default:w.push(h)}"none"!==n&&(m+="; ");"image"!==n&&(m+="image",m+="; ");m+=B.shape+"({";for(l=g=0;g<w.length;g++)if(h=w[g],
"shape"!==h&&"sticky"!==h&&"wcsconfig"!==h){"pts"===h&&(h="dx",x.params.preservedcoords.push("dy"),x.params.preservedcoords.push("points"));if("preservedcoords"===h)n=!0;else if(a.notNull(B[h]))n=B[h];else if(a.notNull(x[h]))n=x[h];else switch(h){case "dx":n=x.left;break;case "dy":n=x.top;break;case "color":n=x.stroke;break;default:n=null}if(n)switch(0<l++&&(m+=","),m+='"'+h+'":',typeof n){case "string":m+='"'+n+'"';break;case "object":try{m+=JSON.stringify(n)}catch(D){a.error("can't parse: "+n,D)}break;
default:m+=""+n}}m+="})";n="image"}else h=B.tags.join(","),g=h.includes("exclude")?"-":"",x=v(x,B),b.saveid?x.id=B.id:delete x.id,b.savewcsconfig&&B.wcsconfig&&0<Object.keys(B.wcsconfig).length?x.wcsconfig=$.extend(!0,{},B.wcsconfig):delete x.wcsconfig,B.color&&!t.includes(B.color)&&(x.color=B.color),q&&(k=" # "+h),b.saveediting||delete x.editing,B.wcsstr&&a.isWCSSys(this.params.wcssys)?("wcs"!==n&&("none"!==n&&(m+="; "),m=B.wcssys?m+B.wcssys:m+this.params.wcssys,n="wcs"),m+="; "+g+B.wcsstr):B.imstr&&
(n!==B.imsys&&("none"!==n&&(m+="; "),m+=B.imsys,n=B.imsys),m+="; "+g+B.imstr),!1!==b.includejson&&1===r%2&&0<Object.keys(x).length&&("line"===B.shape&&(m=m.replace(/ *{[^{}]*}$/,"")),m+=" "+JSON.stringify(x)),k&&(m+=k);!1===b.includecomments&&(m=m.replace(/ *#[^;]*/g,""));if(y||C)y&&this.setWCSSys(y,!1),C&&this.setWCSUnits(C,!1),this.updateShapes(d,c,"export"),a.globalOpts.xeqPlugins=z;1<r&&this.display.displayMessage("regions",m);return m}};a.Regions.copyRegions=function(a,b){return this.copyShapes("regions",
a,b)};a.Regions.parseRegions=function(c,b){var d=this,e,f,g=[],h=/^-?(annulus|box|circle|cross|ellipse|line|polygon|point|text)$/,k=/^(fk4|fk5|icrs|galactic|ecliptic|image|physical|linear)$/,l=/^(image|physical)$/,m=/[dr:]/,n=/\(\s*([^)]+?)\s*\)/,q=/(\{.*\})/,p=/\s*,\s*/,x=/#(?![a-zA-Z0-9]{6}['"])/,w=function(b){return"0"===b||"false"===b.toLowerCase()?!1:!0},t=function(b){for(var a,c,d,e={},f=/([a-zA-Z][a-zA-Z0-9_]*)\s*=\s*(\d+(\s*\d+)*|[^ '"{]+|['"{][^'"}]*['"}])/g,g={color:function(b){return{color:b}},
dash:function(b){if(b)return{strokeDashArray:[3,1]}},dashlist:function(b){if(b){var a=b.split(" ");for(b=0;b<a.length;b++)a[b]=parseFloat(a[b]);return{strokeDashArray:a}}},delete:function(b){return{removable:w(b)}},edit:function(b){return{selectable:w(b)}},fixed:function(b){return{zoomable:!w(b)}},font:function(b){var a={};b=b.split(" ");var c=b.length;1<=c&&(a.fontFamily=b[0]);2<=c&&(a.fontSize=parseFloat(b[1]));3<=c&&(a.fontStyle=b[2]);4<=c&&(a.fontWeight=b[3]);return a},highlite:function(b){return{hasControls:w(b),
hasBorders:w(b),hasRotatingPoint:w(b)}},move:function(b){return{movable:w(b)}},rotate:function(b){return{rotatable:w(b)}},resize:function(b){return{resizable:w(b)}},changeable:function(b){return{changeable:w(b)}},select:function(b){return{selectable:w(b)}},text:function(b){return{text:b}},tag:function(b){return{tags:b}},width:function(b){return{strokeWidth:parseFloat(b)}}};null!==(a=f.exec(b));)if(c=a[1].toLowerCase(),a=a[2].replace(/^['"{]|['"}]$/g,""),{}.hasOwnProperty.call(g,c)&&"function"===typeof g[c])for(c=
g[c](a)||{},a=$jscomp.makeIterator(Object.keys(c)),d=a.next();!d.done;d=a.next())d=d.value,"tags"===d&&{}.hasOwnProperty.call(e,d)?e[d]+=","+c[d]:e[d]=c[d];else e[c]=a;if(b=b.replace(f,""))e._comment=b.trim();return e},u=function(b){var c,d={opts:{},args:[],isregion:0};b.includes("(")?d.cmd=b.split("(")[0].trim().toLowerCase():b.includes("{")?d.cmd=b.split("{")[0].trim().toLowerCase():b.includes("#")?d.cmd=b.split("#")[0].trim().toLowerCase():d.cmd=b.trim().toLowerCase();d.cmd&&(d.isregion=0<=d.cmd.search(h));
var e=b.trim().split(x);if((c=q.exec(e[0]))&&c[0])try{d.opts=JSON.parse(c[0].trim())}catch(M){a.error("can't parse opts: "+c[0],M)}d.comment=e[1];if(d.comment){var f=t(d.comment.trim());void 0!==f._comment&&(d.comment=f._comment,delete f._comment)}f&&(d.opts=$.extend({},f,d.opts));(c=n.exec(b))&&c[0].match(q)?d.args=[]:c&&c[1]&&(d.args=c[1].split(p));d.isregion&&d.cmd.startsWith("-")&&(d.cmd=d.cmd.slice(1),d.comment?d.comment.match(/exclude/)||(d.comment+=",exclude"):d.comment="exclude");return d},
v=function(b,c){var e={};if("d"===b.charAt(0).toLowerCase()&&"d"===c.charAt(0).toLowerCase())return e.dx=parseFloat(b.substring(1)),e.dy=parseFloat(c.substring(1)),e;b=a.strtoscaled(b);c=a.strtoscaled(c);!b.dtype.match(m)&&!c.dtype.match(m)||A||z.match(l)||(B=!0,y=z);if(A||B)return a.isHMS(y,b.dtype)&&(b.dval*=15),"r"===b.dtype&&(b.dval=180*b.dval/Math.PI),"r"===c.dtype&&(c.dval=180*c.dval/Math.PI),c=a.wcs2pix(d.raw.wcs,b.dval,c.dval).split(/ +/),e.x=parseFloat(c[0]),e.y=parseFloat(c[1]),e;if("physical"===
y)return c=d.logicalToImagePos({x:b.dval,y:c.dval}),e.x=c.x,e.y=c.y,e;e.x=b.dval;e.y=c.dval;return e},r=function(b,c){b=a.strtoscaled(b);var e=d.raw.wcsinfo||{cdelt1:1,cdelt2:1};!b.dtype.match(m)||A||z.match(l)||(B=!0,y=z);A||B?("r"===b.dtype&&(b.dval=180*b.dval/Math.PI),0!==a.REGSIZE&&a.error("region size based on ang sep is not implemented"),b.dval=Math.abs(b.dval/e["cdelt"+c])):"physical"===y&&d.lcs&&d.lcs.physical&&(c=Math.sqrt(Math.pow(d.lcs.physical.forward[0][0],2)+Math.pow(d.lcs.physical.forward[0][1],
2)),b.dval=Math.abs(b.dval*c));return b.dval};c=c.trim();if(!c.match(/(\(|\{|#|;|\n)/))return c;var z=this.getWCSSys();b=this.getWCSUnits();var y="physical";var A=a.isWCSSys(y);var C=c.split(/\n|;/);for(c=0;c<C.length;c++)if("#"!==C[c].trim().substr(0,1)){var B=!1;var D=u(C[c]);var E=D.args.length;if(D.isregion){var F=$.extend(!0,{},D.opts);F.shape=D.cmd;F.wcsconfig=F.wcsconfig||{wcssys:y};2<=E&&"line"!==F.shape&&"polygon"!==F.shape&&$.extend(F,v(D.args[0],D.args[1]));F.textOpts&&void 0!==F.textOpts.ra&&
...
[],f=e=0;e<E;e+=2,f++){var G=v(D.args[e],D.args[e+1]);a.notNull(G.dx)&&a.notNull(G.dy)?F.pts[f]={dx:G.dx,dy:G.dy}:F.pts[f]={x:G.x,y:G.y}}break;case "text":3<=E&&(F.text=D.args[2].replace(/^['"]/,"").replace(/["']$/,"")),4<=E&&(F.angle=a.strtoscaled(D.args[3]).dval)}D.comment&&(F.tags=D.comment);g.push(F)}else D.cmd.match(k)?(e=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,this.setWCSSys(D.cmd,!1),a.globalOpts.xeqPlugins=e,y=this.getWCSSys(),A=a.isWCSSys(y)):"remove"!==D.cmd&&"delete"!==D.cmd||
g.push({remove:!0})}e=a.globalOpts.xeqPlugins;a.globalOpts.xeqPlugins=!1;this.setWCSSys(z,!1);this.setWCSUnits(b);a.globalOpts.xeqPlugins=e;return g};a.Regions.saveRegions=function(c,b,d){var e,f,g;c&&(f=c.match(/\.([^.]*)$/))&&f[1]&&f[1].match(/^(reg|svg|csv)$/)&&(e=f[1]);if("object"===typeof d){var h=d;d=null}else if(d&&"string"===typeof d){try{h=JSON.parse(d)}catch(q){h=null}h&&(d=null)}h&&(a.notNull(h.layer)&&(d=h.layer),a.notNull(h.type)&&(e=h.type),a.notNull(h.format)&&(e=h.format));h=h||{};
...
d)}break;case "csv":try{h.mode=1;h.file=c;a.isNull(h.includewcs)&&(h.includewcs=a.globalOpts.csvIncludeWCS);a.isNull(h.savedcoords)&&(h.includedcoords=a.globalOpts.regSaveDCoords);var l=this.listRegions(b,h,d);f=l.split(";");var m=0;for(k="";m<f.length;m++)if(f[m])if(f[m].toLowerCase().match(a.WCSEXP))h.includewcs&&(k+=f[m].trim()+"\n");else{var n=f[m].replace(/\(/,",").replace(/\).*/,"").trim();k+=n+"\n"}}catch(q){a.error("can't convert layer to region: "+d)}break;default:try{h.mode=1,h.file=c,a.isNull(h.includejson)&&
(h.includejson=a.globalOpts.regIncludeJSON),a.isNull(h.includecomments)&&(h.includecomments=a.globalOpts.regIncludeComments),a.notNull(h.savedcoords)?h.includedcoords=h.savedcoords:h.includedcoords=a.globalOpts.regSaveDCoords,l=this.listRegions(b,h,d).replace(/; */g,"\n"),k=!1!==h.includecomments?"# Region file format: JS9 version 1.0\n"+l+"\n":l+"\n"}catch(q){a.error("can't convert layer to region: "+d)}}b=new Blob([k],{type:"text/plain;charset=utf-8"});({}).hasOwnProperty.call(window,"saveAs")?
...
arrowhead:2,ax:0,ay:l},f.push(c);return f}};a.Plot.initConfigForm=function(c,b){var d,e,f=function(b){if(void 0!==b)return"number"===typeof b&&0!==b%1&&(b=Math.round(100*(b+.001))/100),String(b)};if(c&&b){var g=c.winid;var h="#"+$(g).attr("id")+" #plotConfigForm ";"flot"===a.globalOpts.plotLibrary&&($(h+".val").each(function(g,h){d="";e=$(h).attr("name");switch(e){case "xscale":a.notNull(b.curscale.x)&&(d=f(b.curscale.x));break;case "xmin":a.notNull(c.getAxes().xaxis.options.min)&&(d=f(c.getAxes().xaxis.options.min));
...
if(a.globalOpts.wcsCrosshair&&c.validWCS()){h=a.pix2wcs(c.raw.wcs,b.x,b.y).trim().split(/\s+/);var l=a.saostrtod(h[0]);a.isHMS(c.params.wcssys)&&(l*=15);var m=a.saostrtod(h[1]);for(b=0;b<a.displays.length;b++)if((f=a.displays[b].image)&&f!==c&&f.crosshair&&f.params.crosshair&&f.validWCS()){g=f.raw.width;k=f.raw.height;try{var n=a.wcs2pix(f.raw.wcs,l,m)}catch(q){n=null}n&&(h=n.trim().split(/\s+/),d=parseFloat(h[0]),h=parseFloat(h[1]),0<d&&d<g&&0<h&&h<k&&(g={pts:[{x:0,y:h},{x:g,y:h}],redraw:!1},f.changeShapes(e,
...
a.saostrtod(p[1]);p=a.pix2wcs(k.wcs,b[0].x,b[1].y).trim().split(/\s+/);l[1].ra=a.saostrtod(p[0]);l[1].dec=a.saostrtod(p[1]);p=a.pix2wcs(k.wcs,b[1].x,b[0].y).trim().split(/\s+/);l[2].ra=a.saostrtod(p[0]);l[2].dec=a.saostrtod(p[1]);p=a.pix2wcs(k.wcs,b[1].x,b[1].y).trim().split(/\s+/);l[3].ra=a.saostrtod(p[0]);l[3].dec=a.saostrtod(p[1]);h=l[0].ra;q=l[0].dec;b=l[0].ra;var x=l[0].dec;for(p=1;4>p;p++)h=Math.min(h,l[p].ra),q=Math.min(q,l[p].dec),b=Math.max(b,l[p].ra),x=Math.max(x,l[p].dec);p=a.Grid.limits.call(this,
c,h,b,c.raLines*m[0]);h=p.lo;b=p.hi;l=p.inc;p=a.Grid.limits.call(this,c,q,x,c.decLines*m[1]);q=p.lo;x=p.hi;var w=p.inc;a.wcsunits(this.raw.wcs,c.wcsunits);var t=Math.abs(this.raw.wcsinfo.cdelt1);var u=t*a.Grid.opts.stride;var v=b-u;var r=Math.abs(this.raw.wcsinfo.cdelt2);var z=r*a.Grid.opts.stride;var y=x-z;p="image;";for(f=h;f<=b;f+=l){var A="line(";var C=r;n=e=0;for(g=q;g<=x;g+=C)(d=a.wcs2pix(k.wcs,f,g).trim().split(/ +/))&&d.length&&(m=parseFloat(d[0]),d=parseFloat(d[1]),m>=-c.margin&&m<=k.width+
c.margin&&d>=-c.margin&&d<=k.height+c.margin?(A+=String(m+1+","+d+1+", "),n++,0===e?(e=1,g<y&&(C=z)):1===e&&g>y&&(e=2,C=r)):1===e&&(e=2,g-=C,C=r));1<n&&(p+=A.replace(/,\s+$/,") "),p+=' {"color": "'+c.lineColor+'"};')}for(g=q;g<=x;g+=w){A="line(";C=t;n=e=0;for(f=h;f<=b;f+=C)(d=a.wcs2pix(k.wcs,f,g).trim().split(/ +/))&&d.length&&(m=parseFloat(d[0]),d=parseFloat(d[1]),m>=-c.margin&&m<=k.width+c.margin&&d>=-c.margin&&d<=k.height+c.margin?(A+=String(m+1+","+d+1+", "),n++,0===e?(e=1,f<v&&(C=u)):1===e&&
f>v&&(e=2,C=t)):1===e&&(e=2,f-=C,C=t));1<n&&(p+=A.replace(/,\s+$/,") "),p+=' {"color": "'+c.lineColor+'"};')}e=c.labelDecOffx/this.rgb.sect.zoom;C=c.labelDecOffy/this.rgb.sect.zoom;t=0;f=u=h;for(A=0;f<=b;f+=l){for(g=q;g<=x;g+=w)(d=a.wcs2pix(k.wcs,f,g).trim().split(/ +/))&&d.length&&(m=parseFloat(d[0]),d=parseFloat(d[1]),n=this.imageToDisplayPos({x:m,y:d}),n.x>this.ix+c.labelMargin&&n.x<this.rgb.img.width+this.ix-c.labelMargin&&n.y>this.iy+c.labelMargin&&n.y<this.rgb.img.height+this.iy-c.labelMargin&&
(t>=c.decSkip?(p+=sprintf('text(%s,%s,%s,%s) {"color":"%s", "fontFamily":"%s", "fontSize":%s, "fontStyle":"%s", "fontWeight":"%s", "originX":"left", "originY":"top"};',m+e,d+C,a.Grid.getLabel.call(this,c,g,"dec"),c.decAngle,c.labelColor,c.labelFontFamily,c.labelFontSize,c.labelFontStyle,c.labelFontWeight),A++):(f!==u&&t++,u=f)));if(A)break}e=c.labelRAOffx/this.rgb.sect.zoom;C=c.labelRAOffy/this.rgb.sect.zoom;t=0;g=u=q;for(A=0;g<=x;g+=w){for(f=h;f<=b;f+=l)(d=a.wcs2pix(k.wcs,f,g).trim().split(/ +/))&&
...
k[k.length-1];if("string"===typeof c)try{var l=JSON.parse(c)}catch(n){l=null}else"object"===typeof c&&(l=c);if(l&&"object"===typeof l&&{}.hasOwnProperty.call(l,"display")&&1===Object.keys(l).length){k.pop();break a}}l={display:f}}else l=null}switch(e){case "RunAnalysis":b&&(1===d.length&&d.push(null),d.push(b))}l&&d.push(l);try{var m=a.publics[e].apply(a.publics,$jscomp.arrayFromIterable(d))}catch(n){m="ERROR: "+n.message}if(b){a.globalOpts.alerts=g;if(m instanceof a.Display||m instanceof a.Image)m=
m.id;switch(e){case "NewShapeLayer":m&&m.layerName&&(m=m.layerName);break;case "RunAnalysis":m.match(/^ERROR:/)||(b=null)}b&&b(m)}return m}if(e&&"#"!==e){l=a.lookupCommand(e);k=a.lookupDisplay(f,!1);if(l&&k)switch(l.getDisplayInfo(k),c.args?d=$.extend(!0,[],c.args):c.paramlist&&(d=c.paramlist.split(/ +/)),l.getWhich(d)){case "get":try{m=l.get(d)||""}catch(n){m="ERROR: "+n.message}break;case "set":try{m=l.set(d)||h}catch(n){m="ERROR: "+n.message}break;default:m="ERROR: unknown cmd type for '"+e+"'"}else l||
(m="ERROR: unknown cmd '"+e+"'"),k||(m="ERROR: unknown display ("+f+")");if(b){a.globalOpts.alerts=g;if(m instanceof a.Display||m instanceof a.Image)m=m.id;b(m)}return m}b&&b("");b&&(a.globalOpts.alerts=g)};a.lightWin=function(c,b,d,e,f){f=f||"";switch(a.LIGHTWIN){case "dhtml":f.match(/(left|top|center)=/)||(f&&(f+=","),f+=""+a.globalOpts.lightWinPos);var g=dhtmlwindow.open(c,b,d,e,f);/iPad|iPhone|iPod/.test(navigator.platform)&&$("#"+c+" "+a.lightOpts[a.LIGHTWIN].drag).css("-webkit-overflow-scrolling",
...
h||a[b].y>h)var h=a[b].y}return{x:(e+f)/2,y:(g+h)/2}}};a.centroidPolygon=function(a,b){var c=0,e=0,f=0,g=0,h=0,k=[];if(a&&a.length){var l=a.length;if(b){for(b=0;b<l;b++)g+=a[b].x,h+=a[b].y;return{x:g/l,y:h/l}}for(b=0;b<l;b++)k[b]={},k[b].x=a[b].x,k[b].y=a[b].y;k[l]={};k[l].x=k[0].x;k[l].y=k[0].y;for(b=0;b<l;b++)a=k[b].x*k[b+1].y-k[b+1].x*k[b].y,c+=a,e+=(k[b].x+k[b+1].x)*a,f+=(k[b].y+k[b+1].y)*a;l=c/2;return{x:e/(6*l),y:f/(6*l)}}};a.lookupImage=function(c,b){var d,e,f=a.images.length;if(!c)return null;
...
var h=g.getContext("2d");var p=l.height,x=l.width;g.width=x;g.height=p;h.drawImage(l,0,0);e=h.getImageData(0,0,x,p).data;f=new Float32Array(p*x);for(h=0;h<p;h++)for(g=0;g<x;g++){var w=.299*e[a]+.587*e[a+1]+.114*e[a+2];f[(p-h)*x+g]=w;a+=4}k={filename:c.name,naxis:2,axis:[0,x,p],bitpix:-32,bin:1,head:{SIMPLE:!0,BITPIX:-32,NAXIS:2,NAXIS1:x,NAXIS2:p},data:f,offscreen:l};k.dmin=Number.MAX_VALUE;k.dmax=Number.MIN_VALUE;for(a=0;a<p*x;a++)!Number.isNaN(k.data[a])&&Number.isFinite(k.data[a])&&(k.dmin=Math.min(k.dmin,
k.data[a]),k.dmax=Math.max(k.dmax,k.data[a]));b.source="img";d(k,b)};l.src=a.target.result};e.readAsDataURL(c)};a.getFITSImage=function(c,b,d,e){a.fits.getFITSImage?a.fits.getFITSImage(c,b,d,e):a.error("no FITS module available to process FITS image")};a.fits2fits=function(c,b,d,e){var f,g={};d=d||{};var h=a.notNull(d.fits2fits)?d.fits2fits:a.globalOpts.fits2fits;!0===h?h="always":!1===h&&(h="never");if(h.match(/never/i))return!1;if(!a.helper.connected||"nodejs"!==a.helper.type&&"socket.io"!==a.helper.type)return"always"===
h&&a.globalOpts.requireFits2Fits&&a.error("can't run fits2fits without connected JS9 helper"),!1;if(!a.helper.js9helper)if(a.globalOpts.requireFits2Fits)a.error("js9helper not found for fits2fits processing");else return!1;if(!a.globalOpts.workDir)return a.globalOpts.requireFits2Fits&&a.error("can't run fits2fits without a workdir"),!1;var k=d.xdim||a.fits.options.image.xdim||a.fits.options.table.xdim;var l=d.ydim||a.fits.options.image.ydim||a.fits.options.table.ydim;var m=d.bin||a.fits.options.image.bin||
a.fits.options.table.bin;var n=d.binMode||a.globalOpts.binMode;n="a"===n?"a":"";"string"===typeof m&&(m.match(/[as]$/)&&(n=m.slice(-1)),m=parseInt(m,10));m=Math.max(1,m||1);a.notNull(d.xcen)&&a.notNull(d.ycen)?g.sect=k+"@"+d.xcen+","+l+"@"+d.ycen+","+m+n:g.sect=k+","+l+","+m+n;l=h.toLowerCase().split(/[>,]/);for(k=0;k<l.length;k++)switch(l[k]){case "size":l[k+1]&&(a.isNumber(l[k+1])&&(g.maxsize=1E6*parseFloat(l[k+1])),k++)}g.fits=a.cleanPath(b);g.parent=!0;a.waiting(!0,c);a.helper.send("fits2fits",
...
var g,h,k,l="",m="",n=!0;a.waiting(!1);"processing"===a.fetchURL.status&&(a.fetchURL.status="error");for(h=0;h<a.images.length;h++){var q=a.images[h];(k=q.status.cur)&&q.status[k]&&q.setStatus(k,"error")}"string"===typeof f?(f=d.match(f))?f[1]?d=f[1]:f[0]&&(d=f[0]):n=!1:"object"===typeof f&&(g=f);3>b.length&&(e=!0);if(n&&(g&&g.message?d+=" ("+g.message+")":d&&(g=Error(d)),(b=a.strace(g))&&(m="\n\nStacktrace:\n"+b),a.globalOpts.alerts&&(d&&"string"===typeof d&&0>d.search(/ERROR/)&&(l="JS9 ERROR: "),
alert(l+(d+m))),e))throw g;};a.log=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];void 0!==window.console&&void 0!==window.console.log&&console.log.apply(console,$jscomp.arrayFromIterable(b))};a.eventToCharStr=function(c){var b={37:"leftArrow",38:"upArrow",39:"rightArrow",40:"downArrow",8:"delete"},d={188:"44",109:"45",190:"46",191:"47",192:"96",220:"92",222:"39",221:"93",219:"91",173:"45",187:"61",186:"59",189:"45"},e={96:"~",49:"!",50:"@",51:"#",52:"$",53:"%",54:"^",55:"&",
...
"SIMPLE","T","file does conform to FITS standard");g[b]=!0;return e};if(!c)return f;b=b||{};"boolean"===typeof b&&(b={addcr:b});if(c.card||c.cardstr){var l=c.header||{};var m=c.card?c.card.length:c.ncard;for(d=0;d<m;d++)if(h=c.card?c.card[d].slice(0,80):c.cardstr.slice(80*d,80*(d+1)),!b.notab||!h.match(/^TAB(TYP|MIN|MAX|DIM)[1,2]/)){if(h.match(/^XTENSION/)&&0===d&&b.simple)f+=k(h,"XTENSION");else if(h.match(/^BITPIX /)&&c.bitpix)f+=k(h,"BITPIX",c.bitpix,"bits/pixel");else if(h.match(/^NAXIS1 /)&&
c.width)f+=k(h,"NAXIS1",c.width,"x image dim");else if(h.match(/^NAXIS2 /)&&c.height)f+=k(h,"NAXIS2",c.height,"y image dim");else if(h.match(/^CRPIX1 /)&&a.notNull(l.CRPIX1))f+=k(h,"CRPIX1",l.CRPIX1,"ref point");else if(h.match(/^CRPIX2 /)&&a.notNull(l.CRPIX2))f+=k(h,"CRPIX2",l.CRPIX2,"ref point");else if(h.match(/^CDELT1 /)&&a.notNull(l.CDELT1))f+=k(h,"CDELT1",l.CDELT1,"deg/pixel");else if(h.match(/^CDELT2 /)&&a.notNull(l.CDELT2))f+=k(h,"CDELT2",l.CDELT2,"deg/pixel");else if(h.match(/^CD1_1 /)&&
a.notNull(l.CD1_1))f+=k(h,"CD1_1",l.CD1_1,"WCS matrix value");else if(h.match(/^CD1_2 /)&&a.notNull(l.CD1_2))f+=k(h,"CD1_2",l.CD1_2,"WCS matrix value");else if(h.match(/^CD2_1 /)&&a.notNull(l.CD2_1))f+=k(h,"CD2_1",l.CD2_1,"WCS matrix value");else if(h.match(/^CD2_2 /)&&a.notNull(l.CD2_2))f+=k(h,"CD2_2",l.CD2_2,"WCS matrix value");else if(h.match(/^LTV1 /)&&a.notNull(l.LTV1))f+=k(h,"LTV1",l.LTV1,"IRAF ref. point");else if(h.match(/^LTV2 /)&&a.notNull(l.LTV2))f+=k(h,"LTV2",l.LTV2,"IRAF ref. point");
else if(h.match(/^LTM1_1 /)&&a.notNull(l.LTM1_1))f+=k(h,"LTM1_1",l.LTM1_1,"IRAF matrix value");else if(h.match(/^LTM1_2 /)&&a.notNull(l.LTM1_2))f+=k(h,"LTM1_2",l.LTM1_2,"IRAF matrix value");else if(h.match(/^LTM2_1 /)&&a.notNull(l.LTM2_1))f+=k(h,"LTM2_1",l.LTM2_1,"IRAF matrix value");else if(h.match(/^LTM2_2 /)&&a.notNull(l.LTM2_2))f+=k(h,"LTM2_2",l.LTM2_2,"IRAF matrix value");else if(b.twoaxes&&h.match(/^NAXIS /))f+=k(h,"NAXIS",2,"number of data axes");else if(b.twoaxes&&h.match(/^(NAXIS|CRPIX|CRVAL|CTYPE|CUNIT|CDELT)[34567]/))continue;
else if(b.twoaxes&&h.match(/^(DATASUM|CHECKSUM)/))continue;else"END "===h.substring(0,4)?(a.notNull(l.LTV1)&&!g.LTV1&&(f+=k(null,"LTV1",l.LTV1,"IRAF ref. point"),b.addcr&&(f+="\n")),a.notNull(l.LTV2)&&!g.LTV2&&(f+=k(null,"LTV2",l.LTV2,"IRAF ref. point"),b.addcr&&(f+="\n")),a.notNull(l.LTM1_1)&&!g.LTM1_1&&(f+=k(null,"LTM1_1",l.LTM1_1,"IRAF matrix value"),b.addcr&&(f+="\n")),a.notNull(l.LTM1_2)&&!g.LTM1_2&&(f+=k(null,"LTM1_2",l.LTM1_2,"IRAF matrix value"),b.addcr&&(f+="\n")),a.notNull(l.LTM2_1)&&!g.LTM2_1&&
(f+=k(null,"LTM2_1",l.LTM2_1,"IRAF matrix value"),b.addcr&&(f+="\n")),a.notNull(l.LTM2_2)&&!g.LTM2_2&&(f+=k(null,"LTM2_2",l.LTM2_2,"IRAF matrix value"),b.addcr&&(f+="\n")),f+=h,e=!0):f+=h;b.addcr&&(f+="\n")}}else if(c.header||c.BITPIX){c=c.header?c.header:c;if(void 0!==c.SIMPLE||void 0!==c.simple)m=void 0!==c.SIMPLE?c.SIMPLE:c.simple,!0===m?m="T":!1===m&&(m="F"),f+=sprintf("%-8s= %20s / %-47s","SIMPLE",m,"conforms to FITS standard"),b.addcr&&(f+="\n");if(void 0!==c.BITPIX||void 0!==c.bitpix)m=void 0!==
c.BITPIX?c.BITPIX:c.bitpix,f+=sprintf("%-8s= %20s / %-47s","BITPIX",m,"bits/pixel"),b.addcr&&(f+="\n");k=$jscomp.makeIterator(Object.keys(c));for(d=k.next();!d.done;d=k.next())if(d=d.value,"js9Protocol"!==d&&"js9Endian"!==d&&"SIMPLE"!==d&&"simple"!==d&&"BITPIX"!==d&&"bitpix"!==d&&("END"===d&&(e=!0),b.twoaxes&&"NAXIS"===d&&(c[d]=2),!b.twoaxes||!d.match(h))){if(d.match(/HISTORY__[0-9]+/))f+=sprintf("HISTORY %-72s",c[d]);else if(d.match(/COMMENT__[0-9]+/))f+=sprintf("COMMENT %-72s",c[d]);else{m=c[d];
!0===m?m="T":!1===m?m="F":""===m?m="' '":Number.isNaN(m)?m="NaN":a.isNumber(m)||"'"===m.charAt(0)||(m="'"+m+"'");m=sprintf("%-8s= %20s",d,m);l=80-m.length;if(0<l)for(d=0;d<l;d++)m+=" ";f+=m}b.addcr&&(f+="\n")}}e||(f+=sprintf("%-8s%-72s","END"," "),b.addcr&&(f+="\n"));return f};a.hdus2Str=function(c){var b,d="";if(!c)return d;for(b=0;b<c.length;b++){var e=c[b];var f=e.name?e.name:0===b?"Primary":"N/A";d+=sprintf("<b>#%d</b>:&#09;<b>name</b>: %s&#09;<b>type</b>: %s",e.hdu,f,e.type);switch(e.type){case "image":d+=
...
if(c.is(b))var g=c;else if(g=c.find(b),!g.length)return;var h=c.find(a.lightOpts[a.LIGHTWIN].drag);h.length||(h=c);var k=h.find(".JS9Searchbar");if(k.length)k.css("display","block");else{k=$("<div>").addClass("JS9Searchbar").appendTo(h);k.opts={matchcase:!1,matchdiacritics:!1,matchwords:!1,matchwildcards:!1};var l=$("<input type='search'>").addClass("JS9SearchInput").appendTo(k);l.on("input",function(){d(l.val())});k.opts.matchwildcards?l.prop("placeholder","sea*rch template?"):l.prop("placeholder",
"search term(s)");b=$("<button>").addClass("JS9SearchButton").prop("data-btn","next").html("&darr;").appendTo(k);var m=$("<button>").addClass("JS9SearchButton").prop("data-btn","prev").html("&uarr;").appendTo(k);b.add(m).on("click",function(a){k.results&&k.results.length&&(k.currentIndex+=$(a.currentTarget).is(m)?-1:1,0>k.currentIndex&&(k.currentIndex=k.results.length-1),k.currentIndex>k.results.length-1&&(k.currentIndex=0),f())});var n=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchcase).prop("data-btn",
"matchcase").html("Match Case").appendTo(k);n.on("click",function(){k.opts.matchcase=!k.opts.matchcase;e(n);d(l.val())});e(n);var q=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchdiacritics).prop("data-btn","matchdiacritics").html("Match Diacritics").appendTo(k);q.on("click",function(){k.opts.matchdiacritics=!k.opts.matchdiacritics;e(q);d(l.val())});e(q);var p=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchwords).prop("data-btn","matchwords").html("Whole Words").appendTo(k);
p.on("click",function(){k.opts.matchwords=!k.opts.matchwords;e(p);d(l.val())});e(p);var x=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchwildcards).prop("data-btn","matchwildcards").html("Wildcards").appendTo(k);x.on("click",function(){k.opts.matchwildcards=!k.opts.matchwildcards;k.opts.matchwildcards?l.prop("placeholder","sea*rch template?"):l.prop("placeholder","search term(s)");e(x);d(l.val())});e(x);$("<button>").addClass("JS9SearchButton").prop("data-btn","close").html("Close").appendTo(k).on("click",
function(){g.unmark();l.val("");k.css("display","none")});h.css("outline","none");h.attr("tabindex","0");h.on("keydown",function(b){var c=String.fromCharCode(b.which||b.keyCode);a.specialKey(b)&&"F"===c&&("none"===k.css("display")?(k.css("display","block"),l.focus()):(g.unmark(),l.val(""),k.css("display","none")))})}};a.tooltip=function(c,b,d,e,f,g){var h=function(b){return b.replace(/\$([a-zA-Z0-9_./]+)/g,function(b,c,d){c=c.split(".");switch(c[0]){case "im":d=e;break;case "xreg":d=f;break;case "evt":d=
...
"[object Uint32Array]":!0,"[object Float32Array]":!0,"[object Float64Array]":!0},a)};a.Starbase=function(a,b){var c,e,f=0;var g=function(a){var b;for(b=0;b<a.length;b++)if(null===a[b].match(/^-+$/))return 0;return b};var h=function(a){return a};this.head={};this.convFuncs=[];this.data=[];this.delims=[];if(a){b=b||{};a=a.replace(/\s+$/,"").split("\n");if(b.skip&&(c=b.skip.split(""))&&c.length)for(;f<a.length&&(c[0]===a[f][0]||"\n"===c[1]&&""===a[f]);f++);if(void 0!==a[f]&&void 0!==a[f+1]){this.headline=
...
b.min});return d};a.lookupStaticColor=function(a,b,d){var c={red:0,green:0,blue:0,alpha:0};if(a&&a.staticObj){c=a.params.nocolor||c;if(b<a.staticObj.colors[0].min)return c;if(d&&d[b])return d[b];a:{var f=a.staticObj.colors;for(var g,h,k=0,l=f.length-1;k<=l;)if(g=Math.floor((k+l)/2),h=f[g],b>=h.min&&b<=h.max){f=g;break a}else h.max<b?k=g+1:l=g-1;f=-1}0>f?a=c:(a=a.staticObj.colors[f],a.active||(a=c));d&&1E7>=b&&(d[b]=a);return a}return c};a.strtoscaled=function(c){c=a.saostrtod(c);var b=String.fromCharCode(a.saodtype());
...
typeof g),"U0lNUExFICA9"===g.slice(0,12)&&(g=window.atob(g)),"SIMPLE  ="===g.slice(0,9)){h=[];for(e=0;e<g.length;e++)h[e]=g.charCodeAt(e);e=new Blob([new Uint8Array(h)]);b.file||(b.file=a.ANON+a.uniqueID());e.name=b.file;k=$.extend(!0,{},a.fits.options,b);try{a.handleFITSFile(e,k,a.NewFitsImage)}catch(l){a.error("can't process FITS file",l)}}else{a.isNull(b.refresh)&&(b.refresh=a.globalOpts.reloadRefresh);if(b.refresh)if("object"===typeof b.refresh)h=b.refresh;else{if(h=g.split("/").reverse()[0],
h=a.lookupImage(h,b.display))b.refresh=h}else h=g.split("/").reverse()[0],h=a.lookupImage(h,b.display);if(h&&!b.refresh){h.displayImage("all",b);h.display.clearMessage();if(b.onload)try{a.xeqByName(b.onload,window,h)}catch(l){a.error("in image onload callback",l,!1)}a.waiting(!1)}else g=a.cleanPath(g),a.fits2fits(b.display,g,b)||(b.display&&(e=a.lookupDisplay(b.display)),a.waiting(!0,e),h&&b.refresh&&a.cleanupFITSFile(h.raw,!0),g=a.fixPath(g,b),e=g.replace(/\[.*\]/,""),(h=a.localAccess(g))?(k=$.extend(!0,
{},a.fits.options,b),k.file=g,k.vfile=h,window.setTimeout(function(){try{a.handleFITSFile(g,k,a.NewFitsImage)}catch(l){a.error("can't process FITS file",l)}},0)):a.fetchURL(g,e,b))}});a.mkPublic("LoadWindow",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e,f,g,h,k,l,m,n=a.lightOpts[a.LIGHTWIN];var q=a.parsePublicArgs(b);var p=function(b){b=$.inArray(b,a.displays);0<=b&&a.displays.splice(b,1)};var x=function(b,c,d){var f;c=c||{};c.clone&&(f=a.lookupDisplay(c.clone,!1));
d&&(k=d.match(/(.*width=)([0-9]+)(px,height=)([0-9]+)(px.*)/,"$1@@H@@$3"),l=parseInt(k[2],10),m=parseInt(k[4],10));var g="<hr class='hline0'>";!f||0<$("#"+c.clone+"Menubar").length&&!f.pluginInstances.JS9Menubar.isDynamic?g+="<div class='JS9Menubar' id='"+b+"Menubar'></div>":d&&(m-=40);g+="<div class='JS9' id='"+b+"'></div>";!f||0<$("#"+c.clone+"Colorbar").length&&0===$("#"+c.clone+"Statusbar").length&&!f.pluginInstances.JS9Colorbar.isDynamic?(e=f&&f.pluginInstances.JS9Colorbar?"data-showTicks='"+
f.pluginInstances.JS9Colorbar.showTicks+"'":"",g+="<div style='margin-top: 2px;'><div class='JS9Colorbar' id='"+b+"Colorbar' "+e+"></div></div>",f&&f.pluginInstances.JS9Colorbar&&!f.pluginInstances.JS9Colorbar.showTicks&&(m-=15)):d&&(m-=44);!f||0<$("#"+c.clone+"Statusbar").length&&!f.pluginInstances.JS9Statusbar.isDynamic?g+="<div class='JS9Statusbar' id='"+b+"Statusbar'></div>":d&&(m-=40);return d?(a.Dysel.retrievePlugins().length&&(l+=2,m+=2),{html:g,winopts:k[1]+String(l)+k[3]+String(m)+k[5]}):
g};var w=function(b,c){var d=new a.Display(z);d.winid=C;a.helper.send("addDisplay",{display:z});a.instantiatePlugins();c.display=z;b&&a.Load(b,c);return d};var t=function(b){var c;var d=0;var e=[];for(c=0;c<a.images.length;c++)d=a.images[c],d.display.id===z&&e.push(d);if(!e.length)return p(b),!0;if("move"===a.globalOpts.lightWinClose){if(a.isNull(a.globalOpts.lightWinMoveTo)||a.globalOpts.lightWinMoveTo===z)d=0;else for(d=c=0;c<a.displays.length;c++)if(a.displays[c].id===a.globalOpts.lightWinMoveTo){d++;
...
2:3:(null===a.helper.connected||a.helper.connected)&&a.fits.name?1:0;break;default:p=(null===a.helper.connected||a.helper.connected)&&a.fits.name?1:0}switch(p){case 0:for(p=0;p<h;p++)if(l=p+1,l<h&&"object"===typeof b[l])f=$.extend(!0,{},b[l]),a.preloads.push([b[p],f,g]),p++;else if(l<h&&b[l].startsWith("{")){try{f=JSON.parse(b[l])}catch(w){f=null}a.preloads.push([b[p],f,g]);p++}else a.preloads.push([b[p],null,g]);break;case 1:a.globalOpts.alerts=!1;for(p=0;p<h;p++){var x=e&&b[p].match(m)&&!b[p].match(e)?
a.LoadProxy:b[p].match(n)?a.LoadSession:b[p].match(q)?a.LoadColormap:a.Load;l=p+1;if(l<h&&"object"===typeof b[l]){x!==a.Load&&x!==a.LoadProxy||a.preloadwaiting.push({id:a.cleanPath(b[p]),loaded:!1});try{g?x(b[p],b[l],g):x(b[p],b[l])}catch(w){d=d+" "+b[p]}p++}else if(l<h&&b[l].startsWith("{")){try{f=JSON.parse(b[l])}catch(w){f=null}x!==a.Load&&x!==a.LoadProxy||a.preloadwaiting.push({id:a.cleanPath(b[p]),loaded:!1});try{g?x(b[p],f,g):x(b[p],f)}catch(w){d=d+" "+b[p]}p++}else{x!==a.Load&&x!==a.LoadProxy||
a.preloadwaiting.push({id:a.cleanPath(b[p]),loaded:!1});try{g?x(b[p],null,g):x(b[p],null)}catch(w){d=d+" "+b[p]}}}a.globalOpts.alerts=k;d&&a.error("could not preload image(s): "+d);break;case 2:a.globalOpts.alerts=!1;for(p=0;p<a.preloads.length;p++){x=e&&a.preloads[p][0].match(m)&&!a.preloads[p][0].match(e)?a.LoadProxy:a.preloads[p][0].match(n)?a.LoadSession:a.preloads[p][0].match(q)?a.LoadColormap:a.Load;x!==a.Load&&x!==a.LoadProxy||a.preloadwaiting.push({id:a.cleanPath(a.cleanPath(a.preloads[p][0])),
loaded:!1});try{a.preloads[p][2]?x(a.preloads[p][0],a.preloads[p][1],a.preloads[p][2]):x(a.preloads[p][0],a.preloads[p][1])}catch(w){d=d+" "+a.preloads[p][0]}}a.globalOpts.alerts=k;d&&a.error("could not preload image(s): "+d);a.preloads=[]}});a.mkPublic("RefreshImage",function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=a.parsePublicArgs(b),f=a.getImage(e.display),g=function(a){f.refreshImage(a,h)};d=e.argv[0];var h=e.argv[1]||{};if(f)if(h.id=f.id,d instanceof Blob){h.rawid&&
...
a.Crosshair.opts,a.crosshairOpts);delete a.crosshairOpts;({}).hasOwnProperty.call(a,"Grid")&&$.extend(!0,a.Grid.opts,a.gridOpts);delete a.gridOpts;({}).hasOwnProperty.call(a,"Module")&&$.extend(!0,Module,a.emscriptenOpts);delete a.emscriptenOpts;if({}.hasOwnProperty.call(a,"Fabric")){$.extend(!0,a.Fabric.opts,a.fabricOpts);var b=$jscomp.makeIterator(Object.keys(a.Fabric.opts));for(c=b.next();!c.done;c=b.next())c=c.value,"canvas"!==c&&(6<=fabric.major_version?fabric.InteractiveFabricObject.ownDefaults[c]=
a.Fabric.opts[c]:fabric.Object.prototype[c]=a.Fabric.opts[c])}delete a.fabricOpts;a.globalOpts.resize||(a.globalOpts.resizeHandle=!1);void 0!==a.analOpts.prependJS9Dir&&(a.globalOpts.prependJS9Dir=a.analOpts.prependJS9Dir,delete a.analOpts.prependJS9Dir);void 0!==a.analOpts.dataDir&&(a.globalOpts.dataDir=a.analOpts.dataDir,delete a.analOpts.dataDir);void 0!==a.globalOpts.regionsToClipboard&&void 0===a.globalOpts.regToClipboard&&(a.globalOpts.regToClipboard=a.globalOpts.regionsToClipboard,delete a.globalOpts.regionsToClipboard);
void 0!==a.globalOpts.regionDisplay&&void 0===a.globalOpts.regDisplay&&(a.globalOpts.regDisplay=a.globalOpts.regionDisplay,delete a.globalOpts.regionDisplay);void 0!==a.globalOpts.regionConfigSize&&void 0===a.globalOpts.regConfigSize&&(a.globalOpts.regConfigSize=a.globalOpts.regionConfigSize,delete a.globalOpts.regionConfigSize);void 0!==a.globalOpts.regionTemplates&&void 0===a.globalOpts.regTemplates&&(a.globalOpts.regTemplates=a.globalOpts.regionTemplates,delete a.globalOpts.regionTemplates);a.BROWSER[3]&&
(a.globalOpts.resizeHandle=!1);if({}.hasOwnProperty.call(window,"localStorage")&&a.globalOpts.localStorage){try{var d=localStorage.getItem("globals")}catch(k){d=null}if(d){try{a.userOpts.displays=JSON.parse(d)}catch(k){}a.userOpts.displays&&$.extend(!0,a.globalOpts,a.userOpts.displays)}try{d=localStorage.getItem("images")}catch(k){d=null}if(d){try{a.userOpts.images=JSON.parse(d)}catch(k){}a.userOpts.images&&$.extend(!0,a.imageOpts,a.userOpts.images)}try{d=localStorage.getItem("fits")}catch(k){d=null}if(d)try{a.userOpts.fits=
...
a.userOpts.images)}}a.DEBUG=a.DEBUG||a.globalOpts.debug||0;$("div.JS9").each(function(b,c){a.checkNew(new a.Display($(c)))});if(window.Worker&&!a.allinone)try{a.worker=new a.WebWorker(a.InstallDir(a.WORKERFILE))}catch(k){}a.allinone?a.initFITS():a.initEmscripten();window.electron&&(a.globalOpts.helperType="nodejs");a.helper=new a.Helper;window.addEventListener("message",function(b){var c=b.origin||b.originalEvent.origin;b=b.data;"null"===c&&(c="unknown");if(a.globalOpts.postMessage){if("string"===
typeof b)try{var d=JSON.parse(b)}catch(n){a.error("can't parse msg: "+b,n)}else"object"===typeof b?d=b:a.error("invalid msg from postMessage");a.msgHandler(d,function(a,b,c,e){e=e||{};parent.postMessage({cmd:d.cmd,res:{name:e.name,rtype:e.rtype,rdata:a,stdout:a,stderr:b,errcode:c}},"*")})}else a.DEBUG&&(c="JS9 ignoring postMessage, origin: "+c,c="string"===typeof b?c+(" data: "+b):"object"===typeof b?c+(" obj: "+JSON.stringify(Object.keys(b))):c+(" typeof: "+typeof b),a.log(c))},!1);({}).hasOwnProperty.call(window,
"ImageFilters")&&(a.ImageFilters=ImageFilters);a.initColormaps();a.initCommands();a.initAnalysis();a.RegisterPlugin(a.MouseTouch.CLASS,a.MouseTouch.NAME,a.MouseTouch.init,{menuItem:"Mouse/Touch",onplugindisplay:a.MouseTouch.init,help:"help/mousetouch.html",winTitle:"Mouse/Touch Actions",winResize:!0,winDims:[a.MouseTouch.WIDTH,a.MouseTouch.HEIGHT]});a.RegisterPlugin(a.Regions.CLASS,a.Regions.NAME,a.Regions.init,{divArgs:["regions"],winDims:[0,0]});a.RegisterPlugin(a.Crosshair.CLASS,a.Crosshair.NAME,
a.Crosshair.init,{onmousemove:a.Crosshair.display,onkeyboardaction:a.Crosshair.keyaction,onkeyup:a.Crosshair.keyup,onimageload:a.Crosshair.create,winDims:[0,0]});a.RegisterPlugin(a.Grid.CLASS,a.Grid.NAME,a.Grid.init,{onsetpan:a.Grid.regrid,onsetzoom:a.Grid.regrid,onsetwcssys:a.Grid.regrid,onsetwcsunits:a.Grid.regrid,onimageload:a.Grid.regrid,onupdateprefs:a.Grid.regrid,winDims:[0,0]});a.RegisterPlugin(a.Dysel.CLASS,a.Dysel.NAME,a.Dysel.init,{onimageload:a.Dysel.imageload,onimageclose:a.Dysel.imageclose,
winDims:[0,0]});a.RegisterPlugin(a.Titlebar.CLASS,a.Titlebar.NAME,a.Titlebar.init,{onimageload:a.Titlebar.imageload,onimagedisplay:a.Titlebar.imagedisplay,onimageclose:a.Titlebar.imageclose,winDims:[0,0]});a.instantiatePlugins();a.plugins.sort(function(a,b){a=a.opts.menuItem;b=b.opts.menuItem;return a?!b||a<b?-1:a>b?1:0:1});if(a.globalOpts.processQueryParams&&(c=new URL(window.location),c.searchParams)){d={};b=null;c=$jscomp.makeIterator(c.searchParams);for(var e=c.next();!e.done;e=c.next()){var f=
$jscomp.makeIterator(e.value);e=f.next().value;f=f.next().value;switch(e){case "url":case "file":var g=f;break;case "display":var h={display:f};break;case "renamedisplay":b=f.split(/[:,]/);break;default:d[e]=f}}b&&(a.prerename=[].concat($jscomp.arrayFromIterable(b)));g&&(h?a.Preload(g,d,h):a.Preload(g,d))}$(document).scrollTop(0);a.inited=!0;$(document).trigger("JS9:init")};return a}();
