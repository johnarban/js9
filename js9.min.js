...
null);if(c){switch(c.type){case "polyline":case "polygon":a.Fabric.removePolygonAnchors(b,c)}f(c,"unselect");g(-1)}},k=function(b,d){b.params.sel&&d.params&&b.params.sel!==d&&h(b,b.params.sel);b.display.image&&(b.display.image.layer=c);if(d){switch(d.type){case "polyline":case "polygon":a.Fabric.addPolygonAnchors(b,d),b.canvas.renderAll()}d.polyparams?b.params.sel=d.polyparams.polygon:d.params&&(b.params.sel=d);f(d,"select");g(1)}},m=function(b,c,d){b.params.sel&&b.params.sel!==d&&h(b,b.params.sel);
d=d||b.canvas.getActiveObject();var e=b.canvas.getActiveObjects();for(c=0;c<e.length;c++){var k=e[c];if(k.params&&k.params.parent&&k.params.parent.obj){var l=k.params.parent.obj;0>$.inArray(l,e)&&d.addWithUpdate(l)}if(k.params&&k.params.children)for(l=0;l<k.params.children.length;l++){var m=k.params.children[l].obj;0>$.inArray(m,e)&&d.addWithUpdate(m)}switch(k.type){case "polyline":case "polygon":k.params&&a.Fabric.removePolygonAnchors(b,k)}f(k,"select")}b.canvas.renderAll();g(1)};if(e&&c){if(e.layers[c])return e.layers[c];
e.layers[c]={};var l=e.layers[c];l.layerName=c;l.params=[];l.params.sel=null;l.params.sellayer=null;d?l.dtype="other":(l.dtype="main",d=e.divjq);var p=d.attr("id")+"-"+c.replace(/\s+/,"_")+"-shapeLayer";l.display=e;l.opts=$.extend(!0,{},b);l.opts.canvas=l.opts.canvas||{};void 0===l.opts.canvas.selection&&(l.opts.canvas.selection=!0);l.el=a.Fabric.elements;l.divjq=$("<div>").addClass("JS9Container").css("z-index",0).appendTo(d);l.canvasjq=$("<canvas>").addClass("JS9Layer").attr("id",p).attr("width",
d.css("width")).attr("height",d.css("height")).appendTo(l.divjq);a.bugs.webkit_resize&&"main"===l.dtype&&l.canvasjq.attr("width",e.width).attr("height",e.height);l.canvas=new fabric.Canvas(l.canvasjq[0]);l.canvas.renderOnAddRemove=!1;l.canvas.preserveObjectStacking=!0;l.opts.movable?(l.opts.lockMovementX=!1,l.opts.lockMovementY=!1,l.opts.selectable=!0,l.opts.evented=!0):!1===l.opts.movable&&(l.opts.lockMovementX=!0,l.opts.lockMovementY=!0,l.opts.selectable=!1,l.opts.evented=!1);void 0===l.opts.changeable&&
void 0!==l.opts.fixinplace&&(l.opts.changeable=!l.opts.fixinplace);void 0===l.opts.changeable&&void 0!==l.opts.locked&&(l.opts.changeable=!l.opts.locked);l.opts.changeable?(l.opts.hasControls=!0,l.opts.hasRotatingPoint=!0,l.opts.hasBorders=!0,l.opts.lockMovementX=!1,l.opts.lockMovementY=!1,l.opts.lockRotation=!1,l.opts.lockScalingX=!1,l.opts.lockScalingY=!1,l.opts.lockUniScaling=!1,l.opts.selectable=!0,l.opts.evented=!0,l.opts.usekeyboard=!0):!1===l.opts.changeable&&(l.opts.hasControls=!1,l.opts.hasRotatingPoint=
!1,l.opts.hasBorders=!1,l.opts.lockMovementX=!0,l.opts.lockMovementY=!0,l.opts.lockRotation=!0,l.opts.lockScalingX=!0,l.opts.lockScalingY=!0,l.opts.lockUniScaling=!0,l.opts.selectable=!1,l.opts.evented=!1,l.opts.usekeyboard=!1);l.opts.selectable&&(l.opts.canvas.selection=!0);if(l.opts.onmousedown||l.opts.onmouseup||l.opts.onmousemove||l.opts.tooltip||l.opts.onmouseover||l.opts.onmouseout){l.opts.evented=!0;if(l.opts.onmousedown)l.canvas.on("mouse:down",function(b){if(l.display.image&&b.target){var d=
b.target,e=d.params;if(!e||e&&!1!==e.changeable)"main"===l.dtype&&(l.display.image.clickInRegion=!0,l.display.image.clickInLayer=c),l.opts.onmousedown.call(l.canvas,l.display.image,d.pub,b.e,d)}else if(l.canvas._selection=l.canvas.selection)l.canvas.selection=a.specialKey(b.e)});else l.canvas.on("mouse:down",function(b){if(l.canvas._selection=l.canvas.selection)l.canvas.selection=a.specialKey(b.e)});if(l.opts.onmouseup)l.canvas.on("mouse:up",function(a){l.display.image&&a.target&&l.opts.onmouseup.call(l.canvas,
l.display.image,a.target.pub,a.e,a.target);l.canvas.selection=l.canvas._selection||l.canvas.selection});else l.canvas.on("mouse:up",function(){l.canvas.selection=l.canvas._selection||l.canvas.selection});if(l.opts.onmousemove)l.canvas.on("mouse:move",function(a){l.display.image&&a.target&&l.opts.onmousemove.call(l.canvas,l.display.image,a.target.pub,a.e,a.target)});if(l.opts.onmouseover)l.canvas.on("mouse:over",function(a){l.display.image&&a.target&&l.opts.onmouseover.call(l.canvas,l.display.image,
a.target.pub,a.e,a.target)});if(l.opts.onmouseout)l.canvas.on("mouse:out",function(a){l.display.image&&a.target&&l.opts.onmouseout.call(l.canvas,l.display.image,a.target.pub,a.e,a.target)});if(l.opts.onmousedblclick)l.canvas.on("mouse:dblclick",function(a){l.display.image&&a.target&&l.opts.onmousedblclick.call(l.canvas,l.display.image,a.target.pub,a.e,a.target)});l.opts.tooltip&&(l.canvas.on("mouse:over",function(b){l.display.image&&b.target&&a.tooltip(b.target.left+b.target.width+2,b.target.top+
b.target.height+2,l.opts.tooltip,l.display.image,b.target.pub,b.e,b.target)}),l.canvas.on("mouse:out",function(b){l.display.image&&b.target&&a.tooltip(b.target.left,b.target.top,null,l.display.image,b.target.pub,b.e,b.target)}))}else l.canvas.on("mouse:down",function(b){if(l.canvas._selection=l.canvas.selection)l.canvas.selection=a.specialKey(b.e)}),l.canvas.on("mouse:up",function(){l.canvas.selection=l.canvas._selection||l.canvas.selection});l.canvas.on("object:modified",function(b){var c=[];if(b.target){var d=
b.target;a.Fabric.updateChildren(l,d,"deltas");if(l.opts.sortOverlapping&&(d.setCoords(),l.canvas.forEachObject(function(a){a!==d&&d.intersectsWithObject(a)&&(e=a.getScaledWidth(),f=a.getScaledHeight(),c.push({obj:a,siz:e*f}))}),c.length)){var e=d.getScaledWidth();var f=d.getScaledHeight();c.push({obj:d,siz:e*f});c.sort(function(a,b){return a.siz<=b.siz?-1:1});var g=c.length;for(b=0;b<g;b++)try{c[b].obj.sendToBack()}catch(w){}}}});l.canvas.on("object:scaling",function(b){b.target&&(b=b.target,b.rescaleEvenly(),
b.rescaleBorder(),a.Fabric.updateChildren(l,b,"scaling"),"activeSelection"!==b.type&&"group"!==b.type||f(b,"scaling"))});l.canvas.on("object:moving",function(b){b.target&&(b=b.target,a.Fabric.updateChildren(l,b,"moving"),"activeSelection"!==b.type&&"group"!==b.type||f(b,"moving"))});l.canvas.on("object:rotating",function(b){b.target&&(b=b.target,a.Fabric.updateChildren(l,b,"rotating"),"activeSelection"!==b.type&&"group"!==b.type||f(b,"rotating"))});l.canvas.on("selection:created",function(b){if(!a.globalOpts.skipSelectionProcessing)if(b.target){var c=
b.target;"activeSelection"===c.type||"group"===c.type&&!c.params?m(l,b,c):k(l,c)}else b.selected&&b.selected.length&&(1===b.selected.length?(c=b.selected[0],k(l,c)):m(l,b))});l.canvas.on("selection:updated",function(b){if(!a.globalOpts.skipSelectionProcessing)if(b.target){var c=b.target;"activeSelection"===c.type||"group"===c.type&&!c.params?m(l,b,c):k(l,c)}else b.selected&&b.selected.length&&(1===b.selected.length?(c=b.selected[0],k(l,c)):m(l,b))});l.canvas.on("before:selection:cleared",function(b){if(!a.globalOpts.skipSelectionProcessing&&
...
(b.r2/=c));b.sizeScale&&(a.notNull(b.r1)&&(b.r1*=b.sizeScale),a.notNull(b.r2)&&(b.r2*=b.sizeScale));break;case "point":b.strokeWidth=a.Regions.opts.ptStrokeWidth;switch(b.ptshape){case "box":b.width=2*b.ptsize;b.height=2*b.ptsize;break;case "circle":b.radius=b.ptsize;break;case "ellipse":b.rx=b.ptsize;b.ry=b.ptsize/2;break;case "x":case "+":b.strokeWidth=0,b.width=b.ptsize,b.height=b.width}b.lockRotation=!0;b.lockScalingX=!0;b.lockScalingY=!0;b.lockUniScaling=!0;b.hasControls=!1;b.hasRotatingPoint=
!1;b.hasBorders=!0;break;case "line":case "polygon":if(a.notNull(b.wcspts)&&this.validWCS()){b.pts=[];b.wcssys&&(l=this.getWCSSys(),p=a.globalOpts.xeqPlugins,a.globalOpts.xeqPlugins=!1,this.setWCSSys(b.wcssys,!1));for(e=0;e<b.wcspts.length;e++)m=a.wcs2pix(this.raw.wcs,b.wcspts[e].ra,b.wcspts[e].dec).trim().split(/ +/),b.pts.push({x:parseFloat(m[0]),y:parseFloat(m[1])});l&&(this.setWCSSys(l,!1),a.globalOpts.xeqPlugins=p)}if(b.pts&&b.pts.length){if("string"===typeof b.pts){m=b.pts.replace(/ /g,"").split(",");
l=m.length;if("string"===typeof m[0])for(e=0;e<l;e++)m[e]=parseFloat(m[e]);b.pts=[];for(p=e=0;e<l;e+=2,p++)b.pts[p]={x:m[e],y:m[e+1]}}l=b.pts.length;for(e=0;e<l;e++)p=b.pts[e],a.notNull(p.x)&&a.notNull(p.y)?b.pts[e]=this.imageToDisplayPos(b.pts[e]):a.notNull(p.dx)&&a.notNull(p.dy)&&(b.pts[e].x=p.dx,delete b.pts[e].dx,b.pts[e].y=p.dy,delete b.pts[e].dy);b.left&&b.top?p={x:b.left,y:b.top}:b.dx&&b.dy?p={x:b.dx,y:b.dy}:(p=a.centerPolygon(b.pts),f.left=p.x,f.top=p.y);b.points=[];for(e=0;e<l;e++)m={x:(b.pts[e].x-
p.x)/c,y:(b.pts[e].y-p.y)/c},b.points.push(m)}else d&&d.points&&d.points.length||("polygon"===b.shape&&b.polypoints?b.points=b.points||b.polypoints:"line"===b.shape&&b.linepoints&&(b.points=b.points||b.linepoints));if(b.ireg&&a.SCALEIREG)for(l=b.points.length,e=0;e<l;e++)b.points[e].x/=c,b.points[e].y/=c}e=$jscomp.makeIterator(Object.keys(b));for(c=e.next();!c.done;c=e.next())switch(c=c.value,c){case "tags":case "x":case "y":case "px":case "py":case "deltax":case "deltay":case "ra":case "dec":case "pts":case "left":case "top":case "angle":case "radii":case "ireg":break;
